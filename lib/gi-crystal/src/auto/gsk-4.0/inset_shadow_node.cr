...
module Gsk
  ...
  class InsetShadowNode < RenderNode
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGsk.gsk_inset_shadow_node_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gsk::InsetShadowNode.new(Void*, GICrystal::Transfer)
    ...
    def blur_radius : Float32
      ...
      # C call
      _retval = LibGsk.gsk_inset_shadow_node_get_blur_radius(to_unsafe)
    ...
    def color : Gdk::RGBA
      ...
      # C call
      _retval = LibGsk.gsk_inset_shadow_node_get_color(to_unsafe)
    ...
    def dx : Float32
      ...
      # C call
      _retval = LibGsk.gsk_inset_shadow_node_get_dx(to_unsafe)
    ...
    def dy : Float32
      ...
      # C call
      _retval = LibGsk.gsk_inset_shadow_node_get_dy(to_unsafe)
    ...
    def outline : Gsk::RoundedRect
      ...
      # C call
      _retval = LibGsk.gsk_inset_shadow_node_get_outline(to_unsafe)
    ...
    def spread : Float32
      ...
      # C call
      _retval = LibGsk.gsk_inset_shadow_node_get_spread(to_unsafe)
