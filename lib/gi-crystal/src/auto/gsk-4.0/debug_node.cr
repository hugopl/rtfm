...
module Gsk
  ...
  class DebugNode < RenderNode
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGsk.gsk_debug_node_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gsk::DebugNode.new(Void*, GICrystal::Transfer)
    ...
    def child : Gsk::RenderNode
      ...
      # C call
      _retval = LibGsk.gsk_debug_node_get_child(to_unsafe)
    ...
    def message : ::String
      ...
      # C call
      _retval = LibGsk.gsk_debug_node_get_message(to_unsafe)
