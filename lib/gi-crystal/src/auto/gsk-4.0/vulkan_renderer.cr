...
module Gsk
  ...
  class VulkanRenderer < Renderer
    ...
    GICrystal.declare_new_method(VulkanRenderer, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGsk.gsk_vulkan_renderer_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gsk::VulkanRenderer.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      ...
      Gsk::VulkanRenderer.new(_retval, GICrystal::Transfer::Full)
    end
