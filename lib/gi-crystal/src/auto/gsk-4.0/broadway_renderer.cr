...
module Gsk
  ...
  class BroadwayRenderer < Renderer
    ...
    GICrystal.declare_new_method(BroadwayRenderer, g_object_get_qdata)

    # Initialize a new `BroadwayRenderer`.
    def initialize
      super
    end
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGsk.gsk_broadway_renderer_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gsk::BroadwayRenderer.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      ...
      Gsk::BroadwayRenderer.new(_retval, GICrystal::Transfer::Full)
    end
