...
module Gsk
  ...
  class NglRenderer < Renderer
    ...
    GICrystal.declare_new_method(NglRenderer, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGsk.gsk_ngl_renderer_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gsk::NglRenderer.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      ...
      Gsk::NglRenderer.new(_retval, GICrystal::Transfer::Full)
    end
