...
module Gsk
  ...
  class GLRenderer < Renderer
    ...
    GICrystal.declare_new_method(GLRenderer, g_object_get_qdata)

    # Initialize a new `GLRenderer`.
    def initialize
      super
    end
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGsk.gsk_gl_renderer_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gsk::GLRenderer.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      ...
      Gsk::GLRenderer.new(_retval, GICrystal::Transfer::Full)
    end
