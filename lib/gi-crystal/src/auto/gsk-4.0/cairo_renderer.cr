...
module Gsk
  ...
  class CairoRenderer < Renderer
    ...
    GICrystal.declare_new_method(CairoRenderer, g_object_get_qdata)

    # Initialize a new `CairoRenderer`.
    def initialize
      super
    end
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGsk.gsk_cairo_renderer_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gsk::CairoRenderer.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      ...
      Gsk::CairoRenderer.new(_retval, GICrystal::Transfer::Full)
    end
