...
module Gsk
  ...
  class OpacityNode < RenderNode
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGsk.gsk_opacity_node_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gsk::OpacityNode.new(Void*, GICrystal::Transfer)
    ...
    def child : Gsk::RenderNode
      ...
      # C call
      _retval = LibGsk.gsk_opacity_node_get_child(to_unsafe)
    ...
    def opacity : Float32
      ...
      # C call
      _retval = LibGsk.gsk_opacity_node_get_opacity(to_unsafe)
