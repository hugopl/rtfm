...
module Gsk
  ...
  class ColorMatrixNode < RenderNode
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGsk.gsk_color_matrix_node_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gsk::ColorMatrixNode.new(Void*, GICrystal::Transfer)
    ...
    def child : Gsk::RenderNode
      ...
      # C call
      _retval = LibGsk.gsk_color_matrix_node_get_child(to_unsafe)
    ...
    def color_matrix : Graphene::Matrix
      ...
      # C call
      _retval = LibGsk.gsk_color_matrix_node_get_color_matrix(to_unsafe)
    ...
    def color_offset : Graphene::Vec4
      ...
      # C call
      _retval = LibGsk.gsk_color_matrix_node_get_color_offset(to_unsafe)
