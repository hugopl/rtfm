...
module Gsk
  ...
  class TransformNode < RenderNode
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGsk.gsk_transform_node_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gsk::TransformNode.new(Void*, GICrystal::Transfer)
    ...
    def child : Gsk::RenderNode
      ...
      # C call
      _retval = LibGsk.gsk_transform_node_get_child(to_unsafe)
    ...
    def transform : Gsk::Transform
      ...
      # C call
      _retval = LibGsk.gsk_transform_node_get_transform(to_unsafe)
