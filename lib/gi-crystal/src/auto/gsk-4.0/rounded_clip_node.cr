...
module Gsk
  ...
  class RoundedClipNode < RenderNode
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGsk.gsk_rounded_clip_node_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gsk::RoundedClipNode.new(Void*, GICrystal::Transfer)
    ...
    def child : Gsk::RenderNode
      ...
      # C call
      _retval = LibGsk.gsk_rounded_clip_node_get_child(to_unsafe)
    ...
    def clip : Gsk::RoundedRect
      ...
      # C call
      _retval = LibGsk.gsk_rounded_clip_node_get_clip(to_unsafe)
