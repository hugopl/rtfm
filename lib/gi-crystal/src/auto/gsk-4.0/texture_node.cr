...
module Gsk
  ...
  class TextureNode < RenderNode
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGsk.gsk_texture_node_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gsk::TextureNode.new(Void*, GICrystal::Transfer)
    ...
    def texture : Gdk::Texture
      ...
      # C call
      _retval = LibGsk.gsk_texture_node_get_texture(to_unsafe)
