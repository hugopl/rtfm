...
lib LibGdkPixbuf
  ...
  # All C Functions
  fun gdk_colorspace_get_type : UInt64
  fun gdk_interp_type_get_type : UInt64
  fun gdk_pixbuf_add_alpha(this : Void*, substitute_color : LibC::Int, r : UInt8, g : UInt8, b : UInt8) : Pointer(Void)
  fun gdk_pixbuf_alpha_mode_get_type : UInt64
  ...
  fun gdk_pixbuf_error_get_type : UInt64
  ...
  fun gdk_pixbuf_rotation_get_type : UInt64
