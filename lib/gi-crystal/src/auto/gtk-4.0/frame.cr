...
module Gtk
  ...
  class Frame < Widget
    ...
    GICrystal.declare_new_method(Frame, g_object_get_qdata)
    ...
    def initialize(*, accessible_role : Gtk::AccessibleRole? = nil, can_focus : Bool? = nil, can_target : Bool? = nil, child : Gtk::Widget? = nil, css_classes : Enumerable(::String)? = nil, css_name : ::String? = nil, cursor : Gdk::Cursor? = nil, focus_on_click : Bool? = nil, focusable : Bool? = nil, halign : Gtk::Align? = nil, has_default : Bool? = nil, has_focus : Bool? = nil, has_tooltip : Bool? = nil, height_request : Int32? = nil, hexpand : Bool? = nil, hexpand_set : Bool? = nil, label : ::String? = nil, label_widget : Gtk::Widget? = nil, label_xalign : Float32? = nil, layout_manager : Gtk::LayoutManager? = nil, limit_events : Bool? = nil, margin_bottom : Int32? = nil, margin_end : Int32? = nil, margin_start : Int32? = nil, margin_top : Int32? = nil, name : ::String? = nil, opacity : Float64? = nil, overflow : Gtk::Overflow? = nil, parent : Gtk::Widget? = nil, receives_default : Bool? = nil, root : Gtk::Root? = nil, scale_factor : Int32? = nil, sensitive : Bool? = nil, tooltip_markup : ::String? = nil, tooltip_text : ::String? = nil, valign : Gtk::Align? = nil, vexpand : Bool? = nil, vexpand_set : Bool? = nil, visible : Bool? = nil, width_request : Int32? = nil)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_frame_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::Frame.new(Void*, GICrystal::Transfer)
    ...
    def child : Gtk::Widget?
      ...
      # C call
      _retval = LibGtk.gtk_frame_get_child(to_unsafe)
    ...
    def label : ::String?
      ...
      # C call
      _retval = LibGtk.gtk_frame_get_label(to_unsafe)
    ...
    def label_align : Float32
      # gtk_frame_get_label_align: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibGtk.gtk_frame_get_label_align(to_unsafe)
    ...
    def label_widget : Gtk::Widget?
      ...
      # C call
      _retval = LibGtk.gtk_frame_get_label_widget(to_unsafe)
    ...
    def child=(child : Gtk::Widget?) : Nil
      ...
      # C call
      LibGtk.gtk_frame_set_child(to_unsafe, child)
    ...
    def label=(label : ::String?) : Nil
      ...
      # C call
      LibGtk.gtk_frame_set_label(to_unsafe, label)

      # Return value handling
    end

    def label_align=(xalign : Float32) : Nil
      # gtk_frame_set_label_align: (Method | Setter)
      # @xalign:
      # Returns: (transfer none)

      # C call
      LibGtk.gtk_frame_set_label_align(to_unsafe, xalign)
    ...
    def label_widget=(label_widget : Gtk::Widget?) : Nil
      ...
      # C call
      LibGtk.gtk_frame_set_label_widget(to_unsafe, label_widget)

      # Return value handling
    end

    # compute_child_allocation: (None)
    # @allocation:
    # Returns: (transfer none)
    private macro _register_compute_child_allocation_vfunc(impl_method_name)
      private def self._vfunc_compute_child_allocation(%this : Pointer(Void), lib_allocation :  Pointer(Void), ) : Void
        # @allocation: 

# Generator::BuiltInTypeArgPlan
allocation=Gdk::Rectangle.new(lib_allocation, GICrystal::Transfer::None)


        %instance = LibGObject.g_object_get_qdata(%this, GICrystal::INSTANCE_QDATA_KEY)
        raise GICrystal::ObjectCollectedError.new if %instance.null?

        %retval = %instance.as(self).{{ impl_method_name.id }}(allocation)
      ...
      def self._class_init(type_struct : Pointer(LibGObject::TypeClass), user_data : Pointer(Void)) : Nil
        ...
        vfunc_ptr.value = (->_vfunc_compute_child_allocation(Pointer(Void), Pointer(Void))).pointer
        previous_def
      end
    end
    ...
    # @allocation:
    # Returns: (transfer none)
    private macro _register_unsafe_compute_child_allocation_vfunc(impl_method_name)
      private def self._vfunc_unsafe_compute_child_allocation(%this : Pointer(Void), lib_allocation :  Pointer(Void), ) : Void
# @allocation: 

        %instance = LibGObject.g_object_get_qdata(%this, GICrystal::INSTANCE_QDATA_KEY)
        raise GICrystal::ObjectCollectedError.new if %instance.null?

        %instance.as(self).{{ impl_method_name.id }}(lib_allocation)
      end

      def self._class_init(type_struct : Pointer(LibGObject::TypeClass), user_data : Pointer(Void)) : Nil
        vfunc_ptr = (type_struct.as(Pointer(Void)) + 408).as(Pointer(Pointer(Void)))
        @@_gi_parent_vfunc_compute_child_allocation = Proc(Pointer(Void), Pointer(Void), Void).new(vfunc_ptr.value, Pointer(Void).null) unless vfunc_ptr.value.null?
        vfunc_ptr.value = (->_vfunc_unsafe_compute_child_allocation(Pointer(Void), Pointer(Void))).pointer
        previous_def
      end

      @@_gi_parent_vfunc_compute_child_allocation : Proc(Pointer(Void), Pointer(Void), Void)? = nil
    end
