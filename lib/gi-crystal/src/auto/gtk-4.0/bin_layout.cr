...
module Gtk
  ...
  class BinLayout < LayoutManager
    ...
    GICrystal.declare_new_method(BinLayout, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_bin_layout_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::BinLayout.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      ...
      Gtk::BinLayout.new(_retval, GICrystal::Transfer::Full)
    end
