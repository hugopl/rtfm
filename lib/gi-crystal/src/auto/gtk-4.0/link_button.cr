...
module Gtk
  ...
  class LinkButton < Button
    ...
    GICrystal.declare_new_method(LinkButton, g_object_get_qdata)
    ...
    def initialize(*, accessible_role : Gtk::AccessibleRole? = nil, action_name : ::String? = nil, action_target : GLib::Variant? = nil, can_focus : Bool? = nil, can_shrink : Bool? = nil, can_target : Bool? = nil, child : Gtk::Widget? = nil, css_classes : Enumerable(::String)? = nil, css_name : ::String? = nil, cursor : Gdk::Cursor? = nil, focus_on_click : Bool? = nil, focusable : Bool? = nil, halign : Gtk::Align? = nil, has_default : Bool? = nil, has_focus : Bool? = nil, has_frame : Bool? = nil, has_tooltip : Bool? = nil, height_request : Int32? = nil, hexpand : Bool? = nil, hexpand_set : Bool? = nil, icon_name : ::String? = nil, label : ::String? = nil, layout_manager : Gtk::LayoutManager? = nil, limit_events : Bool? = nil, margin_bottom : Int32? = nil, margin_end : Int32? = nil, margin_start : Int32? = nil, margin_top : Int32? = nil, name : ::String? = nil, opacity : Float64? = nil, overflow : Gtk::Overflow? = nil, parent : Gtk::Widget? = nil, receives_default : Bool? = nil, root : Gtk::Root? = nil, scale_factor : Int32? = nil, sensitive : Bool? = nil, tooltip_markup : ::String? = nil, tooltip_text : ::String? = nil, uri : ::String? = nil, use_underline : Bool? = nil, valign : Gtk::Align? = nil, vexpand : Bool? = nil, vexpand_set : Bool? = nil, visible : Bool? = nil, visited : Bool? = nil, width_request : Int32? = nil)
      ...
      if !visited.nil?
        (_names.to_unsafe + _n).value = "visited".to_unsafe
        GObject::Value.init_g_value(_values.to_unsafe + _n, visited)
        _n += 1
      end
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_link_button_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::LinkButton.new(Void*, GICrystal::Transfer)
    ...
    def self.new(uri : ::String) : self
      ...
      # C call
      _retval = LibGtk.gtk_link_button_new(uri)

      # Return value handling
      Gtk::LinkButton.new(_retval, GICrystal::Transfer::Full)
    end

    def self.new_with_label(uri : ::String, label : ::String?) : self
      # gtk_link_button_new_with_label: (Constructor)
      # @uri:
      # @label: (nullable)
      # Returns: (transfer none)
      ...
      # C call
      _retval = LibGtk.gtk_link_button_new_with_label(uri, label)
    ...
    def uri : ::String
      ...
      # C call
      _retval = LibGtk.gtk_link_button_get_uri(to_unsafe)
    ...
    def visited : Bool
      ...
      # C call
      _retval = LibGtk.gtk_link_button_get_visited(to_unsafe)
    ...
    def uri=(uri : ::String) : Nil
      ...
      # C call
      LibGtk.gtk_link_button_set_uri(to_unsafe, uri)
    ...
    def visited=(visited : Bool) : Nil
      ...
      # C call
      LibGtk.gtk_link_button_set_visited(to_unsafe, visited)
    ...
    struct ActivateLinkSignal < GObject::Signal
      ...
      def connect(handler : Proc(Gtk::LinkButton, Bool), *, after : Bool = false) : GObject::SignalConnection
        _box = ::Box.box(handler)
        handler = ->(_lib_sender : Pointer(Void), _lib_box : Pointer(Void)) {
          _sender = Gtk::LinkButton.new(_lib_sender, GICrystal::Transfer::None)
          _retval = ::Box(Proc(Gtk::LinkButton, Bool)).unbox(_lib_box).call(_sender)
          GICrystal.to_c_bool(_retval)
        }.pointer
      ...
      def emit : Nil
        LibGObject.g_signal_emit_by_name(@source, "activate-link")
      end
    end
