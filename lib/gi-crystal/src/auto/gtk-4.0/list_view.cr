  ...
  class ListView < ListBase
    ...
    def self._register_derived_type(class_name : String, class_init, instance_init)
      LibGObject.g_type_register_static_simple(g_type, class_name,
        sizeof(LibGtk::ListViewClass), class_init,
        sizeof(LibGtk::ListView), instance_init, 0)
    end

    GICrystal.declare_new_method(ListView, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_list_view_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::ListView.new(Void*, GICrystal::Transfer)
    ...
    def self.new(model : Gtk::SelectionModel?, factory : Gtk::ListItemFactory?) : self
      ...
      Gtk::ListView.new(_retval, GICrystal::Transfer::Full)
    end
    ...
    def enable_rubberband : Bool
      ...
      # C call
      _retval = LibGtk.gtk_list_view_get_enable_rubberband(to_unsafe)
    ...
    def factory : Gtk::ListItemFactory?
      ...
      # C call
      _retval = LibGtk.gtk_list_view_get_factory(to_unsafe)
    ...
    def header_factory : Gtk::ListItemFactory?
      # gtk_list_view_get_header_factory: (Method | Getter)
      # Returns: (transfer none) (nullable)

      # C call
      _retval = LibGtk.gtk_list_view_get_header_factory(to_unsafe)
    ...
    def model : Gtk::SelectionModel?
      ...
      # C call
      _retval = LibGtk.gtk_list_view_get_model(to_unsafe)
    ...
    def show_separators : Bool
      ...
      # C call
      _retval = LibGtk.gtk_list_view_get_show_separators(to_unsafe)
    ...
    def single_click_activate : Bool
      ...
      # C call
      _retval = LibGtk.gtk_list_view_get_single_click_activate(to_unsafe)
    ...
    def tab_behavior : Gtk::ListTabBehavior
      # gtk_list_view_get_tab_behavior: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibGtk.gtk_list_view_get_tab_behavior(to_unsafe)
    ...
    def scroll_to(pos : UInt32, flags : Gtk::ListScrollFlags, scroll : Gtk::ScrollInfo?) : Nil
      # gtk_list_view_scroll_to: (Method)
      # @pos:
      # @flags:
      ...
      # C call
      LibGtk.gtk_list_view_scroll_to(to_unsafe, pos, flags, scroll)
    ...
    def enable_rubberband=(enable_rubberband : Bool) : Nil
      ...
      # C call
      LibGtk.gtk_list_view_set_enable_rubberband(to_unsafe, enable_rubberband)
    ...
    def factory=(factory : Gtk::ListItemFactory?) : Nil
      ...
      # C call
      LibGtk.gtk_list_view_set_factory(to_unsafe, factory)

      # Return value handling
    end

    def header_factory=(factory : Gtk::ListItemFactory?) : Nil
      # gtk_list_view_set_header_factory: (Method | Setter)
      # @factory: (nullable)
      # Returns: (transfer none)
      ...
      # C call
      LibGtk.gtk_list_view_set_header_factory(to_unsafe, factory)
    ...
    def model=(model : Gtk::SelectionModel?) : Nil
      ...
      # C call
      LibGtk.gtk_list_view_set_model(to_unsafe, model)
    ...
    def show_separators=(show_separators : Bool) : Nil
      ...
      # C call
      LibGtk.gtk_list_view_set_show_separators(to_unsafe, show_separators)
    ...
    def single_click_activate=(single_click_activate : Bool) : Nil
      ...
      # C call
      LibGtk.gtk_list_view_set_single_click_activate(to_unsafe, single_click_activate)

      # Return value handling
    end

    def tab_behavior=(tab_behavior : Gtk::ListTabBehavior) : Nil
      # gtk_list_view_set_tab_behavior: (Method | Setter)
      # @tab_behavior:
      # Returns: (transfer none)

      # C call
      LibGtk.gtk_list_view_set_tab_behavior(to_unsafe, tab_behavior)
    ...
    struct ActivateSignal < GObject::Signal
      ...
      def connect(handler : Proc(Gtk::ListView, UInt32, Nil), *, after : Bool = false) : GObject::SignalConnection
        _box = ::Box.box(handler)
        handler = ->(_lib_sender : Pointer(Void), lib_position : UInt32, _lib_box : Pointer(Void)) {
          _sender = Gtk::ListView.new(_lib_sender, GICrystal::Transfer::None)
          # NoStrategy
          position = lib_position
          ::Box(Proc(Gtk::ListView, UInt32, Nil)).unbox(_lib_box).call(_sender, position)
        }.pointer
