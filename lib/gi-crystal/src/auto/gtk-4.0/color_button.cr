...
module Gtk
  ...
  class ColorButton < Widget
    ...
    GICrystal.declare_new_method(ColorButton, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_color_button_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::ColorButton.new(Void*, GICrystal::Transfer)
    ...
    def modal : Bool
      ...
      # C call
      _retval = LibGtk.gtk_color_button_get_modal(to_unsafe)
    ...
    def title : ::String
      ...
      # C call
      _retval = LibGtk.gtk_color_button_get_title(to_unsafe)
    ...
    def modal=(modal : Bool) : Nil
      ...
      # C call
      LibGtk.gtk_color_button_set_modal(to_unsafe, modal)
    ...
    def title=(title : ::String) : Nil
      ...
      # C call
      LibGtk.gtk_color_button_set_title(to_unsafe, title)
    ...
    struct ActivateSignal < GObject::Signal
      ...
      def connect(handler : Proc(Gtk::ColorButton, Nil), *, after : Bool = false) : GObject::SignalConnection
        _box = ::Box.box(handler)
        handler = ->(_lib_sender : Pointer(Void), _lib_box : Pointer(Void)) {
    ...
    struct ColorSetSignal < GObject::Signal
      def name : String
