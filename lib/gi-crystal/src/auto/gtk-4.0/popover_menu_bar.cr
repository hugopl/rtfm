...
module Gtk
  ...
  class PopoverMenuBar < Widget
    ...
    GICrystal.declare_new_method(PopoverMenuBar, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_popover_menu_bar_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::PopoverMenuBar.new(Void*, GICrystal::Transfer)
    ...
    def add_child(child : Gtk::Widget, id : ::String) : Bool
      ...
      # C call
      _retval = LibGtk.gtk_popover_menu_bar_add_child(to_unsafe, child, id)
    ...
    def menu_model : Gio::MenuModel?
      ...
      # C call
      _retval = LibGtk.gtk_popover_menu_bar_get_menu_model(to_unsafe)
    ...
    def remove_child(child : Gtk::Widget) : Bool
      ...
      # C call
      _retval = LibGtk.gtk_popover_menu_bar_remove_child(to_unsafe, child)
    ...
    def menu_model=(model : Gio::MenuModel?) : Nil
      ...
      # C call
      LibGtk.gtk_popover_menu_bar_set_menu_model(to_unsafe, model)
