...
module Gtk
  ...
  class Fixed < Widget
    ...
    GICrystal.declare_new_method(Fixed, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_fixed_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::Fixed.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      ...
      Gtk::Fixed.new(_retval, GICrystal::Transfer::Full)
    end
    ...
    def child_position(widget : Gtk::Widget, x : Float64, y : Float64) : Nil
      ...
      # C call
      LibGtk.gtk_fixed_get_child_position(to_unsafe, widget, x, y)
    ...
    def child_transform(widget : Gtk::Widget) : Gsk::Transform?
      ...
      # C call
      _retval = LibGtk.gtk_fixed_get_child_transform(to_unsafe, widget)
    ...
    def move(widget : Gtk::Widget, x : Float64, y : Float64) : Nil
      ...
      # C call
      LibGtk.gtk_fixed_move(to_unsafe, widget, x, y)
    ...
    def put(widget : Gtk::Widget, x : Float64, y : Float64) : Nil
      ...
      # C call
      LibGtk.gtk_fixed_put(to_unsafe, widget, x, y)
    ...
    def remove(widget : Gtk::Widget) : Nil
      ...
      # C call
      LibGtk.gtk_fixed_remove(to_unsafe, widget)
    ...
    def set_child_transform(widget : Gtk::Widget, transform : Gsk::Transform?) : Nil
      ...
      # C call
      LibGtk.gtk_fixed_set_child_transform(to_unsafe, widget, transform)
