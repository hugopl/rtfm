  ...
  class ShortcutsSection < Box
    ...
    def self._register_derived_type(class_name : String, class_init, instance_init)
      LibGObject.g_type_register_static_simple(g_type, class_name,
        sizeof(LibGtk::ShortcutsSectionClass), class_init,
        sizeof(LibGtk::ShortcutsSection), instance_init, 0)
    end
    ...
    def initialize(*, accessible_role : Gtk::AccessibleRole? = nil, baseline_child : Int32? = nil, baseline_position : Gtk::BaselinePosition? = nil, can_focus : Bool? = nil, can_target : Bool? = nil, css_classes : Enumerable(::String)? = nil, css_name : ::String? = nil, cursor : Gdk::Cursor? = nil, focus_on_click : Bool? = nil, focusable : Bool? = nil, halign : Gtk::Align? = nil, has_default : Bool? = nil, has_focus : Bool? = nil, has_tooltip : Bool? = nil, height_request : Int32? = nil, hexpand : Bool? = nil, hexpand_set : Bool? = nil, homogeneous : Bool? = nil, layout_manager : Gtk::LayoutManager? = nil, limit_events : Bool? = nil, margin_bottom : Int32? = nil, margin_end : Int32? = nil, margin_start : Int32? = nil, margin_top : Int32? = nil, max_height : UInt32? = nil, name : ::String? = nil, opacity : Float64? = nil, orientation : Gtk::Orientation? = nil, overflow : Gtk::Overflow? = nil, parent : Gtk::Widget? = nil, receives_default : Bool? = nil, root : Gtk::Root? = nil, scale_factor : Int32? = nil, section_name : ::String? = nil, sensitive : Bool? = nil, spacing : Int32? = nil, title : ::String? = nil, tooltip_markup : ::String? = nil, tooltip_text : ::String? = nil, valign : Gtk::Align? = nil, vexpand : Bool? = nil, vexpand_set : Bool? = nil, view_name : ::String? = nil, visible : Bool? = nil, width_request : Int32? = nil)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_shortcuts_section_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::ShortcutsSection.new(Void*, GICrystal::Transfer)
    ...
    @[Deprecated]
    def add_group(group : Gtk::ShortcutsGroup) : Nil
      # gtk_shortcuts_section_add_group: (Method)
      # @group:
      # Returns: (transfer none)

      # C call
      LibGtk.gtk_shortcuts_section_add_group(to_unsafe, group)
    ...
    struct ChangeCurrentPageSignal < GObject::Signal
      ...
      def connect(handler : Proc(Gtk::ShortcutsSection, Int32, Bool), *, after : Bool = false) : GObject::SignalConnection
        _box = ::Box.box(handler)
        handler = ->(_lib_sender : Pointer(Void), lib_offset : Int32, _lib_box : Pointer(Void)) {
      ...
      def emit(offset : Int32) : Nil
        LibGObject.g_signal_emit_by_name(@source, "change-current-page", offset)
      end
    end
