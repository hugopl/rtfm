...
module Gtk
  ...
  class ShortcutsWindow < Window
    ...
    GICrystal.declare_new_method(ShortcutsWindow, g_object_get_qdata)

    # Initialize a new `ShortcutsWindow`.
    def initialize
      super
    end
    ...
    def initialize(*, accessible_role : Gtk::AccessibleRole? = nil, application : Gtk::Application? = nil, can_focus : Bool? = nil, can_target : Bool? = nil, child : Gtk::Widget? = nil, css_classes : Enumerable(::String)? = nil, css_name : ::String? = nil, cursor : Gdk::Cursor? = nil, decorated : Bool? = nil, default_height : Int32? = nil, default_widget : Gtk::Widget? = nil, default_width : Int32? = nil, deletable : Bool? = nil, destroy_with_parent : Bool? = nil, display : Gdk::Display? = nil, focus_on_click : Bool? = nil, focus_visible : Bool? = nil, focus_widget : Gtk::Widget? = nil, focusable : Bool? = nil, fullscreened : Bool? = nil, halign : Gtk::Align? = nil, handle_menubar_accel : Bool? = nil, has_default : Bool? = nil, has_focus : Bool? = nil, has_tooltip : Bool? = nil, height_request : Int32? = nil, hexpand : Bool? = nil, hexpand_set : Bool? = nil, hide_on_close : Bool? = nil, icon_name : ::String? = nil, is_active : Bool? = nil, layout_manager : Gtk::LayoutManager? = nil, limit_events : Bool? = nil, margin_bottom : Int32? = nil, margin_end : Int32? = nil, margin_start : Int32? = nil, margin_top : Int32? = nil, maximized : Bool? = nil, mnemonics_visible : Bool? = nil, modal : Bool? = nil, name : ::String? = nil, opacity : Float64? = nil, overflow : Gtk::Overflow? = nil, parent : Gtk::Widget? = nil, receives_default : Bool? = nil, resizable : Bool? = nil, root : Gtk::Root? = nil, scale_factor : Int32? = nil, section_name : ::String? = nil, sensitive : Bool? = nil, startup_id : ::String? = nil, suspended : Bool? = nil, title : ::String? = nil, titlebar : Gtk::Widget? = nil, tooltip_markup : ::String? = nil, tooltip_text : ::String? = nil, transient_for : Gtk::Window? = nil, valign : Gtk::Align? = nil, vexpand : Bool? = nil, vexpand_set : Bool? = nil, view_name : ::String? = nil, visible : Bool? = nil, width_request : Int32? = nil)
      ...
      if !section_name.nil?
        (_names.to_unsafe + _n).value = "section-name".to_unsafe
        GObject::Value.init_g_value(_values.to_unsafe + _n, section_name)
        _n += 1
      end
      if !sensitive.nil?
      ...
      if !view_name.nil?
        (_names.to_unsafe + _n).value = "view-name".to_unsafe
        GObject::Value.init_g_value(_values.to_unsafe + _n, view_name)
        _n += 1
      end
      if !visible.nil?
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_shortcuts_window_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::ShortcutsWindow.new(Void*, GICrystal::Transfer)
    ...
    # Set `#section_name` property to nil.
    def section_name=(value : Nil) : Nil
      LibGObject.g_object_set(self, "section-name", Pointer(Void).null, Pointer(Void).null)
    end

    # Same as `#section_name`, but can return nil.
    def section_name? : ::String?
      value = uninitialized Pointer(LibC::Char)
      LibGObject.g_object_get(self, "section-name", pointerof(value), Pointer(Void).null)
    ...
    # Set `#view_name` property to nil.
    def view_name=(value : Nil) : Nil
      LibGObject.g_object_set(self, "view-name", Pointer(Void).null, Pointer(Void).null)
    end

    # Same as `#view_name`, but can return nil.
    def view_name? : ::String?
      value = uninitialized Pointer(LibC::Char)
      LibGObject.g_object_get(self, "view-name", pointerof(value), Pointer(Void).null)
      ::String.new(value) if value
    ...
    @[Deprecated]
    def add_section(section : Gtk::ShortcutsSection) : Nil
      # gtk_shortcuts_window_add_section: (Method)
      # @section:
      # Returns: (transfer none)

      # C call
      LibGtk.gtk_shortcuts_window_add_section(to_unsafe, section)
    ...
    struct CloseSignal < GObject::Signal
      ...
      def connect(handler : Proc(Gtk::ShortcutsWindow, Nil), *, after : Bool = false) : GObject::SignalConnection
        _box = ::Box.box(handler)
        handler = ->(_lib_sender : Pointer(Void), _lib_box : Pointer(Void)) {
          _sender = Gtk::ShortcutsWindow.new(_lib_sender, GICrystal::Transfer::None)
          ::Box(Proc(Gtk::ShortcutsWindow, Nil)).unbox(_lib_box).call(_sender)
        }.pointer
    ...
    struct SearchSignal < GObject::Signal
      def name : String
      ...
      def emit : Nil
        LibGObject.g_signal_emit_by_name(@source, "search")
      end
    end

    def search_signal
      SearchSignal.new(self)
    end
