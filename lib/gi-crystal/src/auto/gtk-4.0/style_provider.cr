module Gtk
  module StyleProvider
    macro included
      ...
      macro inherited
        include Gtk::StyleProvider
      end

      {% unless @type.annotation(GICrystal::GeneratedWrapper) %}
        def self._install_iface_Gtk__StyleProvider(interface : Pointer(LibGObject::TypeInterface)) : Nil
        end
      {% end %}
    end

    def self.g_type : UInt64
      Gtk::AbstractStyleProvider.g_type
    end
    ...
    def self.cast?(obj : GObject::Object) : self?
      if LibGObject.g_type_check_instance_is_a(obj, g_type) != 0
        AbstractStyleProvider.new(obj.to_unsafe, :none)
      end
    end
  ...
  class AbstractStyleProvider < GObject::Object
    ...
    GICrystal.declare_new_method(Gtk::AbstractStyleProvider, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_style_provider_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::AbstractStyleProvider.new(Void*, GICrystal::Transfer)
