  ...
  class ShortcutLabel < Widget
    ...
    def self._register_derived_type(class_name : String, class_init, instance_init)
      LibGObject.g_type_register_static_simple(g_type, class_name,
        sizeof(LibGtk::ShortcutLabelClass), class_init,
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_shortcut_label_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::ShortcutLabel.new(Void*, GICrystal::Transfer)
    ...
    def self.new(accelerator : ::String) : self
      ...
      # C call
      _retval = LibGtk.gtk_shortcut_label_new(accelerator)

      # Return value handling
      Gtk::ShortcutLabel.new(_retval, GICrystal::Transfer::Full)
    end
    ...
    def accelerator : ::String?
      ...
      # C call
      _retval = LibGtk.gtk_shortcut_label_get_accelerator(to_unsafe)
    ...
    def disabled_text : ::String?
      ...
      # C call
      _retval = LibGtk.gtk_shortcut_label_get_disabled_text(to_unsafe)
    ...
    def accelerator=(accelerator : ::String) : Nil
      ...
      # C call
      LibGtk.gtk_shortcut_label_set_accelerator(to_unsafe, accelerator)
    ...
    def disabled_text=(disabled_text : ::String) : Nil
      ...
      # C call
      LibGtk.gtk_shortcut_label_set_disabled_text(to_unsafe, disabled_text)
