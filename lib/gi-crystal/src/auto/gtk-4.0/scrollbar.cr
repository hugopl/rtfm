...
module Gtk
  ...
  class Scrollbar < Widget
    ...
    GICrystal.declare_new_method(Scrollbar, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_scrollbar_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::Scrollbar.new(Void*, GICrystal::Transfer)
    ...
    def self.new(orientation : Gtk::Orientation, adjustment : Gtk::Adjustment?) : self
      ...
      # C call
      _retval = LibGtk.gtk_scrollbar_new(orientation, adjustment)
    ...
    def adjustment : Gtk::Adjustment
      ...
      # C call
      _retval = LibGtk.gtk_scrollbar_get_adjustment(to_unsafe)
    ...
    def adjustment=(adjustment : Gtk::Adjustment?) : Nil
      ...
      # C call
      LibGtk.gtk_scrollbar_set_adjustment(to_unsafe, adjustment)
