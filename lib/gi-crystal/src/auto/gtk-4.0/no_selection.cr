...
module Gtk
  ...
  class NoSelection < GObject::Object
    ...
    GICrystal.declare_new_method(NoSelection, g_object_get_qdata)

    # Initialize a new `NoSelection`.
    def initialize
      super
    end
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_no_selection_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::NoSelection.new(Void*, GICrystal::Transfer)
    ...
    def model : Gio::ListModel?
      ...
      # C call
      _retval = LibGtk.gtk_no_selection_get_model(to_unsafe)
    ...
    def model=(model : Gio::ListModel?) : Nil
      ...
      # C call
      LibGtk.gtk_no_selection_set_model(to_unsafe, model)
