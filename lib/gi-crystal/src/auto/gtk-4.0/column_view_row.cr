  ...
  class ColumnViewRow < GObject::Object
    ...
    def self._register_derived_type(class_name : String, class_init, instance_init)
      LibGObject.g_type_register_static_simple(g_type, class_name,
        sizeof(LibGtk::ColumnViewRowClass), class_init,
        sizeof(LibGtk::ColumnViewRow), instance_init, 0)
    end

    GICrystal.declare_new_method(ColumnViewRow, g_object_get_qdata)

    # Initialize a new `ColumnViewRow`.
    def initialize
      super
    end
    ...
    def initialize(*, accessible_description : ::String? = nil, accessible_label : ::String? = nil, activatable : Bool? = nil, focusable : Bool? = nil, item : GObject::Object? = nil, position : UInt32? = nil, selectable : Bool? = nil, selected : Bool? = nil)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_column_view_row_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::ColumnViewRow.new(Void*, GICrystal::Transfer)
    ...
    def accessible_description : ::String
      # gtk_column_view_row_get_accessible_description: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibGtk.gtk_column_view_row_get_accessible_description(to_unsafe)
    ...
    def accessible_label : ::String
      # gtk_column_view_row_get_accessible_label: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibGtk.gtk_column_view_row_get_accessible_label(to_unsafe)
    ...
    def activatable : Bool
      # gtk_column_view_row_get_activatable: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibGtk.gtk_column_view_row_get_activatable(to_unsafe)
    ...
    def focusable : Bool
      # gtk_column_view_row_get_focusable: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibGtk.gtk_column_view_row_get_focusable(to_unsafe)
    ...
    def item : GObject::Object?
      # gtk_column_view_row_get_item: (Method | Getter)
      # Returns: (transfer none) (nullable)

      # C call
      _retval = LibGtk.gtk_column_view_row_get_item(to_unsafe)
    ...
    def position : UInt32
      # gtk_column_view_row_get_position: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibGtk.gtk_column_view_row_get_position(to_unsafe)
    ...
    def selectable : Bool
      # gtk_column_view_row_get_selectable: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibGtk.gtk_column_view_row_get_selectable(to_unsafe)
    ...
    def selected : Bool
      # gtk_column_view_row_get_selected: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibGtk.gtk_column_view_row_get_selected(to_unsafe)
    ...
    def accessible_description=(description : ::String) : Nil
      # gtk_column_view_row_set_accessible_description: (Method | Setter)
      # @description:
      # Returns: (transfer none)

      # C call
      LibGtk.gtk_column_view_row_set_accessible_description(to_unsafe, description)

      # Return value handling
    end

    def accessible_label=(label : ::String) : Nil
      # gtk_column_view_row_set_accessible_label: (Method | Setter)
      # @label:
      # Returns: (transfer none)

      # C call
      LibGtk.gtk_column_view_row_set_accessible_label(to_unsafe, label)

      # Return value handling
    end

    def activatable=(activatable : Bool) : Nil
      # gtk_column_view_row_set_activatable: (Method | Setter)
      # @activatable:
      # Returns: (transfer none)

      # C call
      LibGtk.gtk_column_view_row_set_activatable(to_unsafe, activatable)

      # Return value handling
    end

    def focusable=(focusable : Bool) : Nil
      # gtk_column_view_row_set_focusable: (Method | Setter)
      # @focusable:
      # Returns: (transfer none)

      # C call
      LibGtk.gtk_column_view_row_set_focusable(to_unsafe, focusable)

      # Return value handling
    end

    def selectable=(selectable : Bool) : Nil
      # gtk_column_view_row_set_selectable: (Method | Setter)
      # @selectable:
      # Returns: (transfer none)

      # C call
      LibGtk.gtk_column_view_row_set_selectable(to_unsafe, selectable)
