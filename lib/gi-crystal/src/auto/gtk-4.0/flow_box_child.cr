  ...
  class FlowBoxChild < Widget
    ...
    def self._register_derived_type(class_name : String, class_init, instance_init)
      LibGObject.g_type_register_static_simple(g_type, class_name,
        sizeof(LibGtk::FlowBoxChildClass), class_init,
        sizeof(LibGtk::FlowBoxChild), instance_init, 0)
    end

    GICrystal.declare_new_method(FlowBoxChild, g_object_get_qdata)

    # Initialize a new `FlowBoxChild`.
    def initialize
      super
    end
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_flow_box_child_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::FlowBoxChild.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      # gtk_flow_box_child_new: (Constructor)
      # Returns: (transfer none)

      # C call
      _retval = LibGtk.gtk_flow_box_child_new

      # Return value handling
      Gtk::FlowBoxChild.new(_retval, GICrystal::Transfer::Full)
    end

    def changed : Nil
      # gtk_flow_box_child_changed: (Method)
      # Returns: (transfer none)

      # C call
      LibGtk.gtk_flow_box_child_changed(to_unsafe)
    ...
    def child : Gtk::Widget?
      ...
      # C call
      _retval = LibGtk.gtk_flow_box_child_get_child(to_unsafe)
    ...
    def index : Int32
      # gtk_flow_box_child_get_index: (Method)
      # Returns: (transfer none)

      # C call
      _retval = LibGtk.gtk_flow_box_child_get_index(to_unsafe)
    ...
    def is_selected : Bool
      # gtk_flow_box_child_is_selected: (Method)
      # Returns: (transfer none)

      # C call
      _retval = LibGtk.gtk_flow_box_child_is_selected(to_unsafe)
    ...
    def child=(child : Gtk::Widget?) : Nil
      ...
      # C call
      LibGtk.gtk_flow_box_child_set_child(to_unsafe, child)
    ...
    struct ActivateSignal < GObject::Signal
      ...
      def connect(handler : Proc(Gtk::FlowBoxChild, Nil), *, after : Bool = false) : GObject::SignalConnection
        _box = ::Box.box(handler)
        handler = ->(_lib_sender : Pointer(Void), _lib_box : Pointer(Void)) {
          _sender = Gtk::FlowBoxChild.new(_lib_sender, GICrystal::Transfer::None)
          ::Box(Proc(Gtk::FlowBoxChild, Nil)).unbox(_lib_box).call(_sender)
        }.pointer
