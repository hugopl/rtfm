...
module Gtk
  ...
  class AnyFilter < MultiFilter
    ...
    GICrystal.declare_new_method(AnyFilter, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_any_filter_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::AnyFilter.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      ...
      Gtk::AnyFilter.new(_retval, GICrystal::Transfer::Full)
    end
