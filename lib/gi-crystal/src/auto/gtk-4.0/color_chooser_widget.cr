...
module Gtk
  ...
  class ColorChooserWidget < Widget
    ...
    GICrystal.declare_new_method(ColorChooserWidget, g_object_get_qdata)

    # Initialize a new `ColorChooserWidget`.
    def initialize
      super
    end
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_color_chooser_widget_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::ColorChooserWidget.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      ...
      # C call
      _retval = LibGtk.gtk_color_chooser_widget_new

      # Return value handling
      Gtk::ColorChooserWidget.new(_retval, GICrystal::Transfer::Full)
    end
