...
module Gtk
  ...
  class ListBoxRow < Widget
    ...
    GICrystal.declare_new_method(ListBoxRow, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_list_box_row_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::ListBoxRow.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      ...
      Gtk::ListBoxRow.new(_retval, GICrystal::Transfer::Full)
    end
    ...
    def changed : Nil
      ...
      # C call
      LibGtk.gtk_list_box_row_changed(to_unsafe)
    ...
    def activatable : Bool
      ...
      # C call
      _retval = LibGtk.gtk_list_box_row_get_activatable(to_unsafe)
    ...
    def child : Gtk::Widget?
      ...
      # C call
      _retval = LibGtk.gtk_list_box_row_get_child(to_unsafe)
    ...
    def header : Gtk::Widget?
      ...
      # C call
      _retval = LibGtk.gtk_list_box_row_get_header(to_unsafe)
    ...
    def index : Int32
      ...
      # C call
      _retval = LibGtk.gtk_list_box_row_get_index(to_unsafe)
    ...
    def selectable : Bool
      ...
      # C call
      _retval = LibGtk.gtk_list_box_row_get_selectable(to_unsafe)
    ...
    def is_selected : Bool
      ...
      # C call
      _retval = LibGtk.gtk_list_box_row_is_selected(to_unsafe)
    ...
    def activatable=(activatable : Bool) : Nil
      ...
      # C call
      LibGtk.gtk_list_box_row_set_activatable(to_unsafe, activatable)
    ...
    def child=(child : Gtk::Widget?) : Nil
      ...
      # C call
      LibGtk.gtk_list_box_row_set_child(to_unsafe, child)
    ...
    def header=(header : Gtk::Widget?) : Nil
      ...
      # C call
      LibGtk.gtk_list_box_row_set_header(to_unsafe, header)
    ...
    def selectable=(selectable : Bool) : Nil
      ...
      # C call
      LibGtk.gtk_list_box_row_set_selectable(to_unsafe, selectable)
    ...
    struct ActivateSignal < GObject::Signal
      ...
      def connect(handler : Proc(Gtk::ListBoxRow, Nil), *, after : Bool = false) : GObject::SignalConnection
        _box = ::Box.box(handler)
        handler = ->(_lib_sender : Pointer(Void), _lib_box : Pointer(Void)) {
          _sender = Gtk::ListBoxRow.new(_lib_sender, GICrystal::Transfer::None)
          ::Box(Proc(Gtk::ListBoxRow, Nil)).unbox(_lib_box).call(_sender)
        }.pointer
