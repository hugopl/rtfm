...
module Gtk
  ...
  class Separator < Widget
    ...
    GICrystal.declare_new_method(Separator, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_separator_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::Separator.new(Void*, GICrystal::Transfer)
    ...
    def self.new(orientation : Gtk::Orientation) : self
      ...
      # C call
      _retval = LibGtk.gtk_separator_new(orientation)
