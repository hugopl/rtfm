...
module Gtk
  ...
  class FlattenListModel < GObject::Object
    ...
    GICrystal.declare_new_method(FlattenListModel, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_flatten_list_model_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::FlattenListModel.new(Void*, GICrystal::Transfer)
    ...
    def model : Gio::ListModel?
      ...
      # C call
      _retval = LibGtk.gtk_flatten_list_model_get_model(to_unsafe)
    ...
    def model_for_item(position : UInt32) : Gio::ListModel?
      ...
      # C call
      _retval = LibGtk.gtk_flatten_list_model_get_model_for_item(to_unsafe, position)
    ...
    def model=(model : Gio::ListModel?) : Nil
      ...
      # C call
      LibGtk.gtk_flatten_list_model_set_model(to_unsafe, model)
