  ...
  class Box < Widget
    ...
    def self._register_derived_type(class_name : String, class_init, instance_init)
      LibGObject.g_type_register_static_simple(g_type, class_name,
        sizeof(LibGtk::BoxClass), class_init,
        sizeof(LibGtk::Box), instance_init, 0)
    end

    GICrystal.declare_new_method(Box, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_box_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::Box.new(Void*, GICrystal::Transfer)
    ...
    def append(child : Gtk::Widget) : Nil
      ...
      # C call
      LibGtk.gtk_box_append(to_unsafe, child)

      # Return value handling
    end

    def baseline_child : Int32
      # gtk_box_get_baseline_child: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibGtk.gtk_box_get_baseline_child(to_unsafe)
    ...
    def baseline_position : Gtk::BaselinePosition
      ...
      # C call
      _retval = LibGtk.gtk_box_get_baseline_position(to_unsafe)
    ...
    def homogeneous : Bool
      ...
      # C call
      _retval = LibGtk.gtk_box_get_homogeneous(to_unsafe)
    ...
    def spacing : Int32
      ...
      # C call
      _retval = LibGtk.gtk_box_get_spacing(to_unsafe)
    ...
    def insert_child_after(child : Gtk::Widget, sibling : Gtk::Widget?) : Nil
      ...
      # C call
      LibGtk.gtk_box_insert_child_after(to_unsafe, child, sibling)
    ...
    def prepend(child : Gtk::Widget) : Nil
      ...
      # C call
      LibGtk.gtk_box_prepend(to_unsafe, child)
    ...
    def remove(child : Gtk::Widget) : Nil
      ...
      # C call
      LibGtk.gtk_box_remove(to_unsafe, child)
    ...
    def reorder_child_after(child : Gtk::Widget, sibling : Gtk::Widget?) : Nil
      ...
      # C call
      LibGtk.gtk_box_reorder_child_after(to_unsafe, child, sibling)

      # Return value handling
    end

    def baseline_child=(child : Int32) : Nil
      # gtk_box_set_baseline_child: (Method | Setter)
      # @child:
      # Returns: (transfer none)

      # C call
      LibGtk.gtk_box_set_baseline_child(to_unsafe, child)
    ...
    def baseline_position=(position : Gtk::BaselinePosition) : Nil
      ...
      # C call
      LibGtk.gtk_box_set_baseline_position(to_unsafe, position)
    ...
    def homogeneous=(homogeneous : Bool) : Nil
      ...
      # C call
      LibGtk.gtk_box_set_homogeneous(to_unsafe, homogeneous)
    ...
    def spacing=(spacing : Int32) : Nil
      ...
      # C call
      LibGtk.gtk_box_set_spacing(to_unsafe, spacing)
