...
module Gtk
  ...
  class ActivateAction < ShortcutAction
    ...
    GICrystal.declare_new_method(ActivateAction, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_activate_action_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::ActivateAction.new(Void*, GICrystal::Transfer)
