...
module Gtk
  ...
  class CustomLayout < LayoutManager
    ...
    GICrystal.declare_new_method(CustomLayout, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_custom_layout_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::CustomLayout.new(Void*, GICrystal::Transfer)
