...
module Gtk
  ...
  class Revealer < Widget
    ...
    GICrystal.declare_new_method(Revealer, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_revealer_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::Revealer.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      ...
      Gtk::Revealer.new(_retval, GICrystal::Transfer::Full)
    end
    ...
    def child : Gtk::Widget?
      ...
      # C call
      _retval = LibGtk.gtk_revealer_get_child(to_unsafe)
    ...
    def child_revealed : Bool
      ...
      # C call
      _retval = LibGtk.gtk_revealer_get_child_revealed(to_unsafe)
    ...
    def reveal_child : Bool
      ...
      # C call
      _retval = LibGtk.gtk_revealer_get_reveal_child(to_unsafe)
    ...
    def transition_duration : UInt32
      ...
      # C call
      _retval = LibGtk.gtk_revealer_get_transition_duration(to_unsafe)
    ...
    def transition_type : Gtk::RevealerTransitionType
      ...
      # C call
      _retval = LibGtk.gtk_revealer_get_transition_type(to_unsafe)
    ...
    def child=(child : Gtk::Widget?) : Nil
      ...
      # C call
      LibGtk.gtk_revealer_set_child(to_unsafe, child)
    ...
    def reveal_child=(reveal_child : Bool) : Nil
      ...
      # C call
      LibGtk.gtk_revealer_set_reveal_child(to_unsafe, reveal_child)
    ...
    def transition_duration=(duration : UInt32) : Nil
      ...
      # C call
      LibGtk.gtk_revealer_set_transition_duration(to_unsafe, duration)
    ...
    def transition_type=(transition : Gtk::RevealerTransitionType) : Nil
      ...
      # C call
      LibGtk.gtk_revealer_set_transition_type(to_unsafe, transition)
