...
module Gtk
  ...
  class ToggleButton < Button
    ...
    GICrystal.declare_new_method(ToggleButton, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_toggle_button_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::ToggleButton.new(Void*, GICrystal::Transfer)
    ...
    def active : Bool
      ...
      # C call
      _retval = LibGtk.gtk_toggle_button_get_active(to_unsafe)
    ...
    def active=(is_active : Bool) : Nil
      ...
      # C call
      LibGtk.gtk_toggle_button_set_active(to_unsafe, is_active)
    ...
    def group=(group : Gtk::ToggleButton?) : Nil
      ...
      # C call
      LibGtk.gtk_toggle_button_set_group(to_unsafe, group)
    ...
    def toggled : Nil
      ...
      # C call
      LibGtk.gtk_toggle_button_toggled(to_unsafe)
    ...
    struct ToggledSignal < GObject::Signal
      ...
      def connect(handler : Proc(Gtk::ToggleButton, Nil), *, after : Bool = false) : GObject::SignalConnection
        _box = ::Box.box(handler)
        handler = ->(_lib_sender : Pointer(Void), _lib_box : Pointer(Void)) {
