...
module Gtk
  ...
  class StackSwitcher < Widget
    ...
    GICrystal.declare_new_method(StackSwitcher, g_object_get_qdata)

    # Initialize a new `StackSwitcher`.
    def initialize
      super
    end
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_stack_switcher_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::StackSwitcher.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      ...
      # C call
      _retval = LibGtk.gtk_stack_switcher_new

      # Return value handling
      Gtk::StackSwitcher.new(_retval, GICrystal::Transfer::Full)
    end
    ...
    def stack : Gtk::Stack?
      ...
      # C call
      _retval = LibGtk.gtk_stack_switcher_get_stack(to_unsafe)
    ...
    def stack=(stack : Gtk::Stack?) : Nil
      ...
      # C call
      LibGtk.gtk_stack_switcher_set_stack(to_unsafe, stack)
