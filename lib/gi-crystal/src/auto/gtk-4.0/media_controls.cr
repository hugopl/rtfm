  ...
  class MediaControls < Widget
    ...
    def self._register_derived_type(class_name : String, class_init, instance_init)
      LibGObject.g_type_register_static_simple(g_type, class_name,
        sizeof(LibGtk::MediaControlsClass), class_init,
        sizeof(LibGtk::MediaControls), instance_init, 0)
    end

    GICrystal.declare_new_method(MediaControls, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_media_controls_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::MediaControls.new(Void*, GICrystal::Transfer)
    ...
    def self.new(stream : Gtk::MediaStream?) : self
      ...
      # C call
      _retval = LibGtk.gtk_media_controls_new(stream)
    ...
    def media_stream : Gtk::MediaStream?
      ...
      # C call
      _retval = LibGtk.gtk_media_controls_get_media_stream(to_unsafe)
    ...
    def media_stream=(stream : Gtk::MediaStream?) : Nil
      ...
      # C call
      LibGtk.gtk_media_controls_set_media_stream(to_unsafe, stream)
