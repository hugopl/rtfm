...
module Gtk
  ...
  class ActionBar < Widget
    ...
    GICrystal.declare_new_method(ActionBar, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_action_bar_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::ActionBar.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      ...
      Gtk::ActionBar.new(_retval, GICrystal::Transfer::Full)
    end
    ...
    def center_widget : Gtk::Widget?
      ...
      # C call
      _retval = LibGtk.gtk_action_bar_get_center_widget(to_unsafe)
    ...
    def revealed : Bool
      ...
      # C call
      _retval = LibGtk.gtk_action_bar_get_revealed(to_unsafe)
    ...
    def pack_end(child : Gtk::Widget) : Nil
      ...
      # C call
      LibGtk.gtk_action_bar_pack_end(to_unsafe, child)
    ...
    def pack_start(child : Gtk::Widget) : Nil
      ...
      # C call
      LibGtk.gtk_action_bar_pack_start(to_unsafe, child)
    ...
    def remove(child : Gtk::Widget) : Nil
      ...
      # C call
      LibGtk.gtk_action_bar_remove(to_unsafe, child)
    ...
    def center_widget=(center_widget : Gtk::Widget?) : Nil
      ...
      # C call
      LibGtk.gtk_action_bar_set_center_widget(to_unsafe, center_widget)
    ...
    def revealed=(revealed : Bool) : Nil
      ...
      # C call
      LibGtk.gtk_action_bar_set_revealed(to_unsafe, revealed)
