  ...
  class WindowHandle < Widget
    ...
    def self._register_derived_type(class_name : String, class_init, instance_init)
      LibGObject.g_type_register_static_simple(g_type, class_name,
        sizeof(LibGtk::WindowHandleClass), class_init,
        sizeof(LibGtk::WindowHandle), instance_init, 0)
    end

    GICrystal.declare_new_method(WindowHandle, g_object_get_qdata)

    # Initialize a new `WindowHandle`.
    def initialize
      super
    end
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_window_handle_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::WindowHandle.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      ...
      Gtk::WindowHandle.new(_retval, GICrystal::Transfer::Full)
    end
    ...
    def child : Gtk::Widget?
      ...
      # C call
      _retval = LibGtk.gtk_window_handle_get_child(to_unsafe)
    ...
    def child=(child : Gtk::Widget?) : Nil
      ...
      # C call
      LibGtk.gtk_window_handle_set_child(to_unsafe, child)
