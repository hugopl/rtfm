...
module Gtk
  ...
  class CellRendererCombo < CellRendererText
    ...
    GICrystal.declare_new_method(CellRendererCombo, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_cell_renderer_combo_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::CellRendererCombo.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      ...
      Gtk::CellRendererCombo.new(_retval, GICrystal::Transfer::Full)
    end
    ...
    struct ChangedSignal < GObject::Signal
      ...
      def connect(handler : Proc(::String, Gtk::TreeIter, Nil), *, after : Bool = false) : GObject::SignalConnection
        ...
        handler = ->(_lib_sender : Pointer(Void), lib_path_string : Pointer(LibC::Char), lib_new_iter : Pointer(Void), _lib_box : Pointer(Void)) {
          ...
          # Generator::BuiltInTypeArgPlan
          new_iter = Gtk::TreeIter.new(lib_new_iter, GICrystal::Transfer::None)
