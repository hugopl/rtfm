...
module Gtk
  ...
  class FontChooserWidget < Widget
    ...
    GICrystal.declare_new_method(FontChooserWidget, g_object_get_qdata)

    # Initialize a new `FontChooserWidget`.
    def initialize
      super
    end
    ...
    def initialize(*, accessible_role : Gtk::AccessibleRole? = nil, can_focus : Bool? = nil, can_target : Bool? = nil, css_classes : Enumerable(::String)? = nil, css_name : ::String? = nil, cursor : Gdk::Cursor? = nil, focus_on_click : Bool? = nil, focusable : Bool? = nil, font : ::String? = nil, font_desc : Pango::FontDescription? = nil, font_features : ::String? = nil, halign : Gtk::Align? = nil, has_default : Bool? = nil, has_focus : Bool? = nil, has_tooltip : Bool? = nil, height_request : Int32? = nil, hexpand : Bool? = nil, hexpand_set : Bool? = nil, language : ::String? = nil, layout_manager : Gtk::LayoutManager? = nil, level : Gtk::FontChooserLevel? = nil, limit_events : Bool? = nil, margin_bottom : Int32? = nil, margin_end : Int32? = nil, margin_start : Int32? = nil, margin_top : Int32? = nil, name : ::String? = nil, opacity : Float64? = nil, overflow : Gtk::Overflow? = nil, parent : Gtk::Widget? = nil, preview_text : ::String? = nil, receives_default : Bool? = nil, root : Gtk::Root? = nil, scale_factor : Int32? = nil, sensitive : Bool? = nil, show_preview_entry : Bool? = nil, tooltip_markup : ::String? = nil, tooltip_text : ::String? = nil, tweak_action : Gio::Action? = nil, valign : Gtk::Align? = nil, vexpand : Bool? = nil, vexpand_set : Bool? = nil, visible : Bool? = nil, width_request : Int32? = nil)
      ...
      if !tweak_action.nil?
        (_names.to_unsafe + _n).value = "tweak-action".to_unsafe
        GObject::Value.init_g_value(_values.to_unsafe + _n, tweak_action)
        _n += 1
      end
      if !valign.nil?
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_font_chooser_widget_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::FontChooserWidget.new(Void*, GICrystal::Transfer)
    ...
    def tweak_action : Gio::Action?
      ...
      Gio::AbstractAction.new(value, GICrystal::Transfer::None) unless value.null?
    end
    ...
    def self.new : self
      ...
      # C call
      _retval = LibGtk.gtk_font_chooser_widget_new

      # Return value handling
      Gtk::FontChooserWidget.new(_retval, GICrystal::Transfer::Full)
    end
