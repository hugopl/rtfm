...
module Gtk
  ...
  class ConstraintLayoutChild < LayoutChild
    ...
    GICrystal.declare_new_method(ConstraintLayoutChild, g_object_get_qdata)

    # Initialize a new `ConstraintLayoutChild`.
    def initialize
      super
    end
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_constraint_layout_child_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::ConstraintLayoutChild.new(Void*, GICrystal::Transfer)
