  ...
  class ListBase < Widget
    ...
    def self._register_derived_type(class_name : String, class_init, instance_init)
      LibGObject.g_type_register_static_simple(g_type, class_name,
        sizeof(LibGtk::ListBaseClass), class_init,
        sizeof(LibGtk::ListBase), instance_init, 0)
    end

    GICrystal.declare_new_method(ListBase, g_object_get_qdata)

    # Initialize a new `ListBase`.
    def initialize
      super
    end
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_list_base_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::ListBase.new(Void*, GICrystal::Transfer)
