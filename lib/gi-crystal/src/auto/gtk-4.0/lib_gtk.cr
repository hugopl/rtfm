...
lib LibGtk
  ...
  # Enums
  type AccessibleAnnouncementPriority = UInt32
  type AccessibleAutocomplete = UInt32
  type AccessibleInvalidState = UInt32
  type AccessiblePlatformState = UInt32
  ...
  type AccessibleTextContentChange = UInt32
  type AccessibleTextGranularity = UInt32
  ...
  type FontLevel = UInt32
  type FontRendering = UInt32
  type GraphicsOffloadEnabled = UInt32
  ...
  alias PrintJobCompleteFunc = Pointer(LibGtk::PrintJob), Pointer(Void), Pointer(LibGLib::Error) -> Void
  ...
  alias TextBufferCommitNotify = Pointer(LibGtk::TextBuffer), UInt32, UInt32, UInt32, Pointer(Void) -> Void
  ...
  struct AccessibleRangeInterface # 24 bytes long
    g_iface : LibGObject::TypeInterface
  ...
  struct AlertDialogClass # 136 bytes long
  ...
  struct ColorDialogButtonClass # 408 bytes long
    parent_class : LibGtk::WidgetClass
  end

  struct ColorDialogClass # 136 bytes long
    parent_class : LibGObject::ObjectClass
  end

  type ColumnViewCellClass = Void # Struct with zero bytes

  type ColumnViewClass = Void # Struct with zero bytes

  type ColumnViewColumnClass = Void # Struct with zero bytes

  type ColumnViewRowClass = Void # Struct with zero bytes

  struct ColumnViewSorterClass # 216 bytes long
  ...
  struct FileDialogClass # 136 bytes long
    parent_class : LibGObject::ObjectClass
  end

  struct FileLauncherClass # 136 bytes long
    parent_class : LibGObject::ObjectClass
  end
  ...
  struct FontDialogButtonClass # 408 bytes long
    parent_class : LibGtk::WidgetClass
  end

  struct FontDialogClass # 136 bytes long
    parent_class : LibGObject::ObjectClass
  end
  ...
  struct GraphicsOffloadClass # 408 bytes long
    parent_class : LibGtk::WidgetClass
  end
  ...
  type ListHeaderClass = Void # Struct with zero bytes
  ...
  struct PrintDialogClass # 136 bytes long
    parent_class : LibGObject::ObjectClass
  end
  ...
  type PrintSetup = Void # Struct with zero bytes
  ...
  type ScrollInfo = Void # Struct with zero bytes
  ...
  struct SectionModelInterface # 24 bytes long
    g_iface : LibGObject::TypeInterface
    get_section : Void*
  end
  ...
  struct UriLauncherClass # 136 bytes long
    parent_class : LibGObject::ObjectClass
  end
  ...
  type AlertDialog = Void # Object struct with no fields
  ...
  type ColorDialog = Void # Object struct with no fields

  type ColorDialogButton = Void # Object struct with no fields

  type ColumnView = Void # Object struct with no fields

  type ColumnViewCell = Void # Object struct with no fields

  type ColumnViewColumn = Void # Object struct with no fields

  type ColumnViewRow = Void # Object struct with no fields

  type ColumnViewSorter = Void # Object struct with no fields
  ...
  type FileDialog = Void # Object struct with no fields

  type FileFilter = Void # Object struct with no fields

  type FileLauncher = Void # Object struct with no fields
  ...
  type FontDialog = Void # Object struct with no fields

  type FontDialogButton = Void # Object struct with no fields
  ...
  type GraphicsOffload = Void # Object struct with no fields
  ...
  type Inscription = Void # Object struct with no fields
  ...
  type ListHeader = Void # Object struct with no fields
  ...
  type PrintDialog = Void # Object struct with no fields
  ...
  fun gtk_accessible_get_bounds(this : Void*, x : Pointer(Int32), y : Pointer(Int32), width : Pointer(Int32), height : Pointer(Int32)) : LibC::Int
  fun gtk_accessible_get_first_accessible_child(this : Void*) : Pointer(Void)
  ...
  fun gtk_accessible_list_new_from_array(accessibles : Pointer(Pointer(LibGtk::Accessible)), n_accessibles : UInt64) : Pointer(Void)
  fun gtk_accessible_list_new_from_list(list : Pointer(LibGLib::List)) : Pointer(Void)
  fun gtk_accessible_platform_state_get_type : UInt64
  fun gtk_accessible_property_get_type : UInt64
  fun gtk_accessible_property_init_value(property : UInt32, value : Pointer(Void)) : Void
  fun gtk_accessible_range_get_type : UInt64
  fun gtk_accessible_relation_get_type : UInt64
  ...
  fun gtk_accessible_role_get_type : UInt64
  fun gtk_accessible_set_accessible_parent(this : Void*, parent : Pointer(Void), next_sibling : Pointer(Void)) : Void
  fun gtk_accessible_sort_get_type : UInt64
  fun gtk_accessible_state_get_type : UInt64
  fun gtk_accessible_state_init_value(state : UInt32, value : Pointer(Void)) : Void
  fun gtk_accessible_text_content_change_get_type : UInt64
  fun gtk_accessible_text_get_type : UInt64
  fun gtk_accessible_text_granularity_get_type : UInt64
  fun gtk_accessible_text_update_caret_position(this : Void*) : Void
  fun gtk_accessible_text_update_contents(this : Void*, change : UInt32, start : UInt32, _end : UInt32) : Void
  fun gtk_accessible_text_update_selection_bound(this : Void*) : Void
  fun gtk_accessible_tristate_get_type : UInt64
  fun gtk_accessible_update_next_accessible_sibling(this : Void*, new_sibling : Pointer(Void)) : Void
  fun gtk_accessible_update_platform_state(this : Void*, state : UInt32) : Void
  fun gtk_accessible_update_property_value(this : Void*, n_properties : Int32, properties : Pointer(UInt32), values : Pointer(LibGObject::Value)) : Void
  fun gtk_accessible_update_relation_value(this : Void*, n_relations : Int32, relations : Pointer(UInt32), values : Pointer(LibGObject::Value)) : Void
  fun gtk_accessible_update_state_value(this : Void*, n_states : Int32, states : Pointer(UInt32), values : Pointer(LibGObject::Value)) : Void
  ...
  fun gtk_alert_dialog_choose(this : Void*, parent : Pointer(Void), cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  fun gtk_alert_dialog_choose_finish(this : Void*, result : Pointer(Void), error : LibGLib::Error**) : Int32
  fun gtk_alert_dialog_get_buttons(this : Void*) : Pointer(Pointer(LibC::Char))
  fun gtk_alert_dialog_get_cancel_button(this : Void*) : Int32
  fun gtk_alert_dialog_get_default_button(this : Void*) : Int32
  fun gtk_alert_dialog_get_detail(this : Void*) : Pointer(LibC::Char)
  fun gtk_alert_dialog_get_message(this : Void*) : Pointer(LibC::Char)
  fun gtk_alert_dialog_get_modal(this : Void*) : LibC::Int
  fun gtk_alert_dialog_get_type : UInt64
  fun gtk_alert_dialog_set_buttons(this : Void*, labels : Pointer(Pointer(LibC::Char))) : Void
  fun gtk_alert_dialog_set_cancel_button(this : Void*, button : Int32) : Void
  fun gtk_alert_dialog_set_default_button(this : Void*, button : Int32) : Void
  fun gtk_alert_dialog_set_detail(this : Void*, detail : Pointer(LibC::Char)) : Void
  fun gtk_alert_dialog_set_message(this : Void*, message : Pointer(LibC::Char)) : Void
  fun gtk_alert_dialog_set_modal(this : Void*, modal : LibC::Int) : Void
  fun gtk_alert_dialog_show(this : Void*, parent : Pointer(Void)) : Void
  fun gtk_align_get_type : UInt64
  ...
  fun gtk_application_inhibit_flags_get_type : UInt64
  ...
  fun gtk_arrow_type_get_type : UInt64
  ...
  fun gtk_assistant_page_type_get_type : UInt64
  ...
  fun gtk_baseline_position_get_type : UInt64
  ...
  fun gtk_border_style_get_type : UInt64
  fun gtk_box_append(this : Void*, child : Pointer(Void)) : Void
  fun gtk_box_get_baseline_child(this : Void*) : Int32
  ...
  fun gtk_box_layout_get_baseline_child(this : Void*) : Int32
  ...
  fun gtk_box_layout_set_baseline_child(this : Void*, child : Int32) : Void
  ...
  fun gtk_box_set_baseline_child(this : Void*, child : Int32) : Void
  ...
  fun gtk_builder_closure_flags_get_type : UInt64
  ...
  fun gtk_builder_error_get_type : UInt64
  ...
  fun gtk_button_get_can_shrink(this : Void*) : LibC::Int
  ...
  fun gtk_button_set_can_shrink(this : Void*, can_shrink : LibC::Int) : Void
  ...
  fun gtk_calendar_get_year(this : Void*) : Int32
  ...
  fun gtk_calendar_set_year(this : Void*, year : Int32) : Void
  ...
  fun gtk_cclosure_expression_new(value_type : UInt64, marshal : Void*, n_params : UInt32, params : Pointer(Pointer(LibGtk::Expression)), callback_func : Void*, user_data : Pointer(Void), user_destroy : Void*) : Pointer(Void)
  ...
  fun gtk_cell_area_class_list_cell_properties(this : Void*, n_properties : Pointer(UInt32)) : Pointer(Pointer(LibGObject::ParamSpec))
  ...
  fun gtk_cell_renderer_accel_mode_get_type : UInt64
  ...
  fun gtk_cell_renderer_mode_get_type : UInt64
  ...
  fun gtk_cell_renderer_state_get_type : UInt64
  ...
  fun gtk_center_box_get_shrink_center_last(this : Void*) : LibC::Int
  ...
  fun gtk_center_box_set_shrink_center_last(this : Void*, shrink_center_last : LibC::Int) : Void
  ...
  fun gtk_center_layout_get_shrink_center_last(this : Void*) : LibC::Int
  ...
  fun gtk_center_layout_set_shrink_center_last(this : Void*, shrink_center_last : LibC::Int) : Void
  ...
  fun gtk_check_button_get_child(this : Void*) : Pointer(Void)
  ...
  fun gtk_check_button_set_child(this : Void*, child : Pointer(Void)) : Void
  ...
  fun gtk_closure_expression_new(value_type : UInt64, closure : Pointer(Void), n_params : UInt32, params : Pointer(Pointer(LibGtk::Expression))) : Pointer(Void)
  fun gtk_collation_get_type : UInt64
  ...
  fun gtk_color_chooser_add_palette(this : Void*, orientation : UInt32, colors_per_line : Int32, n_colors : Int32, colors : Pointer(LibGdk::RGBA)) : Void
  ...
  fun gtk_color_dialog_button_get_dialog(this : Void*) : Pointer(Void)
  fun gtk_color_dialog_button_get_rgba(this : Void*) : Pointer(Void)
  fun gtk_color_dialog_button_get_type : UInt64
  fun gtk_color_dialog_button_new(dialog : Pointer(Void)) : Pointer(Void)
  fun gtk_color_dialog_button_set_dialog(this : Void*, dialog : Pointer(Void)) : Void
  fun gtk_color_dialog_button_set_rgba(this : Void*, color : Pointer(Void)) : Void
  fun gtk_color_dialog_choose_rgba(this : Void*, parent : Pointer(Void), initial_color : Pointer(Void), cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  fun gtk_color_dialog_choose_rgba_finish(this : Void*, result : Pointer(Void), error : LibGLib::Error**) : Pointer(Void)
  fun gtk_color_dialog_get_modal(this : Void*) : LibC::Int
  fun gtk_color_dialog_get_title(this : Void*) : Pointer(LibC::Char)
  fun gtk_color_dialog_get_type : UInt64
  fun gtk_color_dialog_get_with_alpha(this : Void*) : LibC::Int
  fun gtk_color_dialog_new : Pointer(Void)
  fun gtk_color_dialog_set_modal(this : Void*, modal : LibC::Int) : Void
  fun gtk_color_dialog_set_title(this : Void*, title : Pointer(LibC::Char)) : Void
  fun gtk_color_dialog_set_with_alpha(this : Void*, with_alpha : LibC::Int) : Void
  fun gtk_column_view_append_column(this : Void*, column : Pointer(Void)) : Void
  fun gtk_column_view_cell_get_child(this : Void*) : Pointer(Void)
  fun gtk_column_view_cell_get_focusable(this : Void*) : LibC::Int
  fun gtk_column_view_cell_get_item(this : Void*) : Pointer(Void)
  fun gtk_column_view_cell_get_position(this : Void*) : UInt32
  fun gtk_column_view_cell_get_selected(this : Void*) : LibC::Int
  fun gtk_column_view_cell_get_type : UInt64
  fun gtk_column_view_cell_set_child(this : Void*, child : Pointer(Void)) : Void
  fun gtk_column_view_cell_set_focusable(this : Void*, focusable : LibC::Int) : Void
  ...
  fun gtk_column_view_column_get_id(this : Void*) : Pointer(LibC::Char)
  ...
  fun gtk_column_view_column_set_id(this : Void*, id : Pointer(LibC::Char)) : Void
  ...
  fun gtk_column_view_get_header_factory(this : Void*) : Pointer(Void)
  fun gtk_column_view_get_model(this : Void*) : Pointer(Void)
  fun gtk_column_view_get_reorderable(this : Void*) : LibC::Int
  fun gtk_column_view_get_row_factory(this : Void*) : Pointer(Void)
  ...
  fun gtk_column_view_get_tab_behavior(this : Void*) : UInt32
  ...
  fun gtk_column_view_row_get_accessible_description(this : Void*) : Pointer(LibC::Char)
  fun gtk_column_view_row_get_accessible_label(this : Void*) : Pointer(LibC::Char)
  fun gtk_column_view_row_get_activatable(this : Void*) : LibC::Int
  fun gtk_column_view_row_get_focusable(this : Void*) : LibC::Int
  fun gtk_column_view_row_get_item(this : Void*) : Pointer(Void)
  fun gtk_column_view_row_get_position(this : Void*) : UInt32
  fun gtk_column_view_row_get_selectable(this : Void*) : LibC::Int
  fun gtk_column_view_row_get_selected(this : Void*) : LibC::Int
  fun gtk_column_view_row_get_type : UInt64
  fun gtk_column_view_row_set_accessible_description(this : Void*, description : Pointer(LibC::Char)) : Void
  fun gtk_column_view_row_set_accessible_label(this : Void*, label : Pointer(LibC::Char)) : Void
  fun gtk_column_view_row_set_activatable(this : Void*, activatable : LibC::Int) : Void
  fun gtk_column_view_row_set_focusable(this : Void*, focusable : LibC::Int) : Void
  fun gtk_column_view_row_set_selectable(this : Void*, selectable : LibC::Int) : Void
  fun gtk_column_view_scroll_to(this : Void*, pos : UInt32, column : Pointer(Void), flags : UInt32, scroll : Pointer(Void)) : Void
  fun gtk_column_view_set_enable_rubberband(this : Void*, enable_rubberband : LibC::Int) : Void
  fun gtk_column_view_set_header_factory(this : Void*, factory : Pointer(Void)) : Void
  ...
  fun gtk_column_view_set_row_factory(this : Void*, factory : Pointer(Void)) : Void
  ...
  fun gtk_column_view_set_tab_behavior(this : Void*, tab_behavior : UInt32) : Void
  fun gtk_column_view_sort_by_column(this : Void*, column : Pointer(Void), direction : UInt32) : Void
  fun gtk_column_view_sorter_get_n_sort_columns(this : Void*) : UInt32
  fun gtk_column_view_sorter_get_nth_sort_column(this : Void*, position : UInt32, sort_order : Pointer(UInt32)) : Pointer(Void)
  fun gtk_column_view_sorter_get_primary_sort_column(this : Void*) : Pointer(Void)
  fun gtk_column_view_sorter_get_primary_sort_order(this : Void*) : UInt32
  fun gtk_column_view_sorter_get_type : UInt64
  ...
  fun gtk_constraint_attribute_get_type : UInt64
  ...
  fun gtk_constraint_relation_get_type : UInt64
  fun gtk_constraint_strength_get_type : UInt64
  fun gtk_constraint_target_get_type : UInt64
  fun gtk_constraint_vfl_parser_error_get_type : UInt64
  fun gtk_constraint_vfl_parser_error_quark : UInt32
  fun gtk_content_fit_get_type : UInt64
  fun gtk_corner_type_get_type : UInt64
  fun gtk_css_parser_error_quark : UInt32
  fun gtk_css_parser_warning_quark : UInt32
  fun gtk_css_provider_get_type : UInt64
  fun gtk_css_provider_load_from_bytes(this : Void*, data : Pointer(Void)) : Void
  fun gtk_css_provider_load_from_data(this : Void*, data : Pointer(LibC::Char), length : Int64) : Void
  ...
  fun gtk_css_provider_load_from_string(this : Void*, string : Pointer(LibC::Char)) : Void
  ...
  fun gtk_css_section_get_bytes(this : Void*) : Pointer(Void)
  ...
  fun gtk_css_section_new_with_bytes(file : Pointer(Void), bytes : Pointer(Void), start : Pointer(Void), _end : Pointer(Void)) : Pointer(Void)
  ...
  fun gtk_debug_flags_get_type : UInt64
  fun gtk_delete_type_get_type : UInt64
  ...
  fun gtk_dialog_error_get_type : UInt64
  fun gtk_dialog_error_quark : UInt32
  fun gtk_dialog_flags_get_type : UInt64
  ...
  fun gtk_direction_type_get_type : UInt64
  fun gtk_directory_list_get_attributes(this : Void*) : Pointer(LibC::Char)
  fun gtk_directory_list_get_error(this : Void*) : Pointer(LibGLib::Error)
  ...
  fun gtk_drop_down_get_header_factory(this : Void*) : Pointer(Void)
  fun gtk_drop_down_get_list_factory(this : Void*) : Pointer(Void)
  fun gtk_drop_down_get_model(this : Void*) : Pointer(Void)
  fun gtk_drop_down_get_search_match_mode(this : Void*) : UInt32
  ...
  fun gtk_drop_down_set_header_factory(this : Void*, factory : Pointer(Void)) : Void
  ...
  fun gtk_drop_down_set_search_match_mode(this : Void*, search_match_mode : UInt32) : Void
  ...
  fun gtk_editable_delegate_get_accessible_platform_state(this : Void*, state : UInt32) : LibC::Int
  ...
  fun gtk_editable_properties_get_type : UInt64
  ...
  fun gtk_entry_icon_position_get_type : UInt64
  ...
  fun gtk_event_controller_scroll_flags_get_type : UInt64
  fun gtk_event_controller_scroll_get_flags(this : Void*) : UInt32
  fun gtk_event_controller_scroll_get_type : UInt64
  fun gtk_event_controller_scroll_get_unit(this : Void*) : UInt32
  ...
  fun gtk_event_controller_set_static_name(this : Void*, name : Pointer(LibC::Char)) : Void
  fun gtk_event_sequence_state_get_type : UInt64
  ...
  fun gtk_file_chooser_action_get_type : UInt64
  ...
  fun gtk_file_chooser_error_get_type : UInt64
  ...
  fun gtk_file_dialog_get_accept_label(this : Void*) : Pointer(LibC::Char)
  fun gtk_file_dialog_get_default_filter(this : Void*) : Pointer(Void)
  fun gtk_file_dialog_get_filters(this : Void*) : Pointer(Void)
  fun gtk_file_dialog_get_initial_file(this : Void*) : Pointer(Void)
  fun gtk_file_dialog_get_initial_folder(this : Void*) : Pointer(Void)
  fun gtk_file_dialog_get_initial_name(this : Void*) : Pointer(LibC::Char)
  fun gtk_file_dialog_get_modal(this : Void*) : LibC::Int
  fun gtk_file_dialog_get_title(this : Void*) : Pointer(LibC::Char)
  fun gtk_file_dialog_get_type : UInt64
  fun gtk_file_dialog_new : Pointer(Void)
  fun gtk_file_dialog_open(this : Void*, parent : Pointer(Void), cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  fun gtk_file_dialog_open_finish(this : Void*, result : Pointer(Void), error : LibGLib::Error**) : Pointer(Void)
  fun gtk_file_dialog_open_multiple(this : Void*, parent : Pointer(Void), cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  fun gtk_file_dialog_open_multiple_finish(this : Void*, result : Pointer(Void), error : LibGLib::Error**) : Pointer(Void)
  fun gtk_file_dialog_open_multiple_text_files(this : Void*, parent : Pointer(Void), cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  fun gtk_file_dialog_open_multiple_text_files_finish(this : Void*, result : Pointer(Void), encoding : Pointer(Pointer(LibC::Char)), error : LibGLib::Error**) : Pointer(Void)
  fun gtk_file_dialog_open_text_file(this : Void*, parent : Pointer(Void), cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  fun gtk_file_dialog_open_text_file_finish(this : Void*, result : Pointer(Void), encoding : Pointer(Pointer(LibC::Char)), error : LibGLib::Error**) : Pointer(Void)
  fun gtk_file_dialog_save(this : Void*, parent : Pointer(Void), cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  fun gtk_file_dialog_save_finish(this : Void*, result : Pointer(Void), error : LibGLib::Error**) : Pointer(Void)
  fun gtk_file_dialog_save_text_file(this : Void*, parent : Pointer(Void), cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  fun gtk_file_dialog_save_text_file_finish(this : Void*, result : Pointer(Void), encoding : Pointer(Pointer(LibC::Char)), line_ending : Pointer(Pointer(LibC::Char)), error : LibGLib::Error**) : Pointer(Void)
  fun gtk_file_dialog_select_folder(this : Void*, parent : Pointer(Void), cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  fun gtk_file_dialog_select_folder_finish(this : Void*, result : Pointer(Void), error : LibGLib::Error**) : Pointer(Void)
  fun gtk_file_dialog_select_multiple_folders(this : Void*, parent : Pointer(Void), cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  fun gtk_file_dialog_select_multiple_folders_finish(this : Void*, result : Pointer(Void), error : LibGLib::Error**) : Pointer(Void)
  fun gtk_file_dialog_set_accept_label(this : Void*, accept_label : Pointer(LibC::Char)) : Void
  fun gtk_file_dialog_set_default_filter(this : Void*, filter : Pointer(Void)) : Void
  fun gtk_file_dialog_set_filters(this : Void*, filters : Pointer(Void)) : Void
  fun gtk_file_dialog_set_initial_file(this : Void*, file : Pointer(Void)) : Void
  fun gtk_file_dialog_set_initial_folder(this : Void*, folder : Pointer(Void)) : Void
  fun gtk_file_dialog_set_initial_name(this : Void*, name : Pointer(LibC::Char)) : Void
  ...
  fun gtk_file_launcher_get_always_ask(this : Void*) : LibC::Int
  fun gtk_file_launcher_get_file(this : Void*) : Pointer(Void)
  fun gtk_file_launcher_get_type : UInt64
  fun gtk_file_launcher_get_writable(this : Void*) : LibC::Int
  fun gtk_file_launcher_launch(this : Void*, parent : Pointer(Void), cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  fun gtk_file_launcher_launch_finish(this : Void*, result : Pointer(Void), error : LibGLib::Error**) : LibC::Int
  fun gtk_file_launcher_new(file : Pointer(Void)) : Pointer(Void)
  fun gtk_file_launcher_open_containing_folder(this : Void*, parent : Pointer(Void), cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  fun gtk_file_launcher_open_containing_folder_finish(this : Void*, result : Pointer(Void), error : LibGLib::Error**) : LibC::Int
  fun gtk_file_launcher_set_always_ask(this : Void*, always_ask : LibC::Int) : Void
  fun gtk_file_launcher_set_file(this : Void*, file : Pointer(Void)) : Void
  fun gtk_file_launcher_set_writable(this : Void*, writable : LibC::Int) : Void
  fun gtk_filter_change_get_type : UInt64
  ...
  fun gtk_flow_box_remove_all(this : Void*) : Void
  ...
  fun gtk_font_chooser_level_get_type : UInt64
  ...
  fun gtk_font_dialog_button_get_dialog(this : Void*) : Pointer(Void)
  fun gtk_font_dialog_button_get_font_desc(this : Void*) : Pointer(Void)
  fun gtk_font_dialog_button_get_font_features(this : Void*) : Pointer(LibC::Char)
  fun gtk_font_dialog_button_get_language(this : Void*) : Pointer(Void)
  fun gtk_font_dialog_button_get_level(this : Void*) : UInt32
  fun gtk_font_dialog_button_get_type : UInt64
  fun gtk_font_dialog_button_get_use_font(this : Void*) : LibC::Int
  fun gtk_font_dialog_button_get_use_size(this : Void*) : LibC::Int
  fun gtk_font_dialog_button_new(dialog : Pointer(Void)) : Pointer(Void)
  fun gtk_font_dialog_button_set_dialog(this : Void*, dialog : Pointer(Void)) : Void
  fun gtk_font_dialog_button_set_font_desc(this : Void*, font_desc : Pointer(Void)) : Void
  fun gtk_font_dialog_button_set_font_features(this : Void*, font_features : Pointer(LibC::Char)) : Void
  fun gtk_font_dialog_button_set_language(this : Void*, language : Pointer(Void)) : Void
  fun gtk_font_dialog_button_set_level(this : Void*, level : UInt32) : Void
  fun gtk_font_dialog_button_set_use_font(this : Void*, use_font : LibC::Int) : Void
  fun gtk_font_dialog_button_set_use_size(this : Void*, use_size : LibC::Int) : Void
  fun gtk_font_dialog_choose_face(this : Void*, parent : Pointer(Void), initial_value : Pointer(Void), cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  fun gtk_font_dialog_choose_face_finish(this : Void*, result : Pointer(Void), error : LibGLib::Error**) : Pointer(Void)
  fun gtk_font_dialog_choose_family(this : Void*, parent : Pointer(Void), initial_value : Pointer(Void), cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  fun gtk_font_dialog_choose_family_finish(this : Void*, result : Pointer(Void), error : LibGLib::Error**) : Pointer(Void)
  fun gtk_font_dialog_choose_font(this : Void*, parent : Pointer(Void), initial_value : Pointer(Void), cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  fun gtk_font_dialog_choose_font_and_features(this : Void*, parent : Pointer(Void), initial_value : Pointer(Void), cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  fun gtk_font_dialog_choose_font_and_features_finish(this : Void*, result : Pointer(Void), font_desc : Pointer(Pointer(Void)), font_features : Pointer(Pointer(LibC::Char)), language : Pointer(Pointer(Void)), error : LibGLib::Error**) : LibC::Int
  fun gtk_font_dialog_choose_font_finish(this : Void*, result : Pointer(Void), error : LibGLib::Error**) : Pointer(Void)
  fun gtk_font_dialog_get_filter(this : Void*) : Pointer(Void)
  fun gtk_font_dialog_get_font_map(this : Void*) : Pointer(Void)
  fun gtk_font_dialog_get_language(this : Void*) : Pointer(Void)
  fun gtk_font_dialog_get_modal(this : Void*) : LibC::Int
  fun gtk_font_dialog_get_title(this : Void*) : Pointer(LibC::Char)
  fun gtk_font_dialog_get_type : UInt64
  fun gtk_font_dialog_new : Pointer(Void)
  fun gtk_font_dialog_set_filter(this : Void*, filter : Pointer(Void)) : Void
  fun gtk_font_dialog_set_font_map(this : Void*, fontmap : Pointer(Void)) : Void
  fun gtk_font_dialog_set_language(this : Void*, language : Pointer(Void)) : Void
  fun gtk_font_dialog_set_modal(this : Void*, modal : LibC::Int) : Void
  fun gtk_font_dialog_set_title(this : Void*, title : Pointer(LibC::Char)) : Void
  fun gtk_font_level_get_type : UInt64
  fun gtk_font_rendering_get_type : UInt64
  ...
  fun gtk_gesture_stylus_get_backlog(this : Void*, backlog : Pointer(Pointer(LibGdk::TimeCoord)), n_elems : Pointer(UInt32)) : LibC::Int
  fun gtk_gesture_stylus_get_device_tool(this : Void*) : Pointer(Void)
  fun gtk_gesture_stylus_get_stylus_only(this : Void*) : LibC::Int
  fun gtk_gesture_stylus_get_type : UInt64
  fun gtk_gesture_stylus_new : Pointer(Void)
  fun gtk_gesture_stylus_set_stylus_only(this : Void*, stylus_only : LibC::Int) : Void
  ...
  fun gtk_gl_area_get_allowed_apis(this : Void*) : UInt32
  fun gtk_gl_area_get_api(this : Void*) : UInt32
  fun gtk_gl_area_get_auto_render(this : Void*) : LibC::Int
  fun gtk_gl_area_get_context(this : Void*) : Pointer(Void)
  fun gtk_gl_area_get_error(this : Void*) : Pointer(LibGLib::Error)
  ...
  fun gtk_gl_area_set_allowed_apis(this : Void*, apis : UInt32) : Void
  fun gtk_gl_area_set_auto_render(this : Void*, auto_render : LibC::Int) : Void
  fun gtk_gl_area_set_error(this : Void*, error : Pointer(LibGLib::Error)) : Void
  ...
  fun gtk_graphics_offload_enabled_get_type : UInt64
  fun gtk_graphics_offload_get_black_background(this : Void*) : LibC::Int
  fun gtk_graphics_offload_get_child(this : Void*) : Pointer(Void)
  fun gtk_graphics_offload_get_enabled(this : Void*) : UInt32
  fun gtk_graphics_offload_get_type : UInt64
  fun gtk_graphics_offload_new(child : Pointer(Void)) : Pointer(Void)
  fun gtk_graphics_offload_set_black_background(this : Void*, value : LibC::Int) : Void
  fun gtk_graphics_offload_set_child(this : Void*, child : Pointer(Void)) : Void
  fun gtk_graphics_offload_set_enabled(this : Void*, enabled : UInt32) : Void
  ...
  fun gtk_grid_view_get_tab_behavior(this : Void*) : UInt32
  fun gtk_grid_view_get_type : UInt64
  fun gtk_grid_view_new(model : Pointer(Void), factory : Pointer(Void)) : Pointer(Void)
  fun gtk_grid_view_scroll_to(this : Void*, pos : UInt32, flags : UInt32, scroll : Pointer(Void)) : Void
  ...
  fun gtk_grid_view_set_tab_behavior(this : Void*, tab_behavior : UInt32) : Void
  ...
  fun gtk_header_bar_get_use_native_controls(this : Void*) : LibC::Int
  ...
  fun gtk_header_bar_set_use_native_controls(this : Void*, setting : LibC::Int) : Void
  fun gtk_hsv_to_rgb(h : Float32, s : Float32, v : Float32, r : Pointer(Float32), g : Pointer(Float32), b : Pointer(Float32)) : Void
  fun gtk_icon_lookup_flags_get_type : UInt64
  ...
  fun gtk_icon_size_get_type : UInt64
  ...
  fun gtk_icon_theme_error_get_type : UInt64
  ...
  fun gtk_icon_view_drop_position_get_type : UInt64
  ...
  fun gtk_im_context_activate_osk(this : Void*, event : Pointer(Void)) : LibC::Int
  ...
  fun gtk_image_type_get_type : UInt64
  ...
  fun gtk_input_hints_get_type : UInt64
  fun gtk_input_purpose_get_type : UInt64
  fun gtk_inscription_get_attributes(this : Void*) : Pointer(Void)
  fun gtk_inscription_get_min_chars(this : Void*) : UInt32
  fun gtk_inscription_get_min_lines(this : Void*) : UInt32
  fun gtk_inscription_get_nat_chars(this : Void*) : UInt32
  fun gtk_inscription_get_nat_lines(this : Void*) : UInt32
  fun gtk_inscription_get_text(this : Void*) : Pointer(LibC::Char)
  fun gtk_inscription_get_text_overflow(this : Void*) : UInt32
  fun gtk_inscription_get_type : UInt64
  fun gtk_inscription_get_wrap_mode(this : Void*) : UInt32
  fun gtk_inscription_get_xalign(this : Void*) : Float32
  fun gtk_inscription_get_yalign(this : Void*) : Float32
  fun gtk_inscription_new(text : Pointer(LibC::Char)) : Pointer(Void)
  fun gtk_inscription_overflow_get_type : UInt64
  fun gtk_inscription_set_attributes(this : Void*, attrs : Pointer(Void)) : Void
  fun gtk_inscription_set_markup(this : Void*, markup : Pointer(LibC::Char)) : Void
  fun gtk_inscription_set_min_chars(this : Void*, min_chars : UInt32) : Void
  fun gtk_inscription_set_min_lines(this : Void*, min_lines : UInt32) : Void
  fun gtk_inscription_set_nat_chars(this : Void*, nat_chars : UInt32) : Void
  fun gtk_inscription_set_nat_lines(this : Void*, nat_lines : UInt32) : Void
  fun gtk_inscription_set_text(this : Void*, text : Pointer(LibC::Char)) : Void
  fun gtk_inscription_set_text_overflow(this : Void*, overflow : UInt32) : Void
  ...
  fun gtk_label_get_tabs(this : Void*) : Pointer(Void)
  ...
  fun gtk_label_set_tabs(this : Void*, tabs : Pointer(Void)) : Void
  ...
  fun gtk_level_bar_mode_get_type : UInt64
  ...
  fun gtk_license_get_type : UInt64
  ...
  fun gtk_list_box_get_tab_behavior(this : Void*) : UInt32
  ...
  fun gtk_list_box_remove_all(this : Void*) : Void
  ...
  fun gtk_list_box_set_tab_behavior(this : Void*, behavior : UInt32) : Void
  fun gtk_list_box_unselect_all(this : Void*) : Void
  fun gtk_list_box_unselect_row(this : Void*, row : Pointer(Void)) : Void
  fun gtk_list_header_get_child(this : Void*) : Pointer(Void)
  fun gtk_list_header_get_end(this : Void*) : UInt32
  fun gtk_list_header_get_item(this : Void*) : Pointer(Void)
  fun gtk_list_header_get_n_items(this : Void*) : UInt32
  fun gtk_list_header_get_start(this : Void*) : UInt32
  fun gtk_list_header_get_type : UInt64
  fun gtk_list_header_set_child(this : Void*, child : Pointer(Void)) : Void
  fun gtk_list_item_factory_get_type : UInt64
  fun gtk_list_item_get_accessible_description(this : Void*) : Pointer(LibC::Char)
  fun gtk_list_item_get_accessible_label(this : Void*) : Pointer(LibC::Char)
  fun gtk_list_item_get_activatable(this : Void*) : LibC::Int
  fun gtk_list_item_get_child(this : Void*) : Pointer(Void)
  fun gtk_list_item_get_focusable(this : Void*) : LibC::Int
  ...
  fun gtk_list_item_set_accessible_description(this : Void*, description : Pointer(LibC::Char)) : Void
  fun gtk_list_item_set_accessible_label(this : Void*, label : Pointer(LibC::Char)) : Void
  ...
  fun gtk_list_item_set_focusable(this : Void*, focusable : LibC::Int) : Void
  fun gtk_list_item_set_selectable(this : Void*, selectable : LibC::Int) : Void
  fun gtk_list_scroll_flags_get_type : UInt64
  ...
  fun gtk_list_store_insert_with_valuesv(this : Void*, iter : Pointer(Void), position : Int32, columns : Pointer(Int32), values : Pointer(LibGObject::Value), n_values : Int32) : Void
  ...
  fun gtk_list_store_set_valuesv(this : Void*, iter : Pointer(Void), columns : Pointer(Int32), values : Pointer(LibGObject::Value), n_values : Int32) : Void
  fun gtk_list_store_swap(this : Void*, a : Pointer(Void), b : Pointer(Void)) : Void
  fun gtk_list_tab_behavior_get_type : UInt64
  fun gtk_list_view_get_enable_rubberband(this : Void*) : LibC::Int
  fun gtk_list_view_get_factory(this : Void*) : Pointer(Void)
  fun gtk_list_view_get_header_factory(this : Void*) : Pointer(Void)
  ...
  fun gtk_list_view_get_tab_behavior(this : Void*) : UInt32
  fun gtk_list_view_get_type : UInt64
  fun gtk_list_view_new(model : Pointer(Void), factory : Pointer(Void)) : Pointer(Void)
  fun gtk_list_view_scroll_to(this : Void*, pos : UInt32, flags : UInt32, scroll : Pointer(Void)) : Void
  ...
  fun gtk_list_view_set_header_factory(this : Void*, factory : Pointer(Void)) : Void
  ...
  fun gtk_list_view_set_tab_behavior(this : Void*, tab_behavior : UInt32) : Void
  ...
  fun gtk_media_stream_gerror(this : Void*, error : Pointer(LibGLib::Error)) : Void
  fun gtk_media_stream_get_duration(this : Void*) : Int64
  fun gtk_media_stream_get_ended(this : Void*) : LibC::Int
  fun gtk_media_stream_get_error(this : Void*) : Pointer(LibGLib::Error)
  ...
  fun gtk_menu_button_get_active(this : Void*) : LibC::Int
  fun gtk_menu_button_get_always_show_arrow(this : Void*) : LibC::Int
  fun gtk_menu_button_get_can_shrink(this : Void*) : LibC::Int
  ...
  fun gtk_menu_button_set_active(this : Void*, active : LibC::Int) : Void
  fun gtk_menu_button_set_always_show_arrow(this : Void*, always_show_arrow : LibC::Int) : Void
  fun gtk_menu_button_set_can_shrink(this : Void*, can_shrink : LibC::Int) : Void
  ...
  fun gtk_message_type_get_type : UInt64
  ...
  fun gtk_movement_step_get_type : UInt64
  ...
  fun gtk_natural_wrap_mode_get_type : UInt64
  ...
  fun gtk_ordering_get_type : UInt64
  ...
  fun gtk_orientation_get_type : UInt64
  fun gtk_overflow_get_type : UInt64
  ...
  fun gtk_pack_type_get_type : UInt64
  fun gtk_pad_action_type_get_type : UInt64
  ...
  fun gtk_pad_controller_set_action_entries(this : Void*, entries : Pointer(LibGtk::PadActionEntry), n_entries : Int32) : Void
  fun gtk_page_orientation_get_type : UInt64
  fun gtk_page_set_get_type : UInt64
  ...
  fun gtk_pan_direction_get_type : UInt64
  ...
  fun gtk_pick_flags_get_type : UInt64
  ...
  fun gtk_popover_menu_flags_get_type : UInt64
  fun gtk_popover_menu_get_flags(this : Void*) : UInt32
  ...
  fun gtk_popover_menu_set_flags(this : Void*, flags : UInt32) : Void
  ...
  fun gtk_position_type_get_type : UInt64
  fun gtk_print_capabilities_get_type : UInt64
  ...
  fun gtk_print_dialog_get_accept_label(this : Void*) : Pointer(LibC::Char)
  fun gtk_print_dialog_get_modal(this : Void*) : LibC::Int
  fun gtk_print_dialog_get_page_setup(this : Void*) : Pointer(Void)
  fun gtk_print_dialog_get_print_settings(this : Void*) : Pointer(Void)
  fun gtk_print_dialog_get_title(this : Void*) : Pointer(LibC::Char)
  fun gtk_print_dialog_get_type : UInt64
  fun gtk_print_dialog_new : Pointer(Void)
  fun gtk_print_dialog_print(this : Void*, parent : Pointer(Void), setup : Pointer(Void), cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  fun gtk_print_dialog_print_file(this : Void*, parent : Pointer(Void), setup : Pointer(Void), file : Pointer(Void), cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  fun gtk_print_dialog_print_file_finish(this : Void*, result : Pointer(Void), error : LibGLib::Error**) : LibC::Int
  fun gtk_print_dialog_print_finish(this : Void*, result : Pointer(Void), error : LibGLib::Error**) : Pointer(Void)
  fun gtk_print_dialog_set_accept_label(this : Void*, accept_label : Pointer(LibC::Char)) : Void
  fun gtk_print_dialog_set_modal(this : Void*, modal : LibC::Int) : Void
  fun gtk_print_dialog_set_page_setup(this : Void*, page_setup : Pointer(Void)) : Void
  fun gtk_print_dialog_set_print_settings(this : Void*, print_settings : Pointer(Void)) : Void
  fun gtk_print_dialog_set_title(this : Void*, title : Pointer(LibC::Char)) : Void
  fun gtk_print_dialog_setup(this : Void*, parent : Pointer(Void), cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  fun gtk_print_dialog_setup_finish(this : Void*, result : Pointer(Void), error : LibGLib::Error**) : Pointer(Void)
  fun gtk_print_duplex_get_type : UInt64
  fun gtk_print_error_get_type : UInt64
  ...
  fun gtk_print_job_get_page_ranges(this : Void*, n_ranges : Pointer(Int32)) : Pointer(LibGtk::PageRange)
  ...
  fun gtk_print_job_set_page_ranges(this : Void*, ranges : Pointer(LibGtk::PageRange), n_ranges : Int32) : Void
  ...
  fun gtk_print_operation_action_get_type : UInt64
  ...
  fun gtk_print_operation_result_get_type : UInt64
  ...
  fun gtk_print_pages_get_type : UInt64
  fun gtk_print_quality_get_type : UInt64
  ...
  fun gtk_print_settings_get_page_ranges(this : Void*, num_ranges : Pointer(Int32)) : Pointer(LibGtk::PageRange)
  ...
  fun gtk_print_settings_set_page_ranges(this : Void*, page_ranges : Pointer(LibGtk::PageRange), num_ranges : Int32) : Void
  ...
  fun gtk_print_setup_get_page_setup(this : Void*) : Pointer(Void)
  fun gtk_print_setup_get_print_settings(this : Void*) : Pointer(Void)
  fun gtk_print_setup_get_type : UInt64
  fun gtk_print_setup_ref(this : Void*) : Pointer(Void)
  fun gtk_print_setup_unref(this : Void*) : Void
  fun gtk_print_status_get_type : UInt64
  ...
  fun gtk_propagation_limit_get_type : UInt64
  fun gtk_propagation_phase_get_type : UInt64
  ...
  fun gtk_recent_manager_error_get_type : UInt64
  ...
  fun gtk_response_type_get_type : UInt64
  ...
  fun gtk_revealer_transition_type_get_type : UInt64
  ...
  fun gtk_scale_button_get_active(this : Void*) : LibC::Int
  fun gtk_scale_button_get_adjustment(this : Void*) : Pointer(Void)
  fun gtk_scale_button_get_has_frame(this : Void*) : LibC::Int
  ...
  fun gtk_scale_button_set_has_frame(this : Void*, has_frame : LibC::Int) : Void
  ...
  fun gtk_scroll_info_get_enable_horizontal(this : Void*) : LibC::Int
  fun gtk_scroll_info_get_enable_vertical(this : Void*) : LibC::Int
  fun gtk_scroll_info_get_type : UInt64
  fun gtk_scroll_info_new : Pointer(Void)
  fun gtk_scroll_info_ref(this : Void*) : Pointer(Void)
  fun gtk_scroll_info_set_enable_horizontal(this : Void*, horizontal : LibC::Int) : Void
  fun gtk_scroll_info_set_enable_vertical(this : Void*, vertical : LibC::Int) : Void
  fun gtk_scroll_info_unref(this : Void*) : Void
  fun gtk_scroll_step_get_type : UInt64
  fun gtk_scroll_type_get_type : UInt64
  ...
  fun gtk_scrollable_policy_get_type : UInt64
  ...
  fun gtk_search_entry_get_input_hints(this : Void*) : UInt32
  fun gtk_search_entry_get_input_purpose(this : Void*) : UInt32
  fun gtk_search_entry_get_key_capture_widget(this : Void*) : Pointer(Void)
  fun gtk_search_entry_get_placeholder_text(this : Void*) : Pointer(LibC::Char)
  fun gtk_search_entry_get_search_delay(this : Void*) : UInt32
  fun gtk_search_entry_get_type : UInt64
  fun gtk_search_entry_new : Pointer(Void)
  fun gtk_search_entry_set_input_hints(this : Void*, hints : UInt32) : Void
  fun gtk_search_entry_set_input_purpose(this : Void*, purpose : UInt32) : Void
  fun gtk_search_entry_set_key_capture_widget(this : Void*, widget : Pointer(Void)) : Void
  fun gtk_search_entry_set_placeholder_text(this : Void*, text : Pointer(LibC::Char)) : Void
  fun gtk_search_entry_set_search_delay(this : Void*, delay : UInt32) : Void
  fun gtk_section_model_get_section(this : Void*, position : UInt32, out_start : Pointer(UInt32), out_end : Pointer(UInt32)) : Void
  fun gtk_section_model_get_type : UInt64
  fun gtk_section_model_sections_changed(this : Void*, position : UInt32, n_items : UInt32) : Void
  ...
  fun gtk_selection_mode_get_type : UInt64
  ...
  fun gtk_sensitivity_type_get_type : UInt64
  ...
  fun gtk_shortcut_action_flags_get_type : UInt64
  ...
  fun gtk_shortcut_scope_get_type : UInt64
  ...
  fun gtk_shortcut_type_get_type : UInt64
  fun gtk_shortcuts_group_add_shortcut(this : Void*, shortcut : Pointer(Void)) : Void
  fun gtk_shortcuts_group_get_type : UInt64
  fun gtk_shortcuts_section_add_group(this : Void*, group : Pointer(Void)) : Void
  fun gtk_shortcuts_section_get_type : UInt64
  fun gtk_shortcuts_shortcut_get_type : UInt64
  fun gtk_shortcuts_window_add_section(this : Void*, section : Pointer(Void)) : Void
  ...
  fun gtk_size_group_mode_get_type : UInt64
  ...
  fun gtk_size_request_mode_get_type : UInt64
  ...
  fun gtk_snapshot_append_border(this : Void*, outline : Pointer(Void), border_width : Pointer(Float32), border_color : Pointer(LibGdk::RGBA)) : Void
  ...
  fun gtk_snapshot_append_conic_gradient(this : Void*, bounds : Pointer(Void), center : Pointer(Void), rotation : Float32, stops : Pointer(LibGsk::ColorStop), n_stops : UInt64) : Void
  fun gtk_snapshot_append_fill(this : Void*, path : Pointer(Void), fill_rule : UInt32, color : Pointer(Void)) : Void
  ...
  fun gtk_snapshot_append_scaled_texture(this : Void*, texture : Pointer(Void), filter : UInt32, bounds : Pointer(Void)) : Void
  fun gtk_snapshot_append_stroke(this : Void*, path : Pointer(Void), stroke : Pointer(Void), color : Pointer(Void)) : Void
  ...
  fun gtk_snapshot_push_shadow(this : Void*, shadow : Pointer(LibGsk::Shadow), n_shadows : UInt64) : Void
  fun gtk_snapshot_push_stroke(this : Void*, path : Pointer(Void), stroke : Pointer(Void)) : Void
  ...
  fun gtk_sort_list_model_get_section_sorter(this : Void*) : Pointer(Void)
  ...
  fun gtk_sort_list_model_set_section_sorter(this : Void*, sorter : Pointer(Void)) : Void
  fun gtk_sort_list_model_set_sorter(this : Void*, sorter : Pointer(Void)) : Void
  fun gtk_sort_type_get_type : UInt64
  fun gtk_sorter_change_get_type : UInt64
  ...
  fun gtk_spin_button_set_activates_default(this : Void*, activates_default : LibC::Int) : Void
  ...
  fun gtk_spin_button_update_policy_get_type : UInt64
  fun gtk_spin_type_get_type : UInt64
  ...
  fun gtk_stack_transition_type_get_type : UInt64
  fun gtk_state_flags_get_type : UInt64
  ...
  fun gtk_string_filter_match_mode_get_type : UInt64
  ...
  fun gtk_string_list_find(this : Void*, string : Pointer(LibC::Char)) : UInt32
  ...
  fun gtk_string_sorter_get_collation(this : Void*) : UInt32
  ...
  fun gtk_string_sorter_set_collation(this : Void*, collation : UInt32) : Void
  ...
  fun gtk_style_context_print_flags_get_type : UInt64
  ...
  fun gtk_text_buffer_add_commit_notify(this : Void*, flags : UInt32, commit_notify : Void*, user_data : Pointer(Void), destroy : Void*) : UInt32
  ...
  fun gtk_text_buffer_notify_flags_get_type : UInt64
  ...
  fun gtk_text_buffer_remove_commit_notify(this : Void*, commit_notify_handler : UInt32) : Void
  ...
  fun gtk_text_child_anchor_get_widgets(this : Void*, out_len : Pointer(UInt32)) : Pointer(Pointer(LibGtk::Widget))
  ...
  fun gtk_text_direction_get_type : UInt64
  fun gtk_text_extend_selection_get_type : UInt64
  ...
  fun gtk_text_search_flags_get_type : UInt64
  ...
  fun gtk_text_view_get_visible_offset(this : Void*, x_offset : Pointer(Float64), y_offset : Pointer(Float64)) : Void
  ...
  fun gtk_text_view_layer_get_type : UInt64
  ...
  fun gtk_text_window_type_get_type : UInt64
  ...
  fun gtk_tree_expander_get_hide_expander(this : Void*) : LibC::Int
  fun gtk_tree_expander_get_indent_for_depth(this : Void*) : LibC::Int
  ...
  fun gtk_tree_expander_set_hide_expander(this : Void*, hide_expander : LibC::Int) : Void
  fun gtk_tree_expander_set_indent_for_depth(this : Void*, indent_for_depth : LibC::Int) : Void
  ...
  fun gtk_tree_model_flags_get_type : UInt64
  ...
  fun gtk_tree_store_insert_with_valuesv(this : Void*, iter : Pointer(Void), parent : Pointer(Void), position : Int32, columns : Pointer(Int32), values : Pointer(LibGObject::Value), n_values : Int32) : Void
  ...
  fun gtk_tree_store_set_valuesv(this : Void*, iter : Pointer(Void), columns : Pointer(Int32), values : Pointer(LibGObject::Value), n_values : Int32) : Void
  ...
  fun gtk_tree_view_column_sizing_get_type : UInt64
  ...
  fun gtk_tree_view_drop_position_get_type : UInt64
  ...
  fun gtk_tree_view_grid_lines_get_type : UInt64
  ...
  fun gtk_uri_launcher_launch_finish(this : Void*, result : Pointer(Void), error : LibGLib::Error**) : LibC::Int
  fun gtk_uri_launcher_new(uri : Pointer(LibC::Char)) : Pointer(Void)
  fun gtk_uri_launcher_set_uri(this : Void*, uri : Pointer(LibC::Char)) : Void
  ...
  fun gtk_video_get_graphics_offload(this : Void*) : UInt32
  ...
  fun gtk_video_set_graphics_offload(this : Void*, enabled : UInt32) : Void
  ...
  fun gtk_viewport_scroll_to(this : Void*, descendant : Pointer(Void), scroll : Pointer(Void)) : Void
  ...
  fun gtk_widget_dispose_template(this : Void*, widget_type : UInt64) : Void
  ...
  fun gtk_widget_get_baseline(this : Void*) : Int32
  ...
  fun gtk_widget_get_color(this : Void*, color : Pointer(Void)) : Void
  ...
  fun gtk_widget_get_limit_events(this : Void*) : LibC::Int
  ...
  fun gtk_widget_set_limit_events(this : Void*, limit_events : LibC::Int) : Void
  ...
  fun gtk_window_controls_get_use_native_controls(this : Void*) : LibC::Int
  ...
  fun gtk_window_controls_set_use_native_controls(this : Void*, setting : LibC::Int) : Void
  ...
  fun gtk_window_is_suspended(this : Void*) : LibC::Int
  ...
  fun gtk_wrap_mode_get_type : UInt64
end
