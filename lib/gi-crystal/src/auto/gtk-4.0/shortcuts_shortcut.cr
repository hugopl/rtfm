...
module Gtk
  ...
  class ShortcutsShortcut < Widget
    ...
    GICrystal.declare_new_method(ShortcutsShortcut, g_object_get_qdata)

    # Initialize a new `ShortcutsShortcut`.
    def initialize
      super
    end
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_shortcuts_shortcut_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::ShortcutsShortcut.new(Void*, GICrystal::Transfer)
