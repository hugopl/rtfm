...
module Gtk
  ...
  class Dialog < Window
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_dialog_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::Dialog.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      ...
      Gtk::Dialog.new(_retval, GICrystal::Transfer::Full)
    end
    ...
    def add_action_widget(child : Gtk::Widget, response_id : Int32) : Nil
      ...
      # C call
      LibGtk.gtk_dialog_add_action_widget(to_unsafe, child, response_id)
    ...
    def add_button(button_text : ::String, response_id : Int32) : Gtk::Widget
      ...
      # C call
      _retval = LibGtk.gtk_dialog_add_button(to_unsafe, button_text, response_id)
    ...
    def content_area : Gtk::Box
      ...
      # C call
      _retval = LibGtk.gtk_dialog_get_content_area(to_unsafe)
    ...
    def header_bar : Gtk::HeaderBar
      ...
      # C call
      _retval = LibGtk.gtk_dialog_get_header_bar(to_unsafe)
    ...
    def response_for_widget(widget : Gtk::Widget) : Int32
      ...
      # C call
      _retval = LibGtk.gtk_dialog_get_response_for_widget(to_unsafe, widget)
    ...
    def widget_for_response(response_id : Int32) : Gtk::Widget?
      ...
      # C call
      _retval = LibGtk.gtk_dialog_get_widget_for_response(to_unsafe, response_id)
    ...
    def response(response_id : Int32) : Nil
      ...
      # C call
      LibGtk.gtk_dialog_response(to_unsafe, response_id)
    ...
    def default_response=(response_id : Int32) : Nil
      ...
      # C call
      LibGtk.gtk_dialog_set_default_response(to_unsafe, response_id)
    ...
    def set_response_sensitive(response_id : Int32, setting : Bool) : Nil
      ...
      # C call
      LibGtk.gtk_dialog_set_response_sensitive(to_unsafe, response_id, setting)
