...
module Gtk
  ...
  class StackSidebar < Widget
    ...
    GICrystal.declare_new_method(StackSidebar, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_stack_sidebar_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::StackSidebar.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      ...
      Gtk::StackSidebar.new(_retval, GICrystal::Transfer::Full)
    end
    ...
    def stack : Gtk::Stack?
      ...
      # C call
      _retval = LibGtk.gtk_stack_sidebar_get_stack(to_unsafe)
    ...
    def stack=(stack : Gtk::Stack) : Nil
      ...
      # C call
      LibGtk.gtk_stack_sidebar_set_stack(to_unsafe, stack)
