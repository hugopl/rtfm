...
module Gtk
  ...
  class InfoBar < Widget
    ...
    GICrystal.declare_new_method(InfoBar, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_info_bar_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::InfoBar.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      ...
      Gtk::InfoBar.new(_retval, GICrystal::Transfer::Full)
    end
    ...
    def add_action_widget(child : Gtk::Widget, response_id : Int32) : Nil
      ...
      # C call
      LibGtk.gtk_info_bar_add_action_widget(to_unsafe, child, response_id)
    ...
    def add_button(button_text : ::String, response_id : Int32) : Gtk::Button
      ...
      # C call
      _retval = LibGtk.gtk_info_bar_add_button(to_unsafe, button_text, response_id)
    ...
    def add_child(widget : Gtk::Widget) : Nil
      ...
      # C call
      LibGtk.gtk_info_bar_add_child(to_unsafe, widget)
    ...
    def message_type : Gtk::MessageType
      ...
      # C call
      _retval = LibGtk.gtk_info_bar_get_message_type(to_unsafe)
    ...
    def revealed : Bool
      ...
      # C call
      _retval = LibGtk.gtk_info_bar_get_revealed(to_unsafe)
    ...
    def show_close_button : Bool
      ...
      # C call
      _retval = LibGtk.gtk_info_bar_get_show_close_button(to_unsafe)
    ...
    def remove_action_widget(widget : Gtk::Widget) : Nil
      ...
      # C call
      LibGtk.gtk_info_bar_remove_action_widget(to_unsafe, widget)
    ...
    def remove_child(widget : Gtk::Widget) : Nil
      ...
      # C call
      LibGtk.gtk_info_bar_remove_child(to_unsafe, widget)
    ...
    def response(response_id : Int32) : Nil
      ...
      # C call
      LibGtk.gtk_info_bar_response(to_unsafe, response_id)
    ...
    def default_response=(response_id : Int32) : Nil
      ...
      # C call
      LibGtk.gtk_info_bar_set_default_response(to_unsafe, response_id)
    ...
    def message_type=(message_type : Gtk::MessageType) : Nil
      ...
      # C call
      LibGtk.gtk_info_bar_set_message_type(to_unsafe, message_type)
    ...
    def set_response_sensitive(response_id : Int32, setting : Bool) : Nil
      ...
      # C call
      LibGtk.gtk_info_bar_set_response_sensitive(to_unsafe, response_id, setting)
    ...
    def revealed=(revealed : Bool) : Nil
      ...
      # C call
      LibGtk.gtk_info_bar_set_revealed(to_unsafe, revealed)
    ...
    def show_close_button=(setting : Bool) : Nil
      ...
      # C call
      LibGtk.gtk_info_bar_set_show_close_button(to_unsafe, setting)
