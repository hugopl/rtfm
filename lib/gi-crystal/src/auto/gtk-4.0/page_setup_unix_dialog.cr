...
module Gtk
  ...
  class PageSetupUnixDialog < Dialog
    ...
    GICrystal.declare_new_method(PageSetupUnixDialog, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_page_setup_unix_dialog_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::PageSetupUnixDialog.new(Void*, GICrystal::Transfer)
    ...
    def self.new(title : ::String?, parent : Gtk::Window?) : self
      ...
      # C call
      _retval = LibGtk.gtk_page_setup_unix_dialog_new(title, parent)
    ...
    def page_setup : Gtk::PageSetup
      # gtk_page_setup_unix_dialog_get_page_setup: (Method)
      # Returns: (transfer none)

      # C call
      _retval = LibGtk.gtk_page_setup_unix_dialog_get_page_setup(to_unsafe)
    ...
    def print_settings : Gtk::PrintSettings?
      # gtk_page_setup_unix_dialog_get_print_settings: (Method)
      # Returns: (transfer none) (nullable)

      # C call
      _retval = LibGtk.gtk_page_setup_unix_dialog_get_print_settings(to_unsafe)
    ...
    def page_setup=(page_setup : Gtk::PageSetup) : Nil
      # gtk_page_setup_unix_dialog_set_page_setup: (Method)
      # @page_setup:
      # Returns: (transfer none)

      # C call
      LibGtk.gtk_page_setup_unix_dialog_set_page_setup(to_unsafe, page_setup)

      # Return value handling
    end

    def print_settings=(print_settings : Gtk::PrintSettings?) : Nil
      # gtk_page_setup_unix_dialog_set_print_settings: (Method)
      ...
      # C call
      LibGtk.gtk_page_setup_unix_dialog_set_print_settings(to_unsafe, print_settings)
