...
module Gtk
  ...
  class CellRendererSpin < CellRendererText
    ...
    GICrystal.declare_new_method(CellRendererSpin, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_cell_renderer_spin_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::CellRendererSpin.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      ...
      Gtk::CellRendererSpin.new(_retval, GICrystal::Transfer::Full)
    end
