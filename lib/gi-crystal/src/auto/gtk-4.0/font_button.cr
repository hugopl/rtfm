...
module Gtk
  ...
  class FontButton < Widget
    ...
    GICrystal.declare_new_method(FontButton, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_font_button_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::FontButton.new(Void*, GICrystal::Transfer)
    ...
    @[Deprecated]
    def self.new_with_font(fontname : ::String) : self
    ...
    def modal : Bool
      ...
      # C call
      _retval = LibGtk.gtk_font_button_get_modal(to_unsafe)
    ...
    def title : ::String
      ...
      # C call
      _retval = LibGtk.gtk_font_button_get_title(to_unsafe)
    ...
    def use_font : Bool
      ...
      # C call
      _retval = LibGtk.gtk_font_button_get_use_font(to_unsafe)
    ...
    def use_size : Bool
      ...
      # C call
      _retval = LibGtk.gtk_font_button_get_use_size(to_unsafe)
    ...
    def modal=(modal : Bool) : Nil
      ...
      # C call
      LibGtk.gtk_font_button_set_modal(to_unsafe, modal)
    ...
    def title=(title : ::String) : Nil
      ...
      # C call
      LibGtk.gtk_font_button_set_title(to_unsafe, title)
    ...
    def use_font=(use_font : Bool) : Nil
      ...
      # C call
      LibGtk.gtk_font_button_set_use_font(to_unsafe, use_font)
    ...
    def use_size=(use_size : Bool) : Nil
      ...
      # C call
      LibGtk.gtk_font_button_set_use_size(to_unsafe, use_size)
    ...
    struct ActivateSignal < GObject::Signal
      ...
      def connect(handler : Proc(Gtk::FontButton, Nil), *, after : Bool = false) : GObject::SignalConnection
        _box = ::Box.box(handler)
        handler = ->(_lib_sender : Pointer(Void), _lib_box : Pointer(Void)) {
          _sender = Gtk::FontButton.new(_lib_sender, GICrystal::Transfer::None)
          ::Box(Proc(Gtk::FontButton, Nil)).unbox(_lib_box).call(_sender)
        }.pointer
    ...
    struct FontSetSignal < GObject::Signal
      def name : String
