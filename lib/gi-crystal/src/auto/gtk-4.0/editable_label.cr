...
module Gtk
  ...
  class EditableLabel < Widget
    ...
    GICrystal.declare_new_method(EditableLabel, g_object_get_qdata)

    # Initialize a new `EditableLabel`.
    def initialize
      super
    end
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_editable_label_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::EditableLabel.new(Void*, GICrystal::Transfer)
        LibGObject.g_type_set_qdata(g_type, GICrystal::INSTANCE_FACTORY, ctor.pointer)
      end
    end

    def editing=(value : Bool) : Bool
      unsafe_value = value

      LibGObject.g_object_set(self, "editing", unsafe_value, Pointer(Void).null)
      value
    end
    ...
    def self.new(str : ::String) : self
      ...
      Gtk::EditableLabel.new(_retval, GICrystal::Transfer::Full)
    end
    ...
    def editing : Bool
      ...
      # C call
      _retval = LibGtk.gtk_editable_label_get_editing(to_unsafe)
    ...
    def start_editing : Nil
      ...
      # C call
      LibGtk.gtk_editable_label_start_editing(to_unsafe)
    ...
    def stop_editing(commit : Bool) : Nil
      ...
      # C call
      LibGtk.gtk_editable_label_stop_editing(to_unsafe, commit)
