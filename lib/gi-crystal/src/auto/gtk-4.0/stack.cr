...
module Gtk
  ...
  class Stack < Widget
    ...
    GICrystal.declare_new_method(Stack, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_stack_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::Stack.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      ...
      Gtk::Stack.new(_retval, GICrystal::Transfer::Full)
    end
    ...
    def add_child(child : Gtk::Widget) : Gtk::StackPage
      ...
      # C call
      _retval = LibGtk.gtk_stack_add_child(to_unsafe, child)
    ...
    def add_named(child : Gtk::Widget, name : ::String?) : Gtk::StackPage
      ...
      # C call
      _retval = LibGtk.gtk_stack_add_named(to_unsafe, child, name)
    ...
    def add_titled(child : Gtk::Widget, name : ::String?, title : ::String) : Gtk::StackPage
      ...
      # C call
      _retval = LibGtk.gtk_stack_add_titled(to_unsafe, child, name, title)
    ...
    def child_by_name(name : ::String) : Gtk::Widget?
      ...
      # C call
      _retval = LibGtk.gtk_stack_get_child_by_name(to_unsafe, name)
    ...
    def hhomogeneous : Bool
      ...
      # C call
      _retval = LibGtk.gtk_stack_get_hhomogeneous(to_unsafe)
    ...
    def interpolate_size : Bool
      ...
      # C call
      _retval = LibGtk.gtk_stack_get_interpolate_size(to_unsafe)
    ...
    def page(child : Gtk::Widget) : Gtk::StackPage
      ...
      # C call
      _retval = LibGtk.gtk_stack_get_page(to_unsafe, child)
    ...
    def pages : Gtk::SelectionModel
      ...
      # C call
      _retval = LibGtk.gtk_stack_get_pages(to_unsafe)
    ...
    def transition_duration : UInt32
      ...
      # C call
      _retval = LibGtk.gtk_stack_get_transition_duration(to_unsafe)
    ...
    def transition_running : Bool
      ...
      # C call
      _retval = LibGtk.gtk_stack_get_transition_running(to_unsafe)
    ...
    def transition_type : Gtk::StackTransitionType
      ...
      # C call
      _retval = LibGtk.gtk_stack_get_transition_type(to_unsafe)
    ...
    def vhomogeneous : Bool
      ...
      # C call
      _retval = LibGtk.gtk_stack_get_vhomogeneous(to_unsafe)
    ...
    def visible_child : Gtk::Widget?
      ...
      # C call
      _retval = LibGtk.gtk_stack_get_visible_child(to_unsafe)
    ...
    def visible_child_name : ::String?
      ...
      # C call
      _retval = LibGtk.gtk_stack_get_visible_child_name(to_unsafe)
    ...
    def remove(child : Gtk::Widget) : Nil
      ...
      # C call
      LibGtk.gtk_stack_remove(to_unsafe, child)
    ...
    def hhomogeneous=(hhomogeneous : Bool) : Nil
      ...
      # C call
      LibGtk.gtk_stack_set_hhomogeneous(to_unsafe, hhomogeneous)
    ...
    def interpolate_size=(interpolate_size : Bool) : Nil
      ...
      # C call
      LibGtk.gtk_stack_set_interpolate_size(to_unsafe, interpolate_size)
    ...
    def transition_duration=(duration : UInt32) : Nil
      ...
      # C call
      LibGtk.gtk_stack_set_transition_duration(to_unsafe, duration)
    ...
    def transition_type=(transition : Gtk::StackTransitionType) : Nil
      ...
      # C call
      LibGtk.gtk_stack_set_transition_type(to_unsafe, transition)
    ...
    def vhomogeneous=(vhomogeneous : Bool) : Nil
      ...
      # C call
      LibGtk.gtk_stack_set_vhomogeneous(to_unsafe, vhomogeneous)
    ...
    def visible_child=(child : Gtk::Widget) : Nil
      ...
      # C call
      LibGtk.gtk_stack_set_visible_child(to_unsafe, child)
    ...
    def set_visible_child_full(name : ::String, transition : Gtk::StackTransitionType) : Nil
      ...
      # C call
      LibGtk.gtk_stack_set_visible_child_full(to_unsafe, name, transition)
    ...
    def visible_child_name=(name : ::String) : Nil
      ...
      # C call
      LibGtk.gtk_stack_set_visible_child_name(to_unsafe, name)
