...
module Gtk
  ...
  class BoolFilter < Filter
    ...
    GICrystal.declare_new_method(BoolFilter, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_bool_filter_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::BoolFilter.new(Void*, GICrystal::Transfer)
    ...
    def expression : Gtk::Expression?
      ...
      # C call
      _retval = LibGtk.gtk_bool_filter_get_expression(to_unsafe)
    ...
    def invert : Bool
      ...
      # C call
      _retval = LibGtk.gtk_bool_filter_get_invert(to_unsafe)
    ...
    def expression=(expression : Gtk::Expression?) : Nil
      ...
      # C call
      LibGtk.gtk_bool_filter_set_expression(to_unsafe, expression)
    ...
    def invert=(invert : Bool) : Nil
      ...
      # C call
      LibGtk.gtk_bool_filter_set_invert(to_unsafe, invert)
