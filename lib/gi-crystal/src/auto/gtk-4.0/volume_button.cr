...
module Gtk
  ...
  class VolumeButton < ScaleButton
    ...
    GICrystal.declare_new_method(VolumeButton, g_object_get_qdata)

    # Initialize a new `VolumeButton`.
    def initialize
      super
    end
    ...
    def initialize(*, accessible_role : Gtk::AccessibleRole? = nil, active : Bool? = nil, adjustment : Gtk::Adjustment? = nil, can_focus : Bool? = nil, can_target : Bool? = nil, css_classes : Enumerable(::String)? = nil, css_name : ::String? = nil, cursor : Gdk::Cursor? = nil, focus_on_click : Bool? = nil, focusable : Bool? = nil, halign : Gtk::Align? = nil, has_default : Bool? = nil, has_focus : Bool? = nil, has_frame : Bool? = nil, has_tooltip : Bool? = nil, height_request : Int32? = nil, hexpand : Bool? = nil, hexpand_set : Bool? = nil, icons : Enumerable(::String)? = nil, layout_manager : Gtk::LayoutManager? = nil, limit_events : Bool? = nil, margin_bottom : Int32? = nil, margin_end : Int32? = nil, margin_start : Int32? = nil, margin_top : Int32? = nil, name : ::String? = nil, opacity : Float64? = nil, orientation : Gtk::Orientation? = nil, overflow : Gtk::Overflow? = nil, parent : Gtk::Widget? = nil, receives_default : Bool? = nil, root : Gtk::Root? = nil, scale_factor : Int32? = nil, sensitive : Bool? = nil, tooltip_markup : ::String? = nil, tooltip_text : ::String? = nil, use_symbolic : Bool? = nil, valign : Gtk::Align? = nil, value : Float64? = nil, vexpand : Bool? = nil, vexpand_set : Bool? = nil, visible : Bool? = nil, width_request : Int32? = nil)
      ...
      if !use_symbolic.nil?
        (_names.to_unsafe + _n).value = "use-symbolic".to_unsafe
        GObject::Value.init_g_value(_values.to_unsafe + _n, use_symbolic)
        _n += 1
      end
      if !valign.nil?
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_volume_button_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::VolumeButton.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      ...
      # C call
      _retval = LibGtk.gtk_volume_button_new

      # Return value handling
      Gtk::VolumeButton.new(_retval, GICrystal::Transfer::Full)
    end
