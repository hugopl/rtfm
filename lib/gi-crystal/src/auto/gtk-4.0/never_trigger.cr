...
module Gtk
  ...
  class NeverTrigger < ShortcutTrigger
    ...
    GICrystal.declare_new_method(NeverTrigger, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_never_trigger_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::NeverTrigger.new(Void*, GICrystal::Transfer)
