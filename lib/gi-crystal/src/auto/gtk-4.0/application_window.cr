...
module Gtk
  ...
  class ApplicationWindow < Window
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGtk.gtk_application_window_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gtk::ApplicationWindow.new(Void*, GICrystal::Transfer)
    ...
    def help_overlay : Gtk::ShortcutsWindow?
      ...
      # C call
      _retval = LibGtk.gtk_application_window_get_help_overlay(to_unsafe)
    ...
    def id : UInt32
      ...
      # C call
      _retval = LibGtk.gtk_application_window_get_id(to_unsafe)
    ...
    def show_menubar : Bool
      ...
      # C call
      _retval = LibGtk.gtk_application_window_get_show_menubar(to_unsafe)
    ...
    def help_overlay=(help_overlay : Gtk::ShortcutsWindow?) : Nil
      ...
      # C call
      LibGtk.gtk_application_window_set_help_overlay(to_unsafe, help_overlay)
    ...
    def show_menubar=(show_menubar : Bool) : Nil
      ...
      # C call
      LibGtk.gtk_application_window_set_show_menubar(to_unsafe, show_menubar)
