...
module Gio
  ...
  class FileIOStream < IOStream
    ...
    GICrystal.declare_new_method(FileIOStream, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGio.g_file_io_stream_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gio::FileIOStream.new(Void*, GICrystal::Transfer)
    ...
    def etag : ::String?
      ...
      # C call
      _retval = LibGio.g_file_io_stream_get_etag(to_unsafe)
    ...
    def query_info(attributes : ::String, cancellable : Gio::Cancellable?) : Gio::FileInfo
      ...
      # C call
      _retval = LibGio.g_file_io_stream_query_info(to_unsafe, attributes, cancellable, pointerof(_error))
    ...
    def query_info_async(attributes : ::String, io_priority : Int32, cancellable : Gio::Cancellable?, &callback : Gio::AsyncReadyCallback) : Nil
      ...
      # C call
      LibGio.g_file_io_stream_query_info_async(to_unsafe, attributes, io_priority, cancellable, callback, user_data)
    ...
    def query_info_finish(result : Gio::AsyncResult) : Gio::FileInfo
      ...
      # C call
      _retval = LibGio.g_file_io_stream_query_info_finish(to_unsafe, result, pointerof(_error))
