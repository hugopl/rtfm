module Gio
  class DBusArgInfo
    ...
    def initialize(pointer : Pointer(Void), transfer : GICrystal::Transfer)
      ...
      @data = pointer.as(Pointer(LibGio::DBusArgInfo)).value
    ...
    def ==(other : self) : Bool
      LibC.memcmp(self, other.to_unsafe, sizeof(LibGio::DBusArgInfo)).zero?
    end

    def ref_count : Int32
      value = to_unsafe.as(Pointer(LibGio::DBusArgInfo)).value.ref_count
      value
    end
    ...
    def name : ::String?
      value = to_unsafe.as(Pointer(LibGio::DBusArgInfo)).value.name
    ...
    def signature : ::String?
      value = to_unsafe.as(Pointer(LibGio::DBusArgInfo)).value.signature
      return if value.null?
      value = value.as(Pointer(UInt8))
      ::String.new(value)
    end
    ...
    def annotations : Enumerable(Gio::DBusAnnotationInfo)?
      value = to_unsafe.as(Pointer(LibGio::DBusArgInfo)).value.annotations
      return if value.null?
    ...
    def ref : Gio::DBusArgInfo
      ...
      # C call
      _retval = LibGio.g_dbus_arg_info_ref(to_unsafe)
    ...
    def unref : Nil
      ...
      # C call
      LibGio.g_dbus_arg_info_unref(to_unsafe)
