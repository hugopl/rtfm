...
module Gio
  ...
  class AppInfoMonitor < GObject::Object
    ...
    GICrystal.declare_new_method(AppInfoMonitor, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGio.g_app_info_monitor_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gio::AppInfoMonitor.new(Void*, GICrystal::Transfer)
