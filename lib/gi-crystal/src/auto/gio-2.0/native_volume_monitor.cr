...
module Gio
  ...
  class NativeVolumeMonitor < VolumeMonitor
    ...
    GICrystal.declare_new_method(NativeVolumeMonitor, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGio.g_native_volume_monitor_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gio::NativeVolumeMonitor.new(Void*, GICrystal::Transfer)
