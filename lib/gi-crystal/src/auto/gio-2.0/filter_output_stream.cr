  ...
  class FilterOutputStream < OutputStream
    ...
    def self._register_derived_type(class_name : String, class_init, instance_init)
      LibGObject.g_type_register_static_simple(g_type, class_name,
        sizeof(LibGio::FilterOutputStreamClass), class_init,
        sizeof(LibGio::FilterOutputStream), instance_init, 0)
    end

    GICrystal.declare_new_method(FilterOutputStream, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGio.g_filter_output_stream_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gio::FilterOutputStream.new(Void*, GICrystal::Transfer)
    ...
    def base_stream : Gio::OutputStream
      ...
      # C call
      _retval = LibGio.g_filter_output_stream_get_base_stream(to_unsafe)
    ...
    def close_base_stream : Bool
      ...
      # C call
      _retval = LibGio.g_filter_output_stream_get_close_base_stream(to_unsafe)
    ...
    def close_base_stream=(close_base : Bool) : Nil
      ...
      # C call
      LibGio.g_filter_output_stream_set_close_base_stream(to_unsafe, close_base)
