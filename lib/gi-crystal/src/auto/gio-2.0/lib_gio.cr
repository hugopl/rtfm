...
lib LibGio
  ...
  alias DBusInterfaceGetPropertyFunc = Pointer(LibGio::DBusConnection), Pointer(LibC::Char), Pointer(LibC::Char), Pointer(LibC::Char), Pointer(LibC::Char), Pointer(LibGLib::Error), Pointer(Void) -> Pointer(LibGLib::Variant)
  ...
  alias DBusInterfaceSetPropertyFunc = Pointer(LibGio::DBusConnection), Pointer(LibC::Char), Pointer(LibC::Char), Pointer(LibC::Char), Pointer(LibC::Char), Pointer(LibGLib::Variant), Pointer(LibGLib::Error), Pointer(Void) -> LibC::Int
  ...
  struct FileIface # 848 bytes long
    g_iface : LibGObject::TypeInterface
    dup : Void*
    hash : Void*
    equal : Void*
    ...
    make_symbolic_link_async : Void*
    make_symbolic_link_finish : Void*
    copy : Void*
    copy_async : Void*
    copy_finish : Void*
    move : Void*
  ...
  struct ThreadedResolverClass # 264 bytes long
    parent_class : LibGio::ResolverClass
  end
  ...
  type ThreadedResolver = Void # Object struct with no fields
  ...
  fun g_action_map_add_action_entries(this : Void*, entries : Pointer(LibGio::ActionEntry), n_entries : Int32, user_data : Pointer(Void)) : Void
  ...
  fun g_action_map_remove_action_entries(this : Void*, entries : Pointer(LibGio::ActionEntry), n_entries : Int32) : Void
  ...
  fun g_app_info_create_flags_get_type : UInt64
  ...
  fun g_app_info_get_default_for_type(content_type : Pointer(LibC::Char), must_support_uris : LibC::Int) : Pointer(Void)
  fun g_app_info_get_default_for_type_async(content_type : Pointer(LibC::Char), must_support_uris : LibC::Int, cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  fun g_app_info_get_default_for_type_async(content_type : Pointer(LibC::Char), must_support_uris : LibC::Int, cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  fun g_app_info_get_default_for_type_finish(result : Pointer(Void), error : LibGLib::Error**) : Pointer(Void)
  fun g_app_info_get_default_for_type_finish(result : Pointer(Void), error : LibGLib::Error**) : Pointer(Void)
  fun g_app_info_get_default_for_uri_scheme(uri_scheme : Pointer(LibC::Char)) : Pointer(Void)
  fun g_app_info_get_default_for_uri_scheme(uri_scheme : Pointer(LibC::Char)) : Pointer(Void)
  fun g_app_info_get_default_for_uri_scheme_async(uri_scheme : Pointer(LibC::Char), cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  fun g_app_info_get_default_for_uri_scheme_async(uri_scheme : Pointer(LibC::Char), cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  fun g_app_info_get_default_for_uri_scheme_finish(result : Pointer(Void), error : LibGLib::Error**) : Pointer(Void)
  fun g_app_info_get_default_for_uri_scheme_finish(result : Pointer(Void), error : LibGLib::Error**) : Pointer(Void)
  ...
  fun g_application_add_main_option_entries(this : Void*, entries : Pointer(LibGLib::OptionEntry)) : Void
  ...
  fun g_application_command_line_done(this : Void*) : Void
  ...
  fun g_application_command_line_print_literal(this : Void*, message : Pointer(LibC::Char)) : Void
  fun g_application_command_line_printerr_literal(this : Void*, message : Pointer(LibC::Char)) : Void
  fun g_application_command_line_set_exit_status(this : Void*, exit_status : Int32) : Void
  fun g_application_flags_get_type : UInt64
  ...
  fun g_application_get_version(this : Void*) : Pointer(LibC::Char)
  ...
  fun g_application_open(this : Void*, files : Pointer(Pointer(LibGio::File)), n_files : Int32, hint : Pointer(LibC::Char)) : Void
  ...
  fun g_application_set_version(this : Void*, version : Pointer(LibC::Char)) : Void
  ...
  fun g_ask_password_flags_get_type : UInt64
  ...
  fun g_bus_name_owner_flags_get_type : UInt64
  fun g_bus_name_watcher_flags_get_type : UInt64
  ...
  fun g_bus_type_get_type : UInt64
  ...
  fun g_converter_convert_bytes(this : Void*, bytes : Pointer(Void), error : LibGLib::Error**) : Pointer(Void)
  fun g_converter_flags_get_type : UInt64
  ...
  fun g_converter_result_get_type : UInt64
  ...
  fun g_credentials_type_get_type : UInt64
  ...
  fun g_data_stream_byte_order_get_type : UInt64
  fun g_data_stream_newline_type_get_type : UInt64
  ...
  fun g_datagram_based_receive_messages(this : Void*, messages : Pointer(LibGio::InputMessage), num_messages : UInt32, flags : Int32, timeout : Int64, cancellable : Pointer(Void), error : LibGLib::Error**) : Int32
  fun g_datagram_based_send_messages(this : Void*, messages : Pointer(LibGio::OutputMessage), num_messages : UInt32, flags : Int32, timeout : Int64, cancellable : Pointer(Void), error : LibGLib::Error**) : Int32
  ...
  fun g_dbus_annotation_info_lookup(annotations : Pointer(Pointer(LibGio::DBusAnnotationInfo)), name : Pointer(LibC::Char)) : Pointer(LibC::Char)
  fun g_dbus_annotation_info_lookup(annotations : Pointer(Pointer(LibGio::DBusAnnotationInfo)), name : Pointer(LibC::Char)) : Pointer(LibC::Char)
  ...
  fun g_dbus_call_flags_get_type : UInt64
  fun g_dbus_capability_flags_get_type : UInt64
  ...
  fun g_dbus_connection_flags_get_type : UInt64
  ...
  fun g_dbus_connection_register_object_with_closures2(this : Void*, object_path : Pointer(LibC::Char), interface_info : Pointer(Void), method_call_closure : Pointer(Void), get_property_closure : Pointer(Void), set_property_closure : Pointer(Void), error : LibGLib::Error**) : UInt32
  ...
  fun g_dbus_error_encode_gerror(error : Pointer(LibGLib::Error)) : Pointer(LibC::Char)
  fun g_dbus_error_get_remote_error(error : Pointer(LibGLib::Error)) : Pointer(LibC::Char)
  fun g_dbus_error_get_type : UInt64
  fun g_dbus_error_is_remote_error(error : Pointer(LibGLib::Error)) : LibC::Int
  fun g_dbus_error_new_for_dbus_error(dbus_error_name : Pointer(LibC::Char), dbus_error_message : Pointer(LibC::Char)) : Pointer(LibGLib::Error)
  ...
  fun g_dbus_error_register_error_domain(error_domain_quark_name : Pointer(LibC::Char), quark_volatile : Pointer(UInt64), entries : Pointer(LibGio::DBusErrorEntry), num_entries : UInt32) : Void
  fun g_dbus_error_strip_remote_error(error : Pointer(LibGLib::Error)) : LibC::Int
  ...
  fun g_dbus_interface_skeleton_flags_get_type : UInt64
  ...
  fun g_dbus_interface_skeleton_get_vtable(this : Void*) : Pointer(Void)
  ...
  fun g_dbus_message_byte_order_get_type : UInt64
  ...
  fun g_dbus_message_flags_get_type : UInt64
  fun g_dbus_message_get_arg0(this : Void*) : Pointer(LibC::Char)
  fun g_dbus_message_get_arg0_path(this : Void*) : Pointer(LibC::Char)
  ...
  fun g_dbus_message_header_field_get_type : UInt64
  ...
  fun g_dbus_message_type_get_type : UInt64
  ...
  fun g_dbus_method_invocation_return_gerror(this : Void*, error : Pointer(LibGLib::Error)) : Void
  ...
  fun g_dbus_object_manager_client_flags_get_type : UInt64
  ...
  fun g_dbus_property_info_flags_get_type : UInt64
  ...
  fun g_dbus_proxy_flags_get_type : UInt64
  ...
  fun g_dbus_send_message_flags_get_type : UInt64
  fun g_dbus_server_flags_get_type : UInt64
  ...
  fun g_dbus_signal_flags_get_type : UInt64
  ...
  fun g_dbus_subtree_flags_get_type : UInt64
  ...
  fun g_drive_start_flags_get_type : UInt64
  fun g_drive_start_stop_type_get_type : UInt64
  ...
  fun g_emblem_origin_get_type : UInt64
  ...
  fun g_file_attribute_info_flags_get_type : UInt64
  ...
  fun g_file_attribute_status_get_type : UInt64
  fun g_file_attribute_type_get_type : UInt64
  ...
  fun g_file_copy_async_with_closures(this : Void*, destination : Pointer(Void), flags : UInt32, io_priority : Int32, cancellable : Pointer(Void), progress_callback_closure : Pointer(Void), ready_callback_closure : Pointer(Void)) : Void
  ...
  fun g_file_copy_flags_get_type : UInt64
  ...
  fun g_file_create_flags_get_type : UInt64
  ...
  fun g_file_info_get_attribute_file_path(this : Void*, attribute : Pointer(LibC::Char)) : Pointer(LibC::Char)
  ...
  fun g_file_info_set_attribute_file_path(this : Void*, attribute : Pointer(LibC::Char), attr_value : Pointer(LibC::Char)) : Void
  ...
  fun g_file_make_symbolic_link_async(this : Void*, symlink_value : Pointer(LibC::Char), io_priority : Int32, cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  fun g_file_make_symbolic_link_finish(this : Void*, result : Pointer(Void), error : LibGLib::Error**) : LibC::Int
  fun g_file_measure_disk_usage(this : Void*, flags : UInt32, cancellable : Pointer(Void), progress_callback : Void*, progress_data : Pointer(Void), disk_usage : Pointer(UInt64), num_dirs : Pointer(UInt64), num_files : Pointer(UInt64), error : LibGLib::Error**) : LibC::Int
  ...
  fun g_file_measure_flags_get_type : UInt64
  ...
  fun g_file_move_async_with_closures(this : Void*, destination : Pointer(Void), flags : UInt32, io_priority : Int32, cancellable : Pointer(Void), progress_callback_closure : Pointer(Void), ready_callback_closure : Pointer(Void)) : Void
  fun g_file_move_finish(this : Void*, result : Pointer(Void), error : LibGLib::Error**) : LibC::Int
  fun g_file_new_build_filenamev(args : Pointer(Pointer(LibC::Char))) : Pointer(Void)
  fun g_file_new_build_filenamev(args : Pointer(Pointer(LibC::Char))) : Pointer(Void)
  ...
  fun g_file_new_tmp(tmpl : Pointer(LibC::Char), iostream : Pointer(Pointer(Void)), error : LibGLib::Error**) : Pointer(Void)
  fun g_file_new_tmp_async(tmpl : Pointer(LibC::Char), io_priority : Int32, cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  fun g_file_new_tmp_async(tmpl : Pointer(LibC::Char), io_priority : Int32, cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  fun g_file_new_tmp_dir_async(tmpl : Pointer(LibC::Char), io_priority : Int32, cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  fun g_file_new_tmp_dir_async(tmpl : Pointer(LibC::Char), io_priority : Int32, cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  fun g_file_new_tmp_dir_finish(result : Pointer(Void), error : LibGLib::Error**) : Pointer(Void)
  fun g_file_new_tmp_dir_finish(result : Pointer(Void), error : LibGLib::Error**) : Pointer(Void)
  fun g_file_new_tmp_finish(result : Pointer(Void), iostream : Pointer(Pointer(Void)), error : LibGLib::Error**) : Pointer(Void)
  fun g_file_new_tmp_finish(result : Pointer(Void), iostream : Pointer(Pointer(Void)), error : LibGLib::Error**) : Pointer(Void)
  ...
  fun g_file_query_info_flags_get_type : UInt64
  ...
  fun g_file_type_get_type : UInt64
  ...
  fun g_filesystem_preview_type_get_type : UInt64
  ...
  fun g_icon_hash(this : Void*) : UInt32
  ...
  fun g_initable_newv(object_type : UInt64, n_parameters : UInt32, parameters : Pointer(LibGObject::Parameter), cancellable : Pointer(Void), error : LibGLib::Error**) : Pointer(Void)
  fun g_initable_newv(object_type : UInt64, n_parameters : UInt32, parameters : Pointer(LibGObject::Parameter), cancellable : Pointer(Void), error : LibGLib::Error**) : Pointer(Void)
  ...
  fun g_io_error_enum_get_type : UInt64
  fun g_io_error_from_errno(err_no : Int32) : UInt32
  fun g_io_error_from_file_error(file_error : UInt32) : UInt32
  ...
  fun g_io_module_scope_flags_get_type : UInt64
  ...
  fun g_list_store_find_with_equal_func_full(this : Void*, item : Pointer(Void), equal_func : Void*, user_data : Pointer(Void), position : Pointer(UInt32)) : LibC::Int
  ...
  fun g_list_store_splice(this : Void*, position : UInt32, n_removals : UInt32, additions : Pointer(LibGObject::Object), n_additions : UInt32) : Void
  ...
  fun g_memory_monitor_warning_level_get_type : UInt64
  ...
  fun g_mount_mount_flags_get_type : UInt64
  ...
  fun g_mount_operation_result_get_type : UInt64
  ...
  fun g_mount_unmount_flags_get_type : UInt64
  ...
  fun g_network_connectivity_get_type : UInt64
  ...
  fun g_notification_priority_get_type : UInt64
  ...
  fun g_output_stream_splice_flags_get_type : UInt64
  ...
  fun g_output_stream_writev(this : Void*, vectors : Pointer(LibGio::OutputVector), n_vectors : UInt64, bytes_written : Pointer(UInt64), cancellable : Pointer(Void), error : LibGLib::Error**) : LibC::Int
  fun g_output_stream_writev_all(this : Void*, vectors : Pointer(LibGio::OutputVector), n_vectors : UInt64, bytes_written : Pointer(UInt64), cancellable : Pointer(Void), error : LibGLib::Error**) : LibC::Int
  fun g_output_stream_writev_all_async(this : Void*, vectors : Pointer(LibGio::OutputVector), n_vectors : UInt64, io_priority : Int32, cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  ...
  fun g_output_stream_writev_async(this : Void*, vectors : Pointer(LibGio::OutputVector), n_vectors : UInt64, io_priority : Int32, cancellable : Pointer(Void), callback : Void*, user_data : Pointer(Void)) : Void
  ...
  fun g_password_save_get_type : UInt64
  ...
  fun g_pollable_output_stream_writev_nonblocking(this : Void*, vectors : Pointer(LibGio::OutputVector), n_vectors : UInt64, bytes_written : Pointer(UInt64), cancellable : Pointer(Void), error : LibGLib::Error**) : Int32
  fun g_pollable_return_get_type : UInt64
  ...
  fun g_resolver_error_get_type : UInt64
  fun g_resolver_error_quark : UInt32
  fun g_resolver_get_default : Pointer(Void)
  fun g_resolver_get_timeout(this : Void*) : UInt32
  ...
  fun g_resolver_name_lookup_flags_get_type : UInt64
  fun g_resolver_record_type_get_type : UInt64
  fun g_resolver_set_default(this : Void*) : Void
  fun g_resolver_set_timeout(this : Void*, timeout_ms : UInt32) : Void
  ...
  fun g_resource_error_get_type : UInt64
  fun g_resource_error_quark : UInt32
  fun g_resource_flags_get_type : UInt64
  ...
  fun g_resource_has_children(this : Void*, path : Pointer(LibC::Char)) : LibC::Int
  ...
  fun g_resource_lookup_flags_get_type : UInt64
  ...
  fun g_resources_has_children(path : Pointer(LibC::Char)) : LibC::Int
  ...
  fun g_settings_backend_flatten_tree(tree : Pointer(Void), path : Pointer(Pointer(LibC::Char)), keys : Pointer(Pointer(Pointer(LibC::Char))), values : Pointer(Pointer(Pointer(LibGLib::Variant)))) : Void
  ...
  fun g_settings_bind_flags_get_type : UInt64
  fun g_settings_bind_with_mapping_closures(this : Void*, key : Pointer(LibC::Char), object : Pointer(Void), property : Pointer(LibC::Char), flags : UInt32, get_mapping : Pointer(Void), set_mapping : Pointer(Void)) : Void
  ...
  fun g_simple_action_group_add_entries(this : Void*, entries : Pointer(LibGio::ActionEntry), n_entries : Int32, user_data : Pointer(Void)) : Void
  ...
  fun g_simple_async_report_gerror_in_idle(object : Pointer(Void), callback : Void*, user_data : Pointer(Void), error : Pointer(LibGLib::Error)) : Void
  ...
  fun g_simple_async_result_new_from_error(source_object : Pointer(Void), callback : Void*, user_data : Pointer(Void), error : Pointer(LibGLib::Error)) : Pointer(Void)
  ...
  fun g_simple_async_result_set_from_error(this : Void*, error : Pointer(LibGLib::Error)) : Void
  ...
  fun g_socket_client_event_get_type : UInt64
  ...
  fun g_socket_family_get_type : UInt64
  ...
  fun g_socket_listener_event_get_type : UInt64
  ...
  fun g_socket_msg_flags_get_type : UInt64
  ...
  fun g_socket_protocol_get_type : UInt64
  fun g_socket_receive(this : Void*, buffer : Pointer(Pointer(UInt8)), size : UInt64, cancellable : Pointer(Void), error : LibGLib::Error**) : Int64
  fun g_socket_receive_bytes(this : Void*, size : UInt64, timeout_us : Int64, cancellable : Pointer(Void), error : LibGLib::Error**) : Pointer(Void)
  fun g_socket_receive_bytes_from(this : Void*, address : Pointer(Pointer(Void)), size : UInt64, timeout_us : Int64, cancellable : Pointer(Void), error : LibGLib::Error**) : Pointer(Void)
  fun g_socket_receive_from(this : Void*, address : Pointer(Pointer(Void)), buffer : Pointer(Pointer(UInt8)), size : UInt64, cancellable : Pointer(Void), error : LibGLib::Error**) : Int64
  fun g_socket_receive_message(this : Void*, address : Pointer(Pointer(Void)), vectors : Pointer(LibGio::InputVector), num_vectors : Int32, messages : Pointer(Pointer(Pointer(LibGio::SocketControlMessage))), num_messages : Pointer(Int32), flags : Pointer(Int32), cancellable : Pointer(Void), error : LibGLib::Error**) : Int64
  fun g_socket_receive_messages(this : Void*, messages : Pointer(LibGio::InputMessage), num_messages : UInt32, flags : Int32, cancellable : Pointer(Void), error : LibGLib::Error**) : Int32
  fun g_socket_receive_with_blocking(this : Void*, buffer : Pointer(Pointer(UInt8)), size : UInt64, blocking : LibC::Int, cancellable : Pointer(Void), error : LibGLib::Error**) : Int64
  fun g_socket_send(this : Void*, buffer : Pointer(UInt8), size : UInt64, cancellable : Pointer(Void), error : LibGLib::Error**) : Int64
  fun g_socket_send_message(this : Void*, address : Pointer(Void), vectors : Pointer(LibGio::OutputVector), num_vectors : Int32, messages : Pointer(Pointer(LibGio::SocketControlMessage)), num_messages : Int32, flags : Int32, cancellable : Pointer(Void), error : LibGLib::Error**) : Int64
  fun g_socket_send_message_with_timeout(this : Void*, address : Pointer(Void), vectors : Pointer(LibGio::OutputVector), num_vectors : Int32, messages : Pointer(Pointer(LibGio::SocketControlMessage)), num_messages : Int32, flags : Int32, timeout_us : Int64, bytes_written : Pointer(UInt64), cancellable : Pointer(Void), error : LibGLib::Error**) : Int32
  fun g_socket_send_messages(this : Void*, messages : Pointer(LibGio::OutputMessage), num_messages : UInt32, flags : Int32, cancellable : Pointer(Void), error : LibGLib::Error**) : Int32
  ...
  fun g_socket_type_get_type : UInt64
  ...
  fun g_subprocess_flags_get_type : UInt64
  ...
  fun g_task_report_error(source_object : Pointer(Void), callback : Void*, callback_data : Pointer(Void), source_tag : Pointer(Void), error : Pointer(LibGLib::Error)) : Void
  fun g_task_return_boolean(this : Void*, result : LibC::Int) : Void
  fun g_task_return_error(this : Void*, error : Pointer(LibGLib::Error)) : Void
  fun g_task_return_error_if_cancelled(this : Void*) : LibC::Int
  fun g_task_return_int(this : Void*, result : Int64) : Void
  fun g_task_return_new_error_literal(this : Void*, domain : UInt32, code : Int32, message : Pointer(LibC::Char)) : Void
  ...
  fun g_task_set_static_name(this : Void*, name : Pointer(LibC::Char)) : Void
  ...
  fun g_test_dbus_flags_get_type : UInt64
  ...
  fun g_tls_certificate_flags_get_type : UInt64
  fun g_tls_certificate_get_dns_names(this : Void*) : Pointer(LibGLib::Bytes)
  fun g_tls_certificate_get_ip_addresses(this : Void*) : Pointer(LibGio::InetAddress)
  ...
  fun g_tls_certificate_request_flags_get_type : UInt64
  fun g_tls_certificate_verify(this : Void*, identity : Pointer(Void), trusted_ca : Pointer(Void)) : UInt32
  fun g_tls_channel_binding_error_get_type : UInt64
  fun g_tls_channel_binding_error_quark : UInt32
  fun g_tls_channel_binding_type_get_type : UInt64
  ...
  fun g_tls_database_lookup_flags_get_type : UInt64
  ...
  fun g_tls_database_verify_flags_get_type : UInt64
  fun g_tls_error_get_type : UInt64
  ...
  fun g_tls_interaction_result_get_type : UInt64
  fun g_tls_password_flags_get_type : UInt64
  ...
  fun g_tls_protocol_version_get_type : UInt64
  fun g_tls_rehandshake_mode_get_type : UInt64
  ...
  fun g_unix_socket_address_type_get_type : UInt64
