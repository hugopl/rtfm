...
module Gio
  ...
  class UnixOutputStream < OutputStream
    ...
    GICrystal.declare_new_method(UnixOutputStream, g_object_get_qdata)

    # Initialize a new `UnixOutputStream`.
    def initialize
      super
    end
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGio.g_unix_output_stream_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gio::UnixOutputStream.new(Void*, GICrystal::Transfer)
    ...
    def close_fd : Bool
      ...
      # C call
      _retval = LibGio.g_unix_output_stream_get_close_fd(to_unsafe)
    ...
    def fd : Int32
      ...
      # C call
      _retval = LibGio.g_unix_output_stream_get_fd(to_unsafe)
    ...
    def close_fd=(close_fd : Bool) : Nil
      ...
      # C call
      LibGio.g_unix_output_stream_set_close_fd(to_unsafe, close_fd)
