module Gio
  class DBusMethodInfo
    ...
    def initialize(pointer : Pointer(Void), transfer : GICrystal::Transfer)
      ...
      @data = pointer.as(Pointer(LibGio::DBusMethodInfo)).value
    ...
    def ref_count : Int32
      value = to_unsafe.as(Pointer(LibGio::DBusMethodInfo)).value.ref_count
      value
    end
    ...
    def name : ::String?
      value = to_unsafe.as(Pointer(LibGio::DBusMethodInfo)).value.name
    ...
    def in_args : Enumerable(Gio::DBusArgInfo)?
      value = to_unsafe.as(Pointer(LibGio::DBusMethodInfo)).value.in_args
      return if value.null?
    ...
    def out_args : Enumerable(Gio::DBusArgInfo)?
      value = to_unsafe.as(Pointer(LibGio::DBusMethodInfo)).value.out_args
      return if value.null?
      value = value.as(Pointer(Void))
      GICrystal.transfer_null_ended_array(value, GICrystal::Transfer::None)
    end
    ...
    def annotations : Enumerable(Gio::DBusAnnotationInfo)?
      value = to_unsafe.as(Pointer(LibGio::DBusMethodInfo)).value.annotations
      return if value.null?
      value = value.as(Pointer(Void))
      GICrystal.transfer_null_ended_array(value, GICrystal::Transfer::None)
    end
    ...
    def ref : Gio::DBusMethodInfo
      ...
      # C call
      _retval = LibGio.g_dbus_method_info_ref(to_unsafe)
    ...
    def unref : Nil
      ...
      # C call
      LibGio.g_dbus_method_info_unref(to_unsafe)
