...
lib LibGObject
  ...
  alias TypeValueCollectFunc = Pointer(LibGObject::Value), UInt32, Pointer(LibGObject::TypeCValue), UInt32 -> Pointer(LibC::Char)
  alias TypeValueCopyFunc = Pointer(LibGObject::Value), LibGObject::Value -> Void
  alias TypeValueFreeFunc = Pointer(LibGObject::Value) -> Void
  alias TypeValueInitFunc = Pointer(LibGObject::Value) -> Void
  alias TypeValueLCopyFunc = Pointer(LibGObject::Value), UInt32, Pointer(LibGObject::TypeCValue), UInt32 -> Pointer(LibC::Char)
  alias TypeValuePeekPointerFunc = Pointer(LibGObject::Value) -> Pointer(Void)
  ...
  fun g_binding_flags_get_type : UInt64
  ...
  fun g_boxed_type_register_static(name : Pointer(LibC::Char), boxed_copy : Void*, boxed_free : Void*) : UInt64
  ...
  @[Raises]
  fun g_closure_invoke(this : Void*, return_value : Pointer(Void), n_param_values : UInt32, param_values : Pointer(LibGObject::Value), invocation_hint : Pointer(Void)) : Void
  ...
  fun g_flags_register_static(name : Pointer(LibC::Char), const_static_values : Pointer(LibGObject::FlagsValue)) : UInt64
  ...
  fun g_object_class_install_properties(this : Void*, n_pspecs : UInt32, pspecs : Pointer(Pointer(LibGObject::ParamSpec))) : Void
  fun g_object_class_install_property(this : Void*, property_id : UInt32, pspec : Pointer(Void)) : Void
  fun g_object_class_list_properties(this : Void*, n_properties : Pointer(UInt32)) : Pointer(Pointer(LibGObject::ParamSpec))
  ...
  fun g_object_getv(this : Void*, n_properties : UInt32, names : Pointer(Pointer(LibC::Char)), values : Pointer(LibGObject::Value)) : Void
  ...
  fun g_object_interface_list_properties(g_iface : Pointer(Void), n_properties_p : Pointer(UInt32)) : Pointer(Pointer(LibGObject::ParamSpec))
  fun g_object_is_floating(this : Void*) : LibC::Int
  fun g_object_newv(object_type : UInt64, n_parameters : UInt32, parameters : Pointer(LibGObject::Parameter)) : Pointer(Void)
  ...
  fun g_param_spec_pool_free(this : Void*) : Void
  fun g_param_spec_pool_insert(this : Void*, pspec : Pointer(Void), owner_type : UInt64) : Void
  fun g_param_spec_pool_list(this : Void*, owner_type : UInt64, n_pspecs_p : Pointer(UInt32)) : Pointer(Pointer(LibGObject::ParamSpec))
  ...
  fun g_param_value_is_valid(pspec : Pointer(Void), value : Pointer(Void)) : LibC::Int
  ...
  fun g_signal_chain_from_overridden(instance_and_params : Pointer(LibGObject::Value), return_value : Pointer(Void)) : Void
  ...
  @[Raises]
  fun g_signal_emitv(instance_and_params : Pointer(LibGObject::Value), signal_id : UInt32, detail : UInt32, return_value : Pointer(Void)) : Void
  fun g_signal_get_invocation_hint(instance : Pointer(Void)) : Pointer(Void)
  fun g_signal_group_block(this : Void*) : Void
  fun g_signal_group_connect_closure(this : Void*, detailed_signal : Pointer(LibC::Char), closure : Pointer(Void), after : LibC::Int) : Void
  ...
  fun g_signal_override_class_handler(signal_name : Pointer(LibC::Char), instance_type : UInt64, class_handler : Void*) : Void
  ...
  fun g_type_class_adjust_private_offset(g_class : Pointer(Void), private_size_or_offset : Pointer(Int32)) : Void
  fun g_type_class_get(type : UInt64) : Pointer(Void)
  fun g_type_class_get(type : UInt64) : Pointer(Void)
  ...
  fun g_type_default_interface_get(g_type : UInt64) : Pointer(Void)
  ...
  fun g_value_steal_string(this : Void*) : Pointer(LibC::Char)
