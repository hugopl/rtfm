...
module Soup
  ...
  class AuthDigest < Auth
    ...
    GICrystal.declare_new_method(AuthDigest, g_object_get_qdata)

    # Initialize a new `AuthDigest`.
    def initialize
      super
    end
    ...
    def self.g_type : UInt64
      @@g_type ||= LibSoup.soup_auth_digest_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Soup::AuthDigest.new(Void*, GICrystal::Transfer)
