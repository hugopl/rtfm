...
module Soup
  ...
  class AuthNTLM < Auth
    ...
    GICrystal.declare_new_method(AuthNTLM, g_object_get_qdata)

    # Initialize a new `AuthNTLM`.
    def initialize
      super
    end
    ...
    def self.g_type : UInt64
      @@g_type ||= LibSoup.soup_auth_ntlm_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Soup::AuthNTLM.new(Void*, GICrystal::Transfer)
