...
module Gdk
  ...
  class ContentDeserializer < GObject::Object
    ...
    GICrystal.declare_new_method(ContentDeserializer, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGdk.gdk_content_deserializer_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gdk::ContentDeserializer.new(Void*, GICrystal::Transfer)
    ...
    def cancellable : Gio::Cancellable?
      ...
      # C call
      _retval = LibGdk.gdk_content_deserializer_get_cancellable(to_unsafe)
    ...
    def gtype : UInt64
      ...
      # C call
      _retval = LibGdk.gdk_content_deserializer_get_gtype(to_unsafe)
    ...
    def input_stream : Gio::InputStream
      ...
      # C call
      _retval = LibGdk.gdk_content_deserializer_get_input_stream(to_unsafe)
    ...
    def mime_type : ::String
      ...
      # C call
      _retval = LibGdk.gdk_content_deserializer_get_mime_type(to_unsafe)
    ...
    def priority : Int32
      ...
      # C call
      _retval = LibGdk.gdk_content_deserializer_get_priority(to_unsafe)
    ...
    def task_data : Pointer(Void)?
      ...
      # C call
      _retval = LibGdk.gdk_content_deserializer_get_task_data(to_unsafe)
    ...
    def user_data : Pointer(Void)?
      ...
      # C call
      _retval = LibGdk.gdk_content_deserializer_get_user_data(to_unsafe)
    ...
    def value : GObject::Value
      ...
      # C call
      _retval = LibGdk.gdk_content_deserializer_get_value(to_unsafe)
    ...
    def return_error(error : GLib::Error) : Nil
      ...
      # C call
      LibGdk.gdk_content_deserializer_return_error(to_unsafe, error)
    ...
    def return_success : Nil
      ...
      # C call
      LibGdk.gdk_content_deserializer_return_success(to_unsafe)
    ...
    def set_task_data(data : Pointer(Void)?, notify : GLib::DestroyNotify) : Nil
      ...
      # C call
      LibGdk.gdk_content_deserializer_set_task_data(to_unsafe, data, notify)
