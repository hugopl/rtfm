...
lib LibGdk
  ...
  alias CursorGetTextureCallback = Pointer(LibGdk::Cursor), Int32, Float64, Int32, Int32, Int32, Int32, Pointer(Void) -> Pointer(LibGdk::Texture)
  ...
  # Structs
  type CicpParamsClass = Void # Struct with zero bytes

  type ColorState = Void # Struct with zero bytes
  ...
  type DmabufFormats = Void # Struct with zero bytes

  type DmabufTextureBuilderClass = Void # Struct with zero bytes

  type DmabufTextureClass = Void # Struct with zero bytes

  type DragSurfaceInterface = Void # Struct with zero bytes

  type DragSurfaceSize = Void # Struct with zero bytes
  ...
  type GLTextureBuilderClass = Void # Struct with zero bytes
  ...
  type MemoryTextureBuilderClass = Void # Struct with zero bytes
  ...
  type TextureDownloader = Void # Struct with zero bytes
  ...
  type CicpParams = Void # Object struct with no fields
  ...
  type DmabufTexture = Void # Object struct with no fields

  type DmabufTextureBuilder = Void # Object struct with no fields
  ...
  type GLTextureBuilder = Void # Object struct with no fields
  ...
  type MemoryTextureBuilder = Void # Object struct with no fields
  ...
  # All C Functions
  fun gdk_anchor_hints_get_type : UInt64
  ...
  fun gdk_axis_flags_get_type : UInt64
  fun gdk_axis_use_get_type : UInt64
  ...
  fun gdk_cicp_params_build_color_state(this : Void*, error : LibGLib::Error**) : Pointer(Void)
  fun gdk_cicp_params_get_color_primaries(this : Void*) : UInt32
  fun gdk_cicp_params_get_matrix_coefficients(this : Void*) : UInt32
  fun gdk_cicp_params_get_range(this : Void*) : UInt32
  fun gdk_cicp_params_get_transfer_function(this : Void*) : UInt32
  fun gdk_cicp_params_get_type : UInt64
  fun gdk_cicp_params_new : Pointer(Void)
  fun gdk_cicp_params_set_color_primaries(this : Void*, color_primaries : UInt32) : Void
  fun gdk_cicp_params_set_matrix_coefficients(this : Void*, matrix_coefficients : UInt32) : Void
  fun gdk_cicp_params_set_range(this : Void*, range : UInt32) : Void
  fun gdk_cicp_params_set_transfer_function(this : Void*, transfer_function : UInt32) : Void
  fun gdk_cicp_range_get_type : UInt64
  ...
  fun gdk_color_state_get_oklch : Pointer(Void)
  fun gdk_color_state_get_rec2100_linear : Pointer(Void)
  fun gdk_color_state_get_rec2100_linear : Pointer(Void)
  fun gdk_color_state_get_rec2100_pq : Pointer(Void)
  fun gdk_color_state_get_rec2100_pq : Pointer(Void)
  fun gdk_color_state_get_srgb : Pointer(Void)
  fun gdk_color_state_get_srgb : Pointer(Void)
  fun gdk_color_state_get_srgb_linear : Pointer(Void)
  fun gdk_color_state_get_srgb_linear : Pointer(Void)
  fun gdk_color_state_get_type : UInt64
  fun gdk_color_state_ref(this : Void*) : Pointer(Void)
  fun gdk_color_state_unref(this : Void*) : Void
  ...
  fun gdk_content_deserializer_return_error(this : Void*, error : Pointer(LibGLib::Error)) : Void
  ...
  fun gdk_content_formats_is_empty(this : Void*) : LibC::Int
  ...
  fun gdk_content_provider_new_union(providers : Pointer(Pointer(LibGdk::ContentProvider)), n_providers : UInt64) : Pointer(Void)
  ...
  fun gdk_content_serializer_return_error(this : Void*, error : Pointer(LibGLib::Error)) : Void
  ...
  fun gdk_crossing_mode_get_type : UInt64
  ...
  fun gdk_cursor_new_from_callback(callback : Void*, data : Pointer(Void), destroy : Void*, fallback : Pointer(Void)) : Pointer(Void)
  ...
  fun gdk_device_get_active_layout_index(this : Void*) : Int32
  ...
  fun gdk_device_get_layout_names(this : Void*) : Pointer(Pointer(LibC::Char))
  ...
  fun gdk_device_pad_feature_get_type : UInt64
  ...
  fun gdk_device_tool_type_get_type : UInt64
  ...
  fun gdk_display_get_dmabuf_formats(this : Void*) : Pointer(Void)
  ...
  fun gdk_display_map_keycode(this : Void*, keycode : UInt32, keys : Pointer(Pointer(LibGdk::KeymapKey)), keyvals : Pointer(Pointer(UInt32)), n_entries : Pointer(Int32)) : LibC::Int
  fun gdk_display_map_keyval(this : Void*, keyval : UInt32, keys : Pointer(Pointer(LibGdk::KeymapKey)), n_keys : Pointer(Int32)) : LibC::Int
  ...
  fun gdk_display_supports_shadow_width(this : Void*) : LibC::Int
  ...
  fun gdk_dmabuf_error_get_type : UInt64
  fun gdk_dmabuf_error_quark : UInt32
  fun gdk_dmabuf_formats_contains(this : Void*, fourcc : UInt32, modifier : UInt64) : LibC::Int
  fun gdk_dmabuf_formats_equal(this : Void*, formats2 : Pointer(Void)) : LibC::Int
  fun gdk_dmabuf_formats_get_format(this : Void*, idx : UInt64, fourcc : Pointer(UInt32), modifier : Pointer(UInt64)) : Void
  fun gdk_dmabuf_formats_get_n_formats(this : Void*) : UInt64
  fun gdk_dmabuf_formats_get_type : UInt64
  fun gdk_dmabuf_formats_ref(this : Void*) : Pointer(Void)
  fun gdk_dmabuf_formats_unref(this : Void*) : Void
  fun gdk_dmabuf_texture_builder_build(this : Void*, destroy : Void*, data : Pointer(Void), error : LibGLib::Error**) : Pointer(Void)
  fun gdk_dmabuf_texture_builder_get_color_state(this : Void*) : Pointer(Void)
  fun gdk_dmabuf_texture_builder_get_display(this : Void*) : Pointer(Void)
  fun gdk_dmabuf_texture_builder_get_fd(this : Void*, plane : UInt32) : Int32
  fun gdk_dmabuf_texture_builder_get_fourcc(this : Void*) : UInt32
  fun gdk_dmabuf_texture_builder_get_height(this : Void*) : UInt32
  fun gdk_dmabuf_texture_builder_get_modifier(this : Void*) : UInt64
  fun gdk_dmabuf_texture_builder_get_n_planes(this : Void*) : UInt32
  fun gdk_dmabuf_texture_builder_get_offset(this : Void*, plane : UInt32) : UInt32
  fun gdk_dmabuf_texture_builder_get_premultiplied(this : Void*) : LibC::Int
  fun gdk_dmabuf_texture_builder_get_stride(this : Void*, plane : UInt32) : UInt32
  fun gdk_dmabuf_texture_builder_get_type : UInt64
  fun gdk_dmabuf_texture_builder_get_update_region(this : Void*) : Pointer(Void)
  fun gdk_dmabuf_texture_builder_get_update_texture(this : Void*) : Pointer(Void)
  fun gdk_dmabuf_texture_builder_get_width(this : Void*) : UInt32
  fun gdk_dmabuf_texture_builder_new : Pointer(Void)
  fun gdk_dmabuf_texture_builder_set_color_state(this : Void*, color_state : Pointer(Void)) : Void
  fun gdk_dmabuf_texture_builder_set_display(this : Void*, display : Pointer(Void)) : Void
  fun gdk_dmabuf_texture_builder_set_fd(this : Void*, plane : UInt32, fd : Int32) : Void
  fun gdk_dmabuf_texture_builder_set_fourcc(this : Void*, fourcc : UInt32) : Void
  fun gdk_dmabuf_texture_builder_set_height(this : Void*, height : UInt32) : Void
  fun gdk_dmabuf_texture_builder_set_modifier(this : Void*, modifier : UInt64) : Void
  fun gdk_dmabuf_texture_builder_set_n_planes(this : Void*, n_planes : UInt32) : Void
  fun gdk_dmabuf_texture_builder_set_offset(this : Void*, plane : UInt32, offset : UInt32) : Void
  fun gdk_dmabuf_texture_builder_set_premultiplied(this : Void*, premultiplied : LibC::Int) : Void
  fun gdk_dmabuf_texture_builder_set_stride(this : Void*, plane : UInt32, stride : UInt32) : Void
  fun gdk_dmabuf_texture_builder_set_update_region(this : Void*, region : Pointer(Void)) : Void
  fun gdk_dmabuf_texture_builder_set_update_texture(this : Void*, texture : Pointer(Void)) : Void
  fun gdk_dmabuf_texture_builder_set_width(this : Void*, width : UInt32) : Void
  fun gdk_dmabuf_texture_get_type : UInt64
  fun gdk_dnd_event_get_drop(this : Void*) : Pointer(Void)
  fun gdk_dnd_event_get_type : UInt64
  fun gdk_drag_action_get_type : UInt64
  ...
  fun gdk_drag_cancel_reason_get_type : UInt64
  ...
  fun gdk_drag_surface_size_get_type : UInt64
  fun gdk_drag_surface_size_set_size(this : Void*, width : Int32, height : Int32) : Void
  ...
  fun gdk_event_get_history(this : Void*, out_n_coords : Pointer(UInt32)) : Pointer(LibGdk::TimeCoord)
  ...
  fun gdk_event_type_get_type : UInt64
  ...
  fun gdk_file_list_new_from_array(files : Pointer(Pointer(LibGio::File)), n_files : UInt64) : Pointer(Void)
  fun gdk_file_list_new_from_list(files : Pointer(LibGLib::SList)) : Pointer(Void)
  ...
  fun gdk_frame_clock_phase_get_type : UInt64
  ...
  fun gdk_fullscreen_mode_get_type : UInt64
  fun gdk_gl_api_get_type : UInt64
  ...
  fun gdk_gl_error_get_type : UInt64
  fun gdk_gl_error_quark : UInt32
  fun gdk_gl_texture_builder_build(this : Void*, destroy : Void*, data : Pointer(Void)) : Pointer(Void)
  fun gdk_gl_texture_builder_get_color_state(this : Void*) : Pointer(Void)
  fun gdk_gl_texture_builder_get_context(this : Void*) : Pointer(Void)
  fun gdk_gl_texture_builder_get_format(this : Void*) : UInt32
  fun gdk_gl_texture_builder_get_has_mipmap(this : Void*) : LibC::Int
  fun gdk_gl_texture_builder_get_height(this : Void*) : Int32
  fun gdk_gl_texture_builder_get_id(this : Void*) : UInt32
  fun gdk_gl_texture_builder_get_sync(this : Void*) : Pointer(Void)
  fun gdk_gl_texture_builder_get_type : UInt64
  fun gdk_gl_texture_builder_get_update_region(this : Void*) : Pointer(Void)
  fun gdk_gl_texture_builder_get_update_texture(this : Void*) : Pointer(Void)
  fun gdk_gl_texture_builder_get_width(this : Void*) : Int32
  fun gdk_gl_texture_builder_new : Pointer(Void)
  fun gdk_gl_texture_builder_set_color_state(this : Void*, color_state : Pointer(Void)) : Void
  fun gdk_gl_texture_builder_set_context(this : Void*, context : Pointer(Void)) : Void
  fun gdk_gl_texture_builder_set_format(this : Void*, format : UInt32) : Void
  fun gdk_gl_texture_builder_set_has_mipmap(this : Void*, has_mipmap : LibC::Int) : Void
  fun gdk_gl_texture_builder_set_height(this : Void*, height : Int32) : Void
  fun gdk_gl_texture_builder_set_id(this : Void*, id : UInt32) : Void
  fun gdk_gl_texture_builder_set_sync(this : Void*, sync : Pointer(Void)) : Void
  fun gdk_gl_texture_builder_set_update_region(this : Void*, region : Pointer(Void)) : Void
  fun gdk_gl_texture_builder_set_update_texture(this : Void*, texture : Pointer(Void)) : Void
  fun gdk_gl_texture_builder_set_width(this : Void*, width : Int32) : Void
  ...
  fun gdk_gravity_get_type : UInt64
  fun gdk_input_source_get_type : UInt64
  ...
  fun gdk_key_match_get_type : UInt64
  ...
  fun gdk_memory_format_get_type : UInt64
  fun gdk_memory_texture_builder_build(this : Void*) : Pointer(Void)
  fun gdk_memory_texture_builder_get_bytes(this : Void*) : Pointer(Void)
  ...
  fun gdk_memory_texture_builder_get_width(this : Void*) : Int32
  fun gdk_memory_texture_builder_new : Pointer(Void)
  fun gdk_memory_texture_builder_set_bytes(this : Void*, bytes : Pointer(Void)) : Void
  ...
  fun gdk_modifier_type_get_type : UInt64
  fun gdk_monitor_get_connector(this : Void*) : Pointer(LibC::Char)
  fun gdk_monitor_get_description(this : Void*) : Pointer(LibC::Char)
  ...
  fun gdk_monitor_get_scale(this : Void*) : Float64
  ...
  fun gdk_notify_type_get_type : UInt64
  ...
  fun gdk_paintable_flags_get_type : UInt64
  ...
  fun gdk_subpixel_layout_get_type : UInt64
  ...
  fun gdk_surface_edge_get_type : UInt64
  ...
  fun gdk_surface_get_scale(this : Void*) : Float64
  ...
  fun gdk_texture_downloader_get_format(this : Void*) : UInt32
  fun gdk_texture_downloader_get_texture(this : Void*) : Pointer(Void)
  fun gdk_texture_downloader_get_type : UInt64
  fun gdk_texture_downloader_new(texture : Pointer(Void)) : Pointer(Void)
  fun gdk_texture_downloader_set_color_state(this : Void*, color_state : Pointer(Void)) : Void
  fun gdk_texture_downloader_set_format(this : Void*, format : UInt32) : Void
  fun gdk_texture_downloader_set_texture(this : Void*, texture : Pointer(Void)) : Void
  fun gdk_texture_error_get_type : UInt64
  fun gdk_texture_error_quark : UInt32
  fun gdk_texture_get_color_state(this : Void*) : Pointer(Void)
  fun gdk_texture_get_format(this : Void*) : UInt32
  ...
  fun gdk_toplevel_state_get_type : UInt64
  ...
  fun gdk_touchpad_gesture_phase_get_type : UInt64
  fun gdk_unicode_to_keyval(wc : UInt32) : UInt32
  fun gdk_vulkan_context_get_type : UInt64
  fun gdk_vulkan_error_get_type : UInt64
