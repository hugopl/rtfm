...
module Gdk
  ...
  class CairoContext < DrawContext
    ...
    GICrystal.declare_new_method(CairoContext, g_object_get_qdata)

    # Initialize a new `CairoContext`.
    def initialize
      super
    end
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGdk.gdk_cairo_context_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gdk::CairoContext.new(Void*, GICrystal::Transfer)
    ...
    def cairo_create : Cairo::Context?
      ...
      # C call
      _retval = LibGdk.gdk_cairo_context_cairo_create(to_unsafe)
