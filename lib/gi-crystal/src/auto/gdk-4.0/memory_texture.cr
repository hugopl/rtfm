...
module Gdk
  ...
  class MemoryTexture < Texture
    ...
    GICrystal.declare_new_method(MemoryTexture, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGdk.gdk_memory_texture_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gdk::MemoryTexture.new(Void*, GICrystal::Transfer)
