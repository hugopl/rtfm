...
module Gdk
  ...
  class VulkanContext < DrawContext
    ...
    GICrystal.declare_new_method(VulkanContext, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibGdk.gdk_vulkan_context_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Gdk::VulkanContext.new(Void*, GICrystal::Transfer)
