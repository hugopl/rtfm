...
module Adw
  ...
  class ViewSwitcherBar < Gtk::Widget
    ...
    GICrystal.declare_new_method(ViewSwitcherBar, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibAdw.adw_view_switcher_bar_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Adw::ViewSwitcherBar.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      ...
      Adw::ViewSwitcherBar.new(_retval, GICrystal::Transfer::Full)
    end
    ...
    def reveal : Bool
      ...
      # C call
      _retval = LibAdw.adw_view_switcher_bar_get_reveal(to_unsafe)
    ...
    def stack : Adw::ViewStack?
      ...
      # C call
      _retval = LibAdw.adw_view_switcher_bar_get_stack(to_unsafe)
    ...
    def reveal=(reveal : Bool) : Nil
      ...
      # C call
      LibAdw.adw_view_switcher_bar_set_reveal(to_unsafe, reveal)
    ...
    def stack=(stack : Adw::ViewStack?) : Nil
      ...
      # C call
      LibAdw.adw_view_switcher_bar_set_stack(to_unsafe, stack)
