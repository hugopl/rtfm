...
module Adw
  ...
  class Avatar < Gtk::Widget
    ...
    GICrystal.declare_new_method(Avatar, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibAdw.adw_avatar_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Adw::Avatar.new(Void*, GICrystal::Transfer)
    ...
    def draw_to_texture(scale_factor : Int32) : Gdk::Texture
      ...
      # C call
      _retval = LibAdw.adw_avatar_draw_to_texture(to_unsafe, scale_factor)
    ...
    def custom_image : Gdk::Paintable?
      ...
      # C call
      _retval = LibAdw.adw_avatar_get_custom_image(to_unsafe)
    ...
    def icon_name : ::String?
      ...
      # C call
      _retval = LibAdw.adw_avatar_get_icon_name(to_unsafe)
    ...
    def show_initials : Bool
      ...
      # C call
      _retval = LibAdw.adw_avatar_get_show_initials(to_unsafe)
    ...
    def size : Int32
      ...
      # C call
      _retval = LibAdw.adw_avatar_get_size(to_unsafe)
    ...
    def text : ::String?
      ...
      # C call
      _retval = LibAdw.adw_avatar_get_text(to_unsafe)
    ...
    def custom_image=(custom_image : Gdk::Paintable?) : Nil
      ...
      # C call
      LibAdw.adw_avatar_set_custom_image(to_unsafe, custom_image)
    ...
    def icon_name=(icon_name : ::String?) : Nil
      ...
      # C call
      LibAdw.adw_avatar_set_icon_name(to_unsafe, icon_name)
    ...
    def show_initials=(show_initials : Bool) : Nil
      ...
      # C call
      LibAdw.adw_avatar_set_show_initials(to_unsafe, show_initials)
    ...
    def size=(size : Int32) : Nil
      ...
      # C call
      LibAdw.adw_avatar_set_size(to_unsafe, size)
    ...
    def text=(text : ::String?) : Nil
      ...
      # C call
      LibAdw.adw_avatar_set_text(to_unsafe, text)
