...
module Adw
  ...
  class ButtonContent < Gtk::Widget
    ...
    GICrystal.declare_new_method(ButtonContent, g_object_get_qdata)

    # Initialize a new `ButtonContent`.
    def initialize
      super
    end
    ...
    def self.g_type : UInt64
      @@g_type ||= LibAdw.adw_button_content_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Adw::ButtonContent.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      ...
      Adw::ButtonContent.new(_retval, GICrystal::Transfer::Full)
    end

    def can_shrink : Bool
      # adw_button_content_get_can_shrink: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibAdw.adw_button_content_get_can_shrink(to_unsafe)
    ...
    def icon_name : ::String
      ...
      # C call
      _retval = LibAdw.adw_button_content_get_icon_name(to_unsafe)
    ...
    def label : ::String
      ...
      # C call
      _retval = LibAdw.adw_button_content_get_label(to_unsafe)
    ...
    def use_underline : Bool
      ...
      # C call
      _retval = LibAdw.adw_button_content_get_use_underline(to_unsafe)
    ...
    def can_shrink=(can_shrink : Bool) : Nil
      # adw_button_content_set_can_shrink: (Method | Setter)
      # @can_shrink:
      # Returns: (transfer none)

      # C call
      LibAdw.adw_button_content_set_can_shrink(to_unsafe, can_shrink)
    ...
    def icon_name=(icon_name : ::String) : Nil
      ...
      # C call
      LibAdw.adw_button_content_set_icon_name(to_unsafe, icon_name)
    ...
    def label=(label : ::String) : Nil
      ...
      # C call
      LibAdw.adw_button_content_set_label(to_unsafe, label)
    ...
    def use_underline=(use_underline : Bool) : Nil
      ...
      # C call
      LibAdw.adw_button_content_set_use_underline(to_unsafe, use_underline)
