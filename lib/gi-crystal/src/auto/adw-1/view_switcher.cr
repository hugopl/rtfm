...
module Adw
  ...
  class ViewSwitcher < Gtk::Widget
    ...
    GICrystal.declare_new_method(ViewSwitcher, g_object_get_qdata)

    # Initialize a new `ViewSwitcher`.
    def initialize
      super
    end
    ...
    def self.g_type : UInt64
      @@g_type ||= LibAdw.adw_view_switcher_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Adw::ViewSwitcher.new(Void*, GICrystal::Transfer)
    ...
    def policy : Adw::ViewSwitcherPolicy
      ...
      Adw::ViewSwitcherPolicy.new(value)
    end
    ...
    def self.new : self
      ...
      Adw::ViewSwitcher.new(_retval, GICrystal::Transfer::Full)
    end
    ...
    def policy : Adw::ViewSwitcherPolicy
      ...
      # C call
      _retval = LibAdw.adw_view_switcher_get_policy(to_unsafe)

      # Return value handling
      Adw::ViewSwitcherPolicy.new(_retval)
    end
    ...
    def stack : Adw::ViewStack?
      ...
      # C call
      _retval = LibAdw.adw_view_switcher_get_stack(to_unsafe)
    ...
    def policy=(policy : Adw::ViewSwitcherPolicy) : Nil
      ...
      # C call
      LibAdw.adw_view_switcher_set_policy(to_unsafe, policy)
    ...
    def stack=(stack : Adw::ViewStack?) : Nil
      ...
      # C call
      LibAdw.adw_view_switcher_set_stack(to_unsafe, stack)
