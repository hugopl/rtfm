...
module Adw
  ...
  class AboutDialog < Dialog
    ...
    def self.g_type : UInt64
      @@g_type ||= LibAdw.adw_about_dialog_get_type.tap do |g_type|
    ...
    def self.new : self
      # adw_about_dialog_new: (Constructor)
      # Returns: (transfer none)

      # C call
      _retval = LibAdw.adw_about_dialog_new

      # Return value handling
      Adw::AboutDialog.new(_retval, GICrystal::Transfer::Full)
    end

    def self.new_from_appdata(resource_path : ::String, release_notes_version : ::String?) : self
      # adw_about_dialog_new_from_appdata: (Constructor)
      # @resource_path:
      ...
      # C call
      _retval = LibAdw.adw_about_dialog_new_from_appdata(resource_path, release_notes_version)
    ...
    def add_acknowledgement_section(name : ::String?, people : Enumerable(::String)) : Nil
      # adw_about_dialog_add_acknowledgement_section: (Method)
      # @name: (nullable)
      ...
      # C call
      LibAdw.adw_about_dialog_add_acknowledgement_section(to_unsafe, name, people)

      # Return value handling
    end

    def add_credit_section(name : ::String?, people : Enumerable(::String)) : Nil
      # adw_about_dialog_add_credit_section: (Method)
      # @name: (nullable)
      # @people: (array zero-terminated=1 element-type Utf8)
      # Returns: (transfer none)
      ...
      # C call
      LibAdw.adw_about_dialog_add_credit_section(to_unsafe, name, people)

      # Return value handling
    end

    def add_legal_section(title : ::String, copyright : ::String?, license_type : Gtk::License, license : ::String?) : Nil
      # adw_about_dialog_add_legal_section: (Method)
      # @title:
      # @copyright: (nullable)
      # @license_type:
      # @license: (nullable)
      ...
      # C call
      LibAdw.adw_about_dialog_add_legal_section(to_unsafe, title, copyright, license_type, license)

      # Return value handling
    end

    def add_link(title : ::String, url : ::String) : Nil
      # adw_about_dialog_add_link: (Method)
      # @title:
      # @url:
      # Returns: (transfer none)

      # C call
      LibAdw.adw_about_dialog_add_link(to_unsafe, title, url)

      # Return value handling
    end

    def add_other_app(appid : ::String, name : ::String, summary : ::String) : Nil
      # adw_about_dialog_add_other_app: (Method)
      # @appid:
      # @name:
      # @summary:
      # Returns: (transfer none)
      ...
      # C call
      LibAdw.adw_about_dialog_add_other_app(to_unsafe, appid, name, summary)
    ...
    def application_icon : ::String
      ...
      # C call
      _retval = LibAdw.adw_about_dialog_get_application_icon(to_unsafe)
    ...
    def application_name : ::String
      # adw_about_dialog_get_application_name: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibAdw.adw_about_dialog_get_application_name(to_unsafe)
    ...
    def artists : Enumerable(::String)?
      # adw_about_dialog_get_artists: (Method | Getter)
      # Returns: (transfer none) (nullable) (array zero-terminated=1 element-type Utf8)

      # C call
      _retval = LibAdw.adw_about_dialog_get_artists(to_unsafe)
    ...
    def comments : ::String
      # adw_about_dialog_get_comments: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibAdw.adw_about_dialog_get_comments(to_unsafe)
    ...
    def copyright : ::String
      # adw_about_dialog_get_copyright: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibAdw.adw_about_dialog_get_copyright(to_unsafe)
    ...
    def debug_info : ::String
      # adw_about_dialog_get_debug_info: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibAdw.adw_about_dialog_get_debug_info(to_unsafe)
    ...
    def debug_info_filename : ::String
      # adw_about_dialog_get_debug_info_filename: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibAdw.adw_about_dialog_get_debug_info_filename(to_unsafe)
    ...
    def designers : Enumerable(::String)?
      # adw_about_dialog_get_designers: (Method | Getter)
      # Returns: (transfer none) (nullable) (array zero-terminated=1 element-type Utf8)

      # C call
      _retval = LibAdw.adw_about_dialog_get_designers(to_unsafe)
    ...
    def developer_name : ::String
      # adw_about_dialog_get_developer_name: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibAdw.adw_about_dialog_get_developer_name(to_unsafe)
    ...
    def developers : Enumerable(::String)?
      # adw_about_dialog_get_developers: (Method | Getter)
      # Returns: (transfer none) (nullable) (array zero-terminated=1 element-type Utf8)

      # C call
      _retval = LibAdw.adw_about_dialog_get_developers(to_unsafe)
    ...
    def documenters : Enumerable(::String)?
      # adw_about_dialog_get_documenters: (Method | Getter)
      # Returns: (transfer none) (nullable) (array zero-terminated=1 element-type Utf8)

      # C call
      _retval = LibAdw.adw_about_dialog_get_documenters(to_unsafe)
    ...
    def issue_url : ::String
      # adw_about_dialog_get_issue_url: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibAdw.adw_about_dialog_get_issue_url(to_unsafe)
    ...
    def license : ::String
      # adw_about_dialog_get_license: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibAdw.adw_about_dialog_get_license(to_unsafe)
    ...
    def license_type : Gtk::License
      # adw_about_dialog_get_license_type: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibAdw.adw_about_dialog_get_license_type(to_unsafe)
    ...
    def release_notes : ::String
      # adw_about_dialog_get_release_notes: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibAdw.adw_about_dialog_get_release_notes(to_unsafe)
    ...
    def release_notes_version : ::String
      # adw_about_dialog_get_release_notes_version: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibAdw.adw_about_dialog_get_release_notes_version(to_unsafe)
    ...
    def support_url : ::String
      # adw_about_dialog_get_support_url: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibAdw.adw_about_dialog_get_support_url(to_unsafe)
    ...
    def translator_credits : ::String
      # adw_about_dialog_get_translator_credits: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibAdw.adw_about_dialog_get_translator_credits(to_unsafe)
    ...
    def version : ::String
      # adw_about_dialog_get_version: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibAdw.adw_about_dialog_get_version(to_unsafe)
    ...
    def website : ::String
      # adw_about_dialog_get_website: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibAdw.adw_about_dialog_get_website(to_unsafe)
    ...
    def application_icon=(application_icon : ::String) : Nil
      # adw_about_dialog_set_application_icon: (Method | Setter)
      # @application_icon:
      # Returns: (transfer none)

      # C call
      LibAdw.adw_about_dialog_set_application_icon(to_unsafe, application_icon)

      # Return value handling
    end

    def application_name=(application_name : ::String) : Nil
      # adw_about_dialog_set_application_name: (Method | Setter)
      # @application_name:
      # Returns: (transfer none)

      # C call
      LibAdw.adw_about_dialog_set_application_name(to_unsafe, application_name)

      # Return value handling
    end

    def artists=(artists : Enumerable(::String)?) : Nil
      # adw_about_dialog_set_artists: (Method | Setter)
      ...
      # C call
      LibAdw.adw_about_dialog_set_artists(to_unsafe, artists)

      # Return value handling
    end

    def comments=(comments : ::String) : Nil
      # adw_about_dialog_set_comments: (Method | Setter)
      # @comments:
      # Returns: (transfer none)

      # C call
      LibAdw.adw_about_dialog_set_comments(to_unsafe, comments)

      # Return value handling
    end

    def copyright=(copyright : ::String) : Nil
      # adw_about_dialog_set_copyright: (Method | Setter)
      # @copyright:
      # Returns: (transfer none)

      # C call
      LibAdw.adw_about_dialog_set_copyright(to_unsafe, copyright)

      # Return value handling
    end

    def debug_info=(debug_info : ::String) : Nil
      # adw_about_dialog_set_debug_info: (Method | Setter)
      # @debug_info:
      # Returns: (transfer none)

      # C call
      LibAdw.adw_about_dialog_set_debug_info(to_unsafe, debug_info)

      # Return value handling
    end

    def debug_info_filename=(filename : ::String) : Nil
      # adw_about_dialog_set_debug_info_filename: (Method | Setter)
      # @filename:
      # Returns: (transfer none)

      # C call
      LibAdw.adw_about_dialog_set_debug_info_filename(to_unsafe, filename)

      # Return value handling
    end

    def designers=(designers : Enumerable(::String)?) : Nil
      # adw_about_dialog_set_designers: (Method | Setter)
      ...
      # C call
      LibAdw.adw_about_dialog_set_designers(to_unsafe, designers)

      # Return value handling
    end

    def developer_name=(developer_name : ::String) : Nil
      # adw_about_dialog_set_developer_name: (Method | Setter)
      # @developer_name:
      # Returns: (transfer none)

      # C call
      LibAdw.adw_about_dialog_set_developer_name(to_unsafe, developer_name)

      # Return value handling
    end

    def developers=(developers : Enumerable(::String)?) : Nil
      # adw_about_dialog_set_developers: (Method | Setter)
      ...
      # C call
      LibAdw.adw_about_dialog_set_developers(to_unsafe, developers)

      # Return value handling
    end

    def documenters=(documenters : Enumerable(::String)?) : Nil
      # adw_about_dialog_set_documenters: (Method | Setter)
      ...
      # C call
      LibAdw.adw_about_dialog_set_documenters(to_unsafe, documenters)

      # Return value handling
    end

    def issue_url=(issue_url : ::String) : Nil
      # adw_about_dialog_set_issue_url: (Method | Setter)
      # @issue_url:
      # Returns: (transfer none)

      # C call
      LibAdw.adw_about_dialog_set_issue_url(to_unsafe, issue_url)

      # Return value handling
    end

    def license=(license : ::String) : Nil
      # adw_about_dialog_set_license: (Method | Setter)
      # @license:
      # Returns: (transfer none)

      # C call
      LibAdw.adw_about_dialog_set_license(to_unsafe, license)

      # Return value handling
    end

    def license_type=(license_type : Gtk::License) : Nil
      # adw_about_dialog_set_license_type: (Method | Setter)
      # @license_type:
      # Returns: (transfer none)

      # C call
      LibAdw.adw_about_dialog_set_license_type(to_unsafe, license_type)

      # Return value handling
    end

    def release_notes=(release_notes : ::String) : Nil
      # adw_about_dialog_set_release_notes: (Method | Setter)
      # @release_notes:
      # Returns: (transfer none)

      # C call
      LibAdw.adw_about_dialog_set_release_notes(to_unsafe, release_notes)

      # Return value handling
    end

    def release_notes_version=(version : ::String) : Nil
      # adw_about_dialog_set_release_notes_version: (Method | Setter)
      # @version:
      # Returns: (transfer none)

      # C call
      LibAdw.adw_about_dialog_set_release_notes_version(to_unsafe, version)

      # Return value handling
    end

    def support_url=(support_url : ::String) : Nil
      # adw_about_dialog_set_support_url: (Method | Setter)
      # @support_url:
      # Returns: (transfer none)

      # C call
      LibAdw.adw_about_dialog_set_support_url(to_unsafe, support_url)

      # Return value handling
    end

    def translator_credits=(translator_credits : ::String) : Nil
      # adw_about_dialog_set_translator_credits: (Method | Setter)
      # @translator_credits:
      # Returns: (transfer none)

      # C call
      LibAdw.adw_about_dialog_set_translator_credits(to_unsafe, translator_credits)

      # Return value handling
    end

    def version=(version : ::String) : Nil
      # adw_about_dialog_set_version: (Method | Setter)
      # @version:
      # Returns: (transfer none)

      # C call
      LibAdw.adw_about_dialog_set_version(to_unsafe, version)

      # Return value handling
    end

    def website=(website : ::String) : Nil
      # adw_about_dialog_set_website: (Method | Setter)
      # @website:
      # Returns: (transfer none)

      # C call
      LibAdw.adw_about_dialog_set_website(to_unsafe, website)
    ...
    struct ActivateLinkSignal < GObject::Signal
      ...
      def connect(handler : Proc(Adw::AboutDialog, ::String, Bool), *, after : Bool = false) : GObject::SignalConnection
        _box = ::Box.box(handler)
        handler = ->(_lib_sender : Pointer(Void), lib_uri : Pointer(LibC::Char), _lib_box : Pointer(Void)) {
