...
module Adw
  ...
  class CarouselIndicatorDots < Gtk::Widget
    ...
    GICrystal.declare_new_method(CarouselIndicatorDots, g_object_get_qdata)

    # Initialize a new `CarouselIndicatorDots`.
    def initialize
      super
    end
    ...
    def self.g_type : UInt64
      @@g_type ||= LibAdw.adw_carousel_indicator_dots_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Adw::CarouselIndicatorDots.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      ...
      Adw::CarouselIndicatorDots.new(_retval, GICrystal::Transfer::Full)
    end
    ...
    def carousel : Adw::Carousel?
      ...
      # C call
      _retval = LibAdw.adw_carousel_indicator_dots_get_carousel(to_unsafe)
    ...
    def carousel=(carousel : Adw::Carousel?) : Nil
      # adw_carousel_indicator_dots_set_carousel: (Method | Setter)
      # @carousel: (nullable)
      # Returns: (transfer none)
      ...
      # C call
      LibAdw.adw_carousel_indicator_dots_set_carousel(to_unsafe, carousel)
