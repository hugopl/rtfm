  ...
  class Window < Gtk::Window
    ...
    def self._register_derived_type(class_name : String, class_init, instance_init)
      LibGObject.g_type_register_static_simple(g_type, class_name,
        sizeof(LibAdw::WindowClass), class_init,
        sizeof(LibAdw::Window), instance_init, 0)
    end
    ...
    def self.g_type : UInt64
      @@g_type ||= LibAdw.adw_window_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Adw::Window.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      ...
      Adw::Window.new(_retval, GICrystal::Transfer::Full)
    end

    def add_breakpoint(breakpoint : Adw::Breakpoint) : Nil
      # adw_window_add_breakpoint: (Method)
      ...
      # C call
      LibAdw.adw_window_add_breakpoint(to_unsafe, breakpoint)

      # Return value handling
    end

    def adaptive_preview : Bool
      # adw_window_get_adaptive_preview: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibAdw.adw_window_get_adaptive_preview(to_unsafe)
    ...
    def content : Gtk::Widget?
      # adw_window_get_content: (Method | Getter)
      # Returns: (transfer none) (nullable)

      # C call
      _retval = LibAdw.adw_window_get_content(to_unsafe)
    ...
    def current_breakpoint : Adw::Breakpoint?
      # adw_window_get_current_breakpoint: (Method | Getter)
      # Returns: (transfer none) (nullable)

      # C call
      _retval = LibAdw.adw_window_get_current_breakpoint(to_unsafe)
    ...
    def dialogs : Gio::ListModel
      # adw_window_get_dialogs: (Method | Getter)
      # Returns: (transfer full)

      # C call
      _retval = LibAdw.adw_window_get_dialogs(to_unsafe)
    ...
    def visible_dialog : Adw::Dialog?
      # adw_window_get_visible_dialog: (Method | Getter)
      # Returns: (transfer none) (nullable)

      # C call
      _retval = LibAdw.adw_window_get_visible_dialog(to_unsafe)
    ...
    def adaptive_preview=(adaptive_preview : Bool) : Nil
      # adw_window_set_adaptive_preview: (Method | Setter)
      # @adaptive_preview:
      # Returns: (transfer none)

      # C call
      LibAdw.adw_window_set_adaptive_preview(to_unsafe, adaptive_preview)

      # Return value handling
    end

    def content=(content : Gtk::Widget?) : Nil
      # adw_window_set_content: (Method | Setter)
      # @content: (nullable)
      # Returns: (transfer none)
      ...
      # C call
      LibAdw.adw_window_set_content(to_unsafe, content)
