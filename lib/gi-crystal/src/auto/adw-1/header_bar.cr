...
module Adw
  ...
  class HeaderBar < Gtk::Widget
    ...
    def initialize(*, accessible_role : Gtk::AccessibleRole? = nil, can_focus : Bool? = nil, can_target : Bool? = nil, centering_policy : Adw::CenteringPolicy? = nil, css_classes : Enumerable(::String)? = nil, css_name : ::String? = nil, cursor : Gdk::Cursor? = nil, decoration_layout : ::String? = nil, focus_on_click : Bool? = nil, focusable : Bool? = nil, halign : Gtk::Align? = nil, has_default : Bool? = nil, has_focus : Bool? = nil, has_tooltip : Bool? = nil, height_request : Int32? = nil, hexpand : Bool? = nil, hexpand_set : Bool? = nil, layout_manager : Gtk::LayoutManager? = nil, limit_events : Bool? = nil, margin_bottom : Int32? = nil, margin_end : Int32? = nil, margin_start : Int32? = nil, margin_top : Int32? = nil, name : ::String? = nil, opacity : Float64? = nil, overflow : Gtk::Overflow? = nil, parent : Gtk::Widget? = nil, receives_default : Bool? = nil, root : Gtk::Root? = nil, scale_factor : Int32? = nil, sensitive : Bool? = nil, show_back_button : Bool? = nil, show_end_title_buttons : Bool? = nil, show_start_title_buttons : Bool? = nil, show_title : Bool? = nil, title_widget : Gtk::Widget? = nil, tooltip_markup : ::String? = nil, tooltip_text : ::String? = nil, valign : Gtk::Align? = nil, vexpand : Bool? = nil, vexpand_set : Bool? = nil, visible : Bool? = nil, width_request : Int32? = nil)
      ...
      if !show_back_button.nil?
        (_names.to_unsafe + _n).value = "show-back-button".to_unsafe
        GObject::Value.init_g_value(_values.to_unsafe + _n, show_back_button)
        _n += 1
      end
      ...
      if !show_title.nil?
        (_names.to_unsafe + _n).value = "show-title".to_unsafe
        GObject::Value.init_g_value(_values.to_unsafe + _n, show_title)
        _n += 1
      end
      if !title_widget.nil?
    ...
    def self.g_type : UInt64
      @@g_type ||= LibAdw.adw_header_bar_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Adw::HeaderBar.new(Void*, GICrystal::Transfer)
    ...
    def show_back_button=(value : Bool) : Bool
      unsafe_value = value

      LibGObject.g_object_set(self, "show-back-button", unsafe_value, Pointer(Void).null)
      value
    end

    def show_back_button? : Bool
      # Returns: None

      value = uninitialized LibC::Int
      LibGObject.g_object_get(self, "show-back-button", pointerof(value), Pointer(Void).null)
    ...
    def show_title=(value : Bool) : Bool
      unsafe_value = value

      LibGObject.g_object_set(self, "show-title", unsafe_value, Pointer(Void).null)
      value
    end
    ...
    def show_title? : Bool
      ...
      value = uninitialized LibC::Int
      LibGObject.g_object_get(self, "show-title", pointerof(value), Pointer(Void).null)
      GICrystal.to_bool(value)
    end
    ...
    def self.new : self
      ...
      Adw::HeaderBar.new(_retval, GICrystal::Transfer::Full)
    end
    ...
    def centering_policy : Adw::CenteringPolicy
      ...
      # C call
      _retval = LibAdw.adw_header_bar_get_centering_policy(to_unsafe)
    ...
    def decoration_layout : ::String?
      ...
      # C call
      _retval = LibAdw.adw_header_bar_get_decoration_layout(to_unsafe)
    ...
    def show_back_button : Bool
      # adw_header_bar_get_show_back_button: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibAdw.adw_header_bar_get_show_back_button(to_unsafe)
    ...
    def show_end_title_buttons : Bool
      ...
      # C call
      _retval = LibAdw.adw_header_bar_get_show_end_title_buttons(to_unsafe)
    ...
    def show_start_title_buttons : Bool
      ...
      # C call
      _retval = LibAdw.adw_header_bar_get_show_start_title_buttons(to_unsafe)
    ...
    def show_title : Bool
      # adw_header_bar_get_show_title: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibAdw.adw_header_bar_get_show_title(to_unsafe)
    ...
    def title_widget : Gtk::Widget?
      ...
      # C call
      _retval = LibAdw.adw_header_bar_get_title_widget(to_unsafe)
    ...
    def pack_end(child : Gtk::Widget) : Nil
      ...
      # C call
      LibAdw.adw_header_bar_pack_end(to_unsafe, child)
    ...
    def pack_start(child : Gtk::Widget) : Nil
      ...
      # C call
      LibAdw.adw_header_bar_pack_start(to_unsafe, child)
    ...
    def remove(child : Gtk::Widget) : Nil
      ...
      # C call
      LibAdw.adw_header_bar_remove(to_unsafe, child)
    ...
    def centering_policy=(centering_policy : Adw::CenteringPolicy) : Nil
      ...
      # C call
      LibAdw.adw_header_bar_set_centering_policy(to_unsafe, centering_policy)
    ...
    def decoration_layout=(layout : ::String?) : Nil
      ...
      # C call
      LibAdw.adw_header_bar_set_decoration_layout(to_unsafe, layout)

      # Return value handling
    end

    def show_back_button=(show_back_button : Bool) : Nil
      # adw_header_bar_set_show_back_button: (Method | Setter)
      # @show_back_button:
      # Returns: (transfer none)

      # C call
      LibAdw.adw_header_bar_set_show_back_button(to_unsafe, show_back_button)
    ...
    def show_end_title_buttons=(setting : Bool) : Nil
      ...
      # C call
      LibAdw.adw_header_bar_set_show_end_title_buttons(to_unsafe, setting)
    ...
    def show_start_title_buttons=(setting : Bool) : Nil
      ...
      # C call
      LibAdw.adw_header_bar_set_show_start_title_buttons(to_unsafe, setting)

      # Return value handling
    end

    def show_title=(show_title : Bool) : Nil
      # adw_header_bar_set_show_title: (Method | Setter)
      # @show_title:
      # Returns: (transfer none)

      # C call
      LibAdw.adw_header_bar_set_show_title(to_unsafe, show_title)
    ...
    def title_widget=(title_widget : Gtk::Widget?) : Nil
      ...
      # C call
      LibAdw.adw_header_bar_set_title_widget(to_unsafe, title_widget)
