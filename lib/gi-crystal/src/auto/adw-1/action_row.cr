...
module Adw
  ...
  class ActionRow < PreferencesRow
    ...
    GICrystal.declare_new_method(ActionRow, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibAdw.adw_action_row_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Adw::ActionRow.new(Void*, GICrystal::Transfer)
    ...
    def subtitle_selectable=(value : Bool) : Bool
      unsafe_value = value

      LibGObject.g_object_set(self, "subtitle-selectable", unsafe_value, Pointer(Void).null)
      value
    end

    def subtitle_selectable? : Bool
      # Returns: None

      value = uninitialized LibC::Int
      LibGObject.g_object_get(self, "subtitle-selectable", pointerof(value), Pointer(Void).null)
    ...
    def self.new : self
      ...
      Adw::ActionRow.new(_retval, GICrystal::Transfer::Full)
    end
    ...
    def activate : Nil
      ...
      # C call
      LibAdw.adw_action_row_activate(to_unsafe)
    ...
    def add_prefix(widget : Gtk::Widget) : Nil
      ...
      # C call
      LibAdw.adw_action_row_add_prefix(to_unsafe, widget)
    ...
    def add_suffix(widget : Gtk::Widget) : Nil
      ...
      # C call
      LibAdw.adw_action_row_add_suffix(to_unsafe, widget)
    ...
    def activatable_widget : Gtk::Widget?
      ...
      # C call
      _retval = LibAdw.adw_action_row_get_activatable_widget(to_unsafe)
    ...
    def icon_name : ::String?
      ...
      # C call
      _retval = LibAdw.adw_action_row_get_icon_name(to_unsafe)
    ...
    def subtitle : ::String?
      ...
      # C call
      _retval = LibAdw.adw_action_row_get_subtitle(to_unsafe)
    ...
    def subtitle_lines : Int32
      ...
      # C call
      _retval = LibAdw.adw_action_row_get_subtitle_lines(to_unsafe)
    ...
    def subtitle_selectable : Bool
      # adw_action_row_get_subtitle_selectable: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibAdw.adw_action_row_get_subtitle_selectable(to_unsafe)
    ...
    def title_lines : Int32
      ...
      # C call
      _retval = LibAdw.adw_action_row_get_title_lines(to_unsafe)
    ...
    def remove(widget : Gtk::Widget) : Nil
      ...
      # C call
      LibAdw.adw_action_row_remove(to_unsafe, widget)
    ...
    def activatable_widget=(widget : Gtk::Widget?) : Nil
      ...
      # C call
      LibAdw.adw_action_row_set_activatable_widget(to_unsafe, widget)
    ...
    def icon_name=(icon_name : ::String?) : Nil
      ...
      # C call
      LibAdw.adw_action_row_set_icon_name(to_unsafe, icon_name)
    ...
    def subtitle=(subtitle : ::String) : Nil
      ...
      # C call
      LibAdw.adw_action_row_set_subtitle(to_unsafe, subtitle)
    ...
    def subtitle_lines=(subtitle_lines : Int32) : Nil
      ...
      # C call
      LibAdw.adw_action_row_set_subtitle_lines(to_unsafe, subtitle_lines)

      # Return value handling
    end

    def subtitle_selectable=(subtitle_selectable : Bool) : Nil
      # adw_action_row_set_subtitle_selectable: (Method | Setter)
      # @subtitle_selectable:
      # Returns: (transfer none)

      # C call
      LibAdw.adw_action_row_set_subtitle_selectable(to_unsafe, subtitle_selectable)
    ...
    def title_lines=(title_lines : Int32) : Nil
      ...
      # C call
      LibAdw.adw_action_row_set_title_lines(to_unsafe, title_lines)
    ...
    struct ActivatedSignal < GObject::Signal
      ...
      def connect(handler : Proc(Adw::ActionRow, Nil), *, after : Bool = false) : GObject::SignalConnection
        _box = ::Box.box(handler)
        handler = ->(_lib_sender : Pointer(Void), _lib_box : Pointer(Void)) {
