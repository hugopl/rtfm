...
module Adw
  ...
  class WindowTitle < Gtk::Widget
    ...
    GICrystal.declare_new_method(WindowTitle, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibAdw.adw_window_title_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Adw::WindowTitle.new(Void*, GICrystal::Transfer)
    ...
    def self.new(title : ::String, subtitle : ::String) : self
      ...
      # C call
      _retval = LibAdw.adw_window_title_new(title, subtitle)
    ...
    def subtitle : ::String
      # adw_window_title_get_subtitle: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibAdw.adw_window_title_get_subtitle(to_unsafe)
    ...
    def title : ::String
      # adw_window_title_get_title: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibAdw.adw_window_title_get_title(to_unsafe)
    ...
    def subtitle=(subtitle : ::String) : Nil
      # adw_window_title_set_subtitle: (Method | Setter)
      # @subtitle:
      # Returns: (transfer none)

      # C call
      LibAdw.adw_window_title_set_subtitle(to_unsafe, subtitle)

      # Return value handling
    end

    def title=(title : ::String) : Nil
      # adw_window_title_set_title: (Method | Setter)
      # @title:
      # Returns: (transfer none)

      # C call
      LibAdw.adw_window_title_set_title(to_unsafe, title)
