...
module Adw
  ...
  class ToastOverlay < Gtk::Widget
    ...
    GICrystal.declare_new_method(ToastOverlay, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibAdw.adw_toast_overlay_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Adw::ToastOverlay.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      ...
      Adw::ToastOverlay.new(_retval, GICrystal::Transfer::Full)
    end
    ...
    def add_toast(toast : Adw::Toast) : Nil
      ...
      # C call
      LibAdw.adw_toast_overlay_add_toast(to_unsafe, toast)

      # Return value handling
    end

    def dismiss_all : Nil
      # adw_toast_overlay_dismiss_all: (Method)
      # Returns: (transfer none)

      # C call
      LibAdw.adw_toast_overlay_dismiss_all(to_unsafe)
    ...
    def child : Gtk::Widget?
      ...
      # C call
      _retval = LibAdw.adw_toast_overlay_get_child(to_unsafe)
    ...
    def child=(child : Gtk::Widget?) : Nil
      ...
      # C call
      LibAdw.adw_toast_overlay_set_child(to_unsafe, child)
