...
module Adw
  ...
  class ViewSwitcherSidebar < Gtk::Widget
    ...
    GICrystal.declare_new_method(ViewSwitcherSidebar, g_object_get_qdata)

    # Initialize a new `ViewSwitcherSidebar`.
    def initialize
      super
    end
    ...
    def initialize(*, accessible_role : Gtk::AccessibleRole? = nil, can_focus : Bool? = nil, can_target : Bool? = nil, css_classes : Enumerable(::String)? = nil, css_name : ::String? = nil, cursor : Gdk::Cursor? = nil, filter : Gtk::Filter? = nil, focus_on_click : Bool? = nil, focusable : Bool? = nil, halign : Gtk::Align? = nil, has_default : Bool? = nil, has_focus : Bool? = nil, has_tooltip : Bool? = nil, height_request : Int32? = nil, hexpand : Bool? = nil, hexpand_set : Bool? = nil, layout_manager : Gtk::LayoutManager? = nil, limit_events : Bool? = nil, margin_bottom : Int32? = nil, margin_end : Int32? = nil, margin_start : Int32? = nil, margin_top : Int32? = nil, mode : Adw::SidebarMode? = nil, name : ::String? = nil, opacity : Float64? = nil, overflow : Gtk::Overflow? = nil, parent : Gtk::Widget? = nil, placeholder : Gtk::Widget? = nil, receives_default : Bool? = nil, root : Gtk::Root? = nil, scale_factor : Int32? = nil, sensitive : Bool? = nil, stack : Adw::ViewStack? = nil, tooltip_markup : ::String? = nil, tooltip_text : ::String? = nil, valign : Gtk::Align? = nil, vexpand : Bool? = nil, vexpand_set : Bool? = nil, visible : Bool? = nil, width_request : Int32? = nil)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibAdw.adw_view_switcher_sidebar_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Adw::ViewSwitcherSidebar.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      # adw_view_switcher_sidebar_new: (Constructor)
      # Returns: (transfer none)

      # C call
      _retval = LibAdw.adw_view_switcher_sidebar_new

      # Return value handling
      Adw::ViewSwitcherSidebar.new(_retval, GICrystal::Transfer::Full)
    end

    def filter : Gtk::Filter?
      # adw_view_switcher_sidebar_get_filter: (Method | Getter)
      # Returns: (transfer none) (nullable)

      # C call
      _retval = LibAdw.adw_view_switcher_sidebar_get_filter(to_unsafe)
    ...
    def mode : Adw::SidebarMode
      # adw_view_switcher_sidebar_get_mode: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibAdw.adw_view_switcher_sidebar_get_mode(to_unsafe)
    ...
    def placeholder : Gtk::Widget?
      # adw_view_switcher_sidebar_get_placeholder: (Method | Getter)
      # Returns: (transfer none) (nullable)

      # C call
      _retval = LibAdw.adw_view_switcher_sidebar_get_placeholder(to_unsafe)
    ...
    def stack : Adw::ViewStack?
      # adw_view_switcher_sidebar_get_stack: (Method | Getter)
      # Returns: (transfer none) (nullable)

      # C call
      _retval = LibAdw.adw_view_switcher_sidebar_get_stack(to_unsafe)
    ...
    def filter=(filter : Gtk::Filter?) : Nil
      # adw_view_switcher_sidebar_set_filter: (Method | Setter)
      # @filter: (nullable)
      # Returns: (transfer none)
      ...
      # C call
      LibAdw.adw_view_switcher_sidebar_set_filter(to_unsafe, filter)

      # Return value handling
    end

    def mode=(mode : Adw::SidebarMode) : Nil
      # adw_view_switcher_sidebar_set_mode: (Method | Setter)
      # @mode:
      # Returns: (transfer none)

      # C call
      LibAdw.adw_view_switcher_sidebar_set_mode(to_unsafe, mode)

      # Return value handling
    end

    def placeholder=(placeholder : Gtk::Widget?) : Nil
      # adw_view_switcher_sidebar_set_placeholder: (Method | Setter)
      ...
      # C call
      LibAdw.adw_view_switcher_sidebar_set_placeholder(to_unsafe, placeholder)

      # Return value handling
    end

    def stack=(stack : Adw::ViewStack?) : Nil
      # adw_view_switcher_sidebar_set_stack: (Method | Setter)
      # @stack: (nullable)
      # Returns: (transfer none)
      ...
      # C call
      LibAdw.adw_view_switcher_sidebar_set_stack(to_unsafe, stack)
    ...
    struct ActivatedSignal < GObject::Signal
      ...
      def connect(handler : Proc(Adw::ViewSwitcherSidebar, Nil), *, after : Bool = false) : GObject::SignalConnection
        _box = ::Box.box(handler)
        handler = ->(_lib_sender : Pointer(Void), _lib_box : Pointer(Void)) {
          _sender = Adw::ViewSwitcherSidebar.new(_lib_sender, GICrystal::Transfer::None)
          ::Box(Proc(Adw::ViewSwitcherSidebar, Nil)).unbox(_lib_box).call(_sender)
        }.pointer
