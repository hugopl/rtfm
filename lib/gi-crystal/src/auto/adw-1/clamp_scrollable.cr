...
module Adw
  ...
  class ClampScrollable < Gtk::Widget
    ...
    GICrystal.declare_new_method(ClampScrollable, g_object_get_qdata)
    ...
    def self.g_type : UInt64
      @@g_type ||= LibAdw.adw_clamp_scrollable_get_type.tap do |g_type|
        # Set the Crystal constructor on type qdata
        ctor = ->Adw::ClampScrollable.new(Void*, GICrystal::Transfer)
    ...
    def self.new : self
      ...
      Adw::ClampScrollable.new(_retval, GICrystal::Transfer::Full)
    end
    ...
    def child : Gtk::Widget?
      ...
      # C call
      _retval = LibAdw.adw_clamp_scrollable_get_child(to_unsafe)
    ...
    def maximum_size : Int32
      ...
      # C call
      _retval = LibAdw.adw_clamp_scrollable_get_maximum_size(to_unsafe)
    ...
    def tightening_threshold : Int32
      ...
      # C call
      _retval = LibAdw.adw_clamp_scrollable_get_tightening_threshold(to_unsafe)
    ...
    def unit : Adw::LengthUnit
      # adw_clamp_scrollable_get_unit: (Method | Getter)
      # Returns: (transfer none)

      # C call
      _retval = LibAdw.adw_clamp_scrollable_get_unit(to_unsafe)
    ...
    def child=(child : Gtk::Widget?) : Nil
      ...
      # C call
      LibAdw.adw_clamp_scrollable_set_child(to_unsafe, child)
    ...
    def maximum_size=(maximum_size : Int32) : Nil
      ...
      # C call
      LibAdw.adw_clamp_scrollable_set_maximum_size(to_unsafe, maximum_size)
    ...
    def tightening_threshold=(tightening_threshold : Int32) : Nil
      ...
      # C call
      LibAdw.adw_clamp_scrollable_set_tightening_threshold(to_unsafe, tightening_threshold)

      # Return value handling
    end

    def unit=(unit : Adw::LengthUnit) : Nil
      # adw_clamp_scrollable_set_unit: (Method | Setter)
      # @unit:
      # Returns: (transfer none)

      # C call
      LibAdw.adw_clamp_scrollable_set_unit(to_unsafe, unit)
