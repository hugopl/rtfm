...
lib LibGLib
  ...
  # Callbacks
  alias CacheDestroyFunc = Pointer(Void) -> Void
  alias CacheDupFunc = Pointer(Void) -> Pointer(Void)
  alias CacheNewFunc = Pointer(Void) -> Pointer(Void)
  ...
  alias CompletionFunc = Pointer(Void) -> Pointer(LibC::Char)
  alias CompletionStrncmpFunc = Pointer(LibC::Char), Pointer(LibC::Char), UInt64 -> Int32
  ...
  alias EqualFuncFull = Pointer(Void), Pointer(Void), Pointer(Void) -> LibC::Int
  ...
  alias LogWriterFunc = Int32, Pointer(LibGLib::LogField), UInt64, Pointer(Void) -> UInt32
  ...
  alias SourceFuncsCheckFunc = Pointer(LibGLib::Source) -> LibC::Int
  alias SourceFuncsFinalizeFunc = Pointer(LibGLib::Source) -> Void
  alias SourceFuncsPrepareFunc = Pointer(LibGLib::Source), Int32 -> LibC::Int
  alias SourceOnceFunc = Pointer(Void) -> Void
  ...
  # Structs
  type Allocator = Void # Struct with zero bytes
  ...
  type Cache = Void # Struct with zero bytes

  type Checksum = Void # Struct with zero bytes

  struct Completion # 40 bytes long
    items : Pointer(LibGLib::List)
    func : Void*
    prefix : Pointer(LibC::Char)
    cache : Pointer(LibGLib::List)
    strncmp_func : Void*
  end
  ...
  type MemChunk = Void # Struct with zero bytes
  ...
  struct PathBuf # 64 bytes long
    dummy : Pointer(Void)[8]
  end
  ...
  type Relation = Void # Struct with zero bytes
  ...
  struct Thread # 32 bytes long
    func : Void*
    data : Pointer(Void)
    joinable : LibC::Int
    priority : Pointer(Void)
  end
  ...
  fun g_aligned_free_sized(mem : Pointer(Void), alignment : UInt64, size : UInt64) : Void
  fun g_allocator_free(this : Void*) : Void
  ...
  fun g_assertion_message_cmpint(domain : Pointer(LibC::Char), file : Pointer(LibC::Char), line : Int32, func : Pointer(LibC::Char), expr : Pointer(LibC::Char), arg1 : UInt64, cmp : Pointer(LibC::Char), arg2 : UInt64, numtype : Int8) : Void
  ...
  fun g_assertion_message_error(domain : Pointer(LibC::Char), file : Pointer(LibC::Char), line : Int32, func : Pointer(LibC::Char), expr : Pointer(LibC::Char), error : Pointer(LibGLib::Error), error_domain : UInt32, error_code : Int32) : Void
  ...
  fun g_async_queue_new : Pointer(Void)
  fun g_async_queue_new : Pointer(Void)
  fun g_async_queue_new_full(item_free_func : Void*) : Pointer(Void)
  fun g_async_queue_new_full(item_free_func : Void*) : Pointer(Void)
  ...
  fun g_async_queue_push_sorted(this : Void*, data : Pointer(Void), func : Void*, user_data : Pointer(Void)) : Void
  fun g_async_queue_push_sorted_unlocked(this : Void*, data : Pointer(Void), func : Void*, user_data : Pointer(Void)) : Void
  fun g_async_queue_push_unlocked(this : Void*, data : Pointer(Void)) : Void
  fun g_async_queue_ref(this : Void*) : Pointer(Void)
  ...
  fun g_async_queue_sort(this : Void*, func : Void*, user_data : Pointer(Void)) : Void
  fun g_async_queue_sort_unlocked(this : Void*, func : Void*, user_data : Pointer(Void)) : Void
  ...
  fun g_atomic_pointer_compare_and_exchange_full(atomic : Pointer(Void), oldval : Pointer(Void), newval : Pointer(Void), preval : Pointer(Pointer(Void))) : LibC::Int
  fun g_atomic_pointer_exchange(atomic : Pointer(Void), newval : Pointer(Void)) : Pointer(Void)
  ...
  fun g_bookmark_file_copy(this : Void*) : Pointer(Void)
  ...
  fun g_bookmark_file_get_type : UInt64
  ...
  fun g_bookmark_file_new : Pointer(Void)
  ...
  fun g_byte_array_append(array : Pointer(UInt8), data : Pointer(UInt8), len : UInt32) : Pointer(UInt8)
  fun g_byte_array_append(array : Pointer(UInt8), data : Pointer(UInt8), len : UInt32) : Pointer(UInt8)
  ...
  fun g_byte_array_new_take(data : Pointer(UInt8), len : UInt64) : Pointer(UInt8)
  fun g_byte_array_prepend(array : Pointer(UInt8), data : Pointer(UInt8), len : UInt32) : Pointer(UInt8)
  fun g_byte_array_prepend(array : Pointer(UInt8), data : Pointer(UInt8), len : UInt32) : Pointer(UInt8)
  fun g_byte_array_ref(array : Pointer(UInt8)) : Pointer(UInt8)
  fun g_byte_array_ref(array : Pointer(UInt8)) : Pointer(UInt8)
  fun g_byte_array_remove_index(array : Pointer(UInt8), index_ : UInt32) : Pointer(UInt8)
  fun g_byte_array_remove_index(array : Pointer(UInt8), index_ : UInt32) : Pointer(UInt8)
  fun g_byte_array_remove_index_fast(array : Pointer(UInt8), index_ : UInt32) : Pointer(UInt8)
  fun g_byte_array_remove_index_fast(array : Pointer(UInt8), index_ : UInt32) : Pointer(UInt8)
  fun g_byte_array_remove_range(array : Pointer(UInt8), index_ : UInt32, length : UInt32) : Pointer(UInt8)
  fun g_byte_array_remove_range(array : Pointer(UInt8), index_ : UInt32, length : UInt32) : Pointer(UInt8)
  fun g_byte_array_set_size(array : Pointer(UInt8), length : UInt32) : Pointer(UInt8)
  fun g_byte_array_set_size(array : Pointer(UInt8), length : UInt32) : Pointer(UInt8)
  fun g_byte_array_sized_new(reserved_size : UInt32) : Pointer(UInt8)
  fun g_byte_array_sized_new(reserved_size : UInt32) : Pointer(UInt8)
  fun g_byte_array_sort(array : Pointer(UInt8), compare_func : Void*) : Void
  fun g_byte_array_sort(array : Pointer(UInt8), compare_func : Void*) : Void
  fun g_byte_array_sort_with_data(array : Pointer(UInt8), compare_func : Void*, user_data : Pointer(Void)) : Void
  fun g_byte_array_sort_with_data(array : Pointer(UInt8), compare_func : Void*, user_data : Pointer(Void)) : Void
  ...
  fun g_cache_destroy(this : Void*) : Void
  fun g_cache_insert(this : Void*, key : Pointer(Void)) : Pointer(Void)
  fun g_cache_key_foreach(this : Void*, func : Void*, user_data : Pointer(Void)) : Void
  fun g_cache_remove(this : Void*, value : Pointer(Void)) : Void
  fun g_cache_value_foreach(this : Void*, func : Void*, user_data : Pointer(Void)) : Void
  ...
  fun g_creat(filename : Pointer(LibC::Char), mode : Int32) : Int32
  ...
  fun g_datalist_id_remove_multiple(datalist : Pointer(Void), keys : Pointer(UInt32), n_keys : UInt64) : Void
  ...
  fun g_date_time_new_from_unix_local_usec(usecs : Int64) : Pointer(Void)
  fun g_date_time_new_from_unix_utc(t : Int64) : Pointer(Void)
  fun g_date_time_new_from_unix_utc_usec(usecs : Int64) : Pointer(Void)
  ...
  fun g_date_time_to_unix_usec(this : Void*) : Int64
  ...
  fun g_dir_get_type : UInt64
  fun g_dir_make_tmp(tmpl : Pointer(LibC::Char), error : LibGLib::Error**) : Pointer(LibC::Char)
  fun g_dir_make_tmp(tmpl : Pointer(LibC::Char), error : LibGLib::Error**) : Pointer(LibC::Char)
  fun g_dir_open(path : Pointer(LibC::Char), flags : UInt32, error : LibGLib::Error**) : Pointer(Void)
  fun g_dir_read_name(this : Void*) : Pointer(LibC::Char)
  fun g_dir_ref(this : Void*) : Pointer(Void)
  fun g_dir_rewind(this : Void*) : Void
  fun g_dir_unref(this : Void*) : Void
  ...
  fun g_error_copy(this : Void*) : Pointer(LibGLib::Error)
  fun g_error_domain_register(error_type_name : Pointer(LibC::Char), error_type_private_size : UInt64, error_type_init : Void*, error_type_copy : Void*, error_type_clear : Void*) : UInt32
  fun g_error_domain_register(error_type_name : Pointer(LibC::Char), error_type_private_size : UInt64, error_type_init : Void*, error_type_copy : Void*, error_type_clear : Void*) : UInt32
  fun g_error_domain_register_static(error_type_name : Pointer(LibC::Char), error_type_private_size : UInt64, error_type_init : Void*, error_type_copy : Void*, error_type_clear : Void*) : UInt32
  fun g_error_domain_register_static(error_type_name : Pointer(LibC::Char), error_type_private_size : UInt64, error_type_init : Void*, error_type_copy : Void*, error_type_clear : Void*) : UInt32
  ...
  fun g_fopen(filename : Pointer(LibC::Char), mode : Pointer(LibC::Char)) : Pointer(Void)
  ...
  fun g_free_sized(mem : Pointer(Void), size : UInt64) : Void
  fun g_freopen(filename : Pointer(LibC::Char), mode : Pointer(LibC::Char), stream : Pointer(Void)) : Pointer(Void)
  fun g_fsync(fd : Int32) : Int32
  ...
  fun g_hash_table_destroy(hash_table : Pointer(Void)) : Void
  fun g_hash_table_find(hash_table : Pointer(Void), predicate : Void*, user_data : Pointer(Void)) : Pointer(Void)
  fun g_hash_table_find(hash_table : Pointer(Void), predicate : Void*, user_data : Pointer(Void)) : Pointer(Void)
  fun g_hash_table_foreach(hash_table : Pointer(Void), func : Void*, user_data : Pointer(Void)) : Void
  fun g_hash_table_foreach(hash_table : Pointer(Void), func : Void*, user_data : Pointer(Void)) : Void
  fun g_hash_table_foreach_remove(hash_table : Pointer(Void), func : Void*, user_data : Pointer(Void)) : UInt32
  fun g_hash_table_foreach_remove(hash_table : Pointer(Void), func : Void*, user_data : Pointer(Void)) : UInt32
  fun g_hash_table_foreach_steal(hash_table : Pointer(Void), func : Void*, user_data : Pointer(Void)) : UInt32
  fun g_hash_table_foreach_steal(hash_table : Pointer(Void), func : Void*, user_data : Pointer(Void)) : UInt32
  ...
  fun g_hash_table_insert(hash_table : Pointer(Void), key : Pointer(Void), value : Pointer(Void)) : LibC::Int
  fun g_hash_table_iter_get_hash_table(this : Void*) : Pointer(Void)
  ...
  fun g_hash_table_new_similar(other_hash_table : Pointer(Void)) : Pointer(Void)
  fun g_hash_table_ref(hash_table : Pointer(Void)) : Pointer(Void)
  fun g_hash_table_ref(hash_table : Pointer(Void)) : Pointer(Void)
  ...
  fun g_hash_table_unref(hash_table : Pointer(Void)) : Void
  fun g_hmac_copy(this : Void*) : Pointer(Void)
  ...
  fun g_hmac_get_type : UInt64
  fun g_hmac_new(digest_type : UInt32, key : Pointer(UInt8), key_len : UInt64) : Pointer(Void)
  fun g_hmac_ref(this : Void*) : Pointer(Void)
  ...
  fun g_hook_insert_before(hook_list : Pointer(Void), sibling : Pointer(Void), hook : Pointer(Void)) : Void
  fun g_hook_insert_sorted(hook_list : Pointer(Void), hook : Pointer(Void), func : Void*) : Void
  fun g_hook_insert_sorted(hook_list : Pointer(Void), hook : Pointer(Void), func : Void*) : Void
  ...
  fun g_hook_list_marshal(this : Void*, may_recurse : LibC::Int, marshaller : Void*, marshal_data : Pointer(Void)) : Void
  fun g_hook_list_marshal_check(this : Void*, may_recurse : LibC::Int, marshaller : Void*, marshal_data : Pointer(Void)) : Void
  ...
  fun g_io_condition_get_type : UInt64
  ...
  fun g_list_pop_allocator : Void
  fun g_list_push_allocator(allocator : Pointer(Void)) : Void
  fun g_list_push_allocator(allocator : Pointer(Void)) : Void
  ...
  fun g_log_structured_array(log_level : Int32, fields : Pointer(LibGLib::LogField), n_fields : UInt64) : Void
  fun g_log_variant(log_domain : Pointer(LibC::Char), log_level : Int32, fields : Pointer(Void)) : Void
  fun g_log_writer_default(log_level : Int32, fields : Pointer(LibGLib::LogField), n_fields : UInt64, user_data : Pointer(Void)) : UInt32
  fun g_log_writer_default_set_debug_domains(domains : Pointer(LibC::Char)) : Void
  ...
  fun g_log_writer_format_fields(log_level : Int32, fields : Pointer(LibGLib::LogField), n_fields : UInt64, use_color : LibC::Int) : Pointer(LibC::Char)
  fun g_log_writer_is_journald(output_fd : Int32) : LibC::Int
  fun g_log_writer_journald(log_level : Int32, fields : Pointer(LibGLib::LogField), n_fields : UInt64, user_data : Pointer(Void)) : UInt32
  fun g_log_writer_standard_streams(log_level : Int32, fields : Pointer(LibGLib::LogField), n_fields : UInt64, user_data : Pointer(Void)) : UInt32
  fun g_log_writer_supports_color(output_fd : Int32) : LibC::Int
  fun g_log_writer_syslog(log_level : Int32, fields : Pointer(LibGLib::LogField), n_fields : UInt64, user_data : Pointer(Void)) : UInt32
  fun g_lstat(filename : Pointer(LibC::Char), buf : Pointer(Void)) : Int32
  fun g_main_context_acquire(this : Void*) : LibC::Int
  fun g_main_context_add_poll(this : Void*, fd : Pointer(Void), priority : Int32) : Void
  fun g_main_context_check(this : Void*, max_priority : Int32, fds : Pointer(LibGLib::PollFD), n_fds : Int32) : LibC::Int
  ...
  fun g_main_context_pusher_new(this : Void*) : Pointer(Void)
  fun g_main_context_query(this : Void*, max_priority : Int32, timeout_ : Pointer(Int32), fds : Pointer(Pointer(LibGLib::PollFD)), n_fds : Int32) : Int32
  ...
  fun g_mem_chunk_alloc(this : Void*) : Pointer(Void)
  fun g_mem_chunk_alloc0(this : Void*) : Pointer(Void)
  fun g_mem_chunk_clean(this : Void*) : Void
  fun g_mem_chunk_destroy(this : Void*) : Void
  fun g_mem_chunk_free(this : Void*, mem : Pointer(Void)) : Void
  fun g_mem_chunk_info : Void
  fun g_mem_chunk_info : Void
  fun g_mem_chunk_print(this : Void*) : Void
  fun g_mem_chunk_reset(this : Void*) : Void
  ...
  fun g_mkdir(filename : Pointer(LibC::Char), mode : Int32) : Int32
  ...
  fun g_node_children_foreach(this : Void*, flags : UInt32, func : Void*, data : Pointer(Void)) : Void
  ...
  fun g_node_pop_allocator : Void
  fun g_node_push_allocator(allocator : Pointer(Void)) : Void
  fun g_node_push_allocator(allocator : Pointer(Void)) : Void
  fun g_node_reverse_children(this : Void*) : Void
  fun g_node_traverse(this : Void*, order : UInt32, flags : UInt32, max_depth : Int32, func : Void*, data : Pointer(Void)) : Void
  fun g_node_unlink(this : Void*) : Void
  fun g_normalize_mode_get_type : UInt64
  ...
  fun g_once_init_enter_impl(location : Pointer(UInt64)) : LibC::Int
  fun g_open(filename : Pointer(LibC::Char), flags : Int32, mode : Int32) : Int32
  fun g_option_context_add_group(this : Void*, group : Pointer(Void)) : Void
  fun g_option_context_add_main_entries(this : Void*, entries : Pointer(LibGLib::OptionEntry), translation_domain : Pointer(LibC::Char)) : Void
  ...
  fun g_option_group_add_entries(this : Void*, entries : Pointer(LibGLib::OptionEntry)) : Void
  ...
  fun g_parse_debug_string(string : Pointer(LibC::Char), keys : Pointer(LibGLib::DebugKey), nkeys : UInt32) : UInt32
  fun g_path_buf_clear(this : Void*) : Void
  fun g_path_buf_clear_to_path(this : Void*) : Pointer(LibC::Char)
  fun g_path_buf_equal(v1 : Pointer(Void), v2 : Pointer(Void)) : LibC::Int
  fun g_path_buf_equal(v1 : Pointer(Void), v2 : Pointer(Void)) : LibC::Int
  fun g_path_buf_free(this : Void*) : Void
  fun g_path_buf_free_to_path(this : Void*) : Pointer(LibC::Char)
  fun g_path_buf_init(this : Void*) : Pointer(Void)
  fun g_path_buf_init_from_path(this : Void*, path : Pointer(LibC::Char)) : Pointer(Void)
  fun g_path_buf_pop(this : Void*) : LibC::Int
  fun g_path_buf_push(this : Void*, path : Pointer(LibC::Char)) : Pointer(Void)
  fun g_path_buf_set_extension(this : Void*, extension : Pointer(LibC::Char)) : LibC::Int
  fun g_path_buf_set_filename(this : Void*, file_name : Pointer(LibC::Char)) : LibC::Int
  fun g_path_buf_to_path(this : Void*) : Pointer(LibC::Char)
  ...
  fun g_pointer_bit_lock_and_get(address : Pointer(Void), lock_bit : UInt32, out_ptr : Pointer(UInt64)) : Void
  fun g_pointer_bit_lock_mask_ptr(ptr : Pointer(Void), lock_bit : UInt32, set : LibC::Int, preserve_mask : UInt64, preserve_ptr : Pointer(Void)) : Pointer(Void)
  ...
  fun g_pointer_bit_unlock_and_set(address : Pointer(Void), lock_bit : UInt32, ptr : Pointer(Void), preserve_mask : UInt64) : Void
  fun g_poll(fds : Pointer(Void), nfds : UInt32, timeout : Int32) : Int32
  fun g_pollfd_get_type : UInt64
  fun g_prefix_error_literal(err : Pointer(Pointer(LibGLib::Error)), prefix : Pointer(LibC::Char)) : Void
  ...
  fun g_propagate_error(dest : Pointer(Pointer(LibGLib::Error)), src : Pointer(LibGLib::Error)) : Void
  fun g_ptr_array_get_type : UInt64
  fun g_qsort_with_data(pbase : Pointer(Void), total_elems : Int32, size : UInt64, compare_func : Void*, user_data : Pointer(Void)) : Void
  ...
  fun g_queue_foreach(this : Void*, func : Void*, user_data : Pointer(Void)) : Void
  ...
  fun g_queue_insert_sorted(this : Void*, data : Pointer(Void), func : Void*, user_data : Pointer(Void)) : Void
  ...
  fun g_queue_sort(this : Void*, compare_func : Void*, user_data : Pointer(Void)) : Void
  fun g_rand_copy(this : Void*) : Pointer(Void)
  ...
  fun g_rand_get_type : UInt64
  fun g_rand_int(this : Void*) : UInt32
  fun g_rand_int_range(this : Void*, _begin : Int32, _end : Int32) : Int32
  fun g_rand_new : Pointer(Void)
  fun g_rand_new_with_seed(seed : UInt32) : Pointer(Void)
  fun g_rand_new_with_seed_array(seed : Pointer(UInt32), seed_length : UInt32) : Pointer(Void)
  ...
  fun g_ref_string_equal(str1 : Pointer(LibC::Char), str2 : Pointer(LibC::Char)) : LibC::Int
  ...
  fun g_regex_escape_nul(string : Pointer(LibC::Char), length : Int32) : Pointer(LibC::Char)
  fun g_regex_escape_string(string : Pointer(LibC::Char), length : Int32) : Pointer(LibC::Char)
  fun g_regex_escape_string(string : Pointer(LibC::Char), length : Int32) : Pointer(LibC::Char)
  ...
  fun g_regex_replace_eval(this : Void*, string : Pointer(Pointer(LibC::Char)), string_len : Int64, start_position : Int32, match_options : UInt32, eval : Void*, user_data : Pointer(Void), error : LibGLib::Error**) : Pointer(LibC::Char)
  ...
  fun g_relation_count(this : Void*, key : Pointer(Void), field : Int32) : Int32
  fun g_relation_delete(this : Void*, key : Pointer(Void), field : Int32) : Int32
  fun g_relation_destroy(this : Void*) : Void
  fun g_relation_print(this : Void*) : Void
  fun g_reload_user_special_dirs_cache : Void
  fun g_remove(filename : Pointer(LibC::Char)) : Int32
  fun g_rename(oldfilename : Pointer(LibC::Char), newfilename : Pointer(LibC::Char)) : Int32
  ...
  fun g_scanner_scope_foreach_symbol(this : Void*, scope_id : UInt32, func : Void*, user_data : Pointer(Void)) : Void
  ...
  fun g_sequence_foreach(this : Void*, func : Void*, user_data : Pointer(Void)) : Void
  fun g_sequence_foreach_range(_begin : Pointer(Void), _end : Pointer(Void), func : Void*, user_data : Pointer(Void)) : Void
  fun g_sequence_foreach_range(_begin : Pointer(Void), _end : Pointer(Void), func : Void*, user_data : Pointer(Void)) : Void
  ...
  fun g_sequence_insert_before(iter : Pointer(Void), data : Pointer(Void)) : Pointer(Void)
  fun g_sequence_insert_sorted(this : Void*, data : Pointer(Void), cmp_func : Void*, cmp_data : Pointer(Void)) : Pointer(Void)
  fun g_sequence_insert_sorted_iter(this : Void*, data : Pointer(Void), iter_cmp : Void*, cmp_data : Pointer(Void)) : Pointer(Void)
  ...
  fun g_sequence_lookup(this : Void*, data : Pointer(Void), cmp_func : Void*, cmp_data : Pointer(Void)) : Pointer(Void)
  fun g_sequence_lookup_iter(this : Void*, data : Pointer(Void), iter_cmp : Void*, cmp_data : Pointer(Void)) : Pointer(Void)
  ...
  fun g_sequence_remove_range(_begin : Pointer(Void), _end : Pointer(Void)) : Void
  fun g_sequence_search(this : Void*, data : Pointer(Void), cmp_func : Void*, cmp_data : Pointer(Void)) : Pointer(Void)
  fun g_sequence_search_iter(this : Void*, data : Pointer(Void), iter_cmp : Void*, cmp_data : Pointer(Void)) : Pointer(Void)
  fun g_sequence_set(iter : Pointer(Void), data : Pointer(Void)) : Void
  fun g_sequence_set(iter : Pointer(Void), data : Pointer(Void)) : Void
  fun g_sequence_sort(this : Void*, cmp_func : Void*, cmp_data : Pointer(Void)) : Void
  fun g_sequence_sort_changed(iter : Pointer(Void), cmp_func : Void*, cmp_data : Pointer(Void)) : Void
  fun g_sequence_sort_changed(iter : Pointer(Void), cmp_func : Void*, cmp_data : Pointer(Void)) : Void
  fun g_sequence_sort_changed_iter(iter : Pointer(Void), iter_cmp : Void*, cmp_data : Pointer(Void)) : Void
  fun g_sequence_sort_changed_iter(iter : Pointer(Void), iter_cmp : Void*, cmp_data : Pointer(Void)) : Void
  fun g_sequence_sort_iter(this : Void*, cmp_func : Void*, cmp_data : Pointer(Void)) : Void
  fun g_sequence_swap(a : Pointer(Void), b : Pointer(Void)) : Void
  fun g_sequence_swap(a : Pointer(Void), b : Pointer(Void)) : Void
  fun g_set_application_name(application_name : Pointer(LibC::Char)) : Void
  fun g_set_error_literal(err : Pointer(Pointer(LibGLib::Error)), domain : UInt32, code : Int32, message : Pointer(LibC::Char)) : Void
  ...
  fun g_slist_pop_allocator : Void
  fun g_slist_push_allocator(allocator : Pointer(Void)) : Void
  fun g_slist_push_allocator(allocator : Pointer(Void)) : Void
  ...
  fun g_stat(filename : Pointer(LibC::Char), buf : Pointer(Void)) : Int32
  ...
  fun g_strdupv(str_array : Pointer(Pointer(LibC::Char))) : Pointer(Pointer(LibC::Char))
  ...
  fun g_strfreev(str_array : Pointer(Pointer(LibC::Char))) : Void
  ...
  fun g_string_free_and_steal(this : Void*) : Pointer(LibC::Char)
  ...
  fun g_string_new_take(init : Pointer(LibC::Char)) : Pointer(Void)
  ...
  fun g_strjoinv(separator : Pointer(LibC::Char), str_array : Pointer(Pointer(LibC::Char))) : Pointer(LibC::Char)
  ...
  fun g_strv_builder_get_type : UInt64
  fun g_strv_builder_new : Pointer(Void)
  fun g_strv_builder_ref(this : Void*) : Pointer(Void)
  fun g_strv_builder_take(this : Void*, value : Pointer(LibC::Char)) : Void
  fun g_strv_builder_unref(this : Void*) : Void
  fun g_strv_builder_unref_to_strv(this : Void*) : Pointer(Pointer(LibC::Char))
  fun g_strv_contains(strv : Pointer(Pointer(LibC::Char)), str : Pointer(LibC::Char)) : LibC::Int
  fun g_strv_equal(strv1 : Pointer(Pointer(LibC::Char)), strv2 : Pointer(Pointer(LibC::Char))) : LibC::Int
  fun g_strv_get_type : UInt64
  fun g_strv_length(str_array : Pointer(Pointer(LibC::Char))) : UInt32
  ...
  fun g_test_disable_crash_reporting : Void
  ...
  fun g_thread_exit(retval : Pointer(Void)) : Void
  fun g_thread_get_name(this : Void*) : Pointer(LibC::Char)
  ...
  fun g_tree_foreach(this : Void*, func : Void*, user_data : Pointer(Void)) : Void
  fun g_tree_foreach_node(this : Void*, func : Void*, user_data : Pointer(Void)) : Void
  ...
  fun g_tree_search(this : Void*, search_func : Void*, user_data : Pointer(Void)) : Pointer(Void)
  fun g_tree_search_node(this : Void*, search_func : Void*, user_data : Pointer(Void)) : Pointer(Void)
  fun g_tree_steal(this : Void*, key : Pointer(Void)) : LibC::Int
  fun g_tree_traverse(this : Void*, traverse_func : Void*, traverse_type : UInt32, user_data : Pointer(Void)) : Void
  ...
  fun g_tuples_destroy(this : Void*) : Void
  fun g_tuples_index(this : Void*, index_ : Int32, field : Int32) : Pointer(Void)
  ...
  fun g_unicode_break_type_get_type : UInt64
  ...
  fun g_variant_new_array(child_type : Pointer(Void), children : Pointer(Pointer(LibGLib::Variant)), n_children : UInt64) : Pointer(Void)
  ...
  fun g_variant_new_tuple(children : Pointer(Pointer(LibGLib::Variant)), n_children : UInt64) : Pointer(Void)
  ...
  fun g_variant_parse(type : Pointer(Void), text : Pointer(LibC::Char), limit : Pointer(LibC::Char), endptr : Pointer(LibC::Char), error : LibGLib::Error**) : Pointer(Void)
  fun g_variant_parse_error_print_context(error : Pointer(LibGLib::Error), source_str : Pointer(LibC::Char)) : Pointer(LibC::Char)
  fun g_variant_parse_error_print_context(error : Pointer(LibGLib::Error), source_str : Pointer(LibC::Char)) : Pointer(LibC::Char)
  ...
  fun g_variant_type_checked_(type_string : Pointer(LibC::Char)) : Pointer(Void)
  fun g_variant_type_checked_(type_string : Pointer(LibC::Char)) : Pointer(Void)
  ...
  fun g_variant_type_new_tuple(items : Pointer(Pointer(LibGLib::VariantType)), length : Int32) : Pointer(Void)
