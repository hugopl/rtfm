...
lib LibGraphene
  ...
  fun graphene_box_get_vertices(this : Void*, vertices : Pointer(Pointer(LibGraphene::Vec3))) : Void
  ...
  fun graphene_box_init_from_points(this : Void*, n_points : UInt32, points : Pointer(LibGraphene::Point3D)) : Pointer(Void)
  fun graphene_box_init_from_vec3(this : Void*, min : Pointer(Void), max : Pointer(Void)) : Pointer(Void)
  fun graphene_box_init_from_vectors(this : Void*, n_vectors : UInt32, vectors : Pointer(LibGraphene::Vec3)) : Pointer(Void)
  ...
  fun graphene_frustum_get_planes(this : Void*, planes : Pointer(Pointer(LibGraphene::Plane))) : Void
  ...
  fun graphene_quad_init_from_points(this : Void*, points : Pointer(LibGraphene::Point)) : Pointer(Void)
  ...
  fun graphene_rect_get_vertices(this : Void*, vertices : Pointer(Pointer(LibGraphene::Vec2))) : Void
  ...
  fun graphene_sphere_init_from_points(this : Void*, n_points : UInt32, points : Pointer(LibGraphene::Point3D), center : Pointer(Void)) : Pointer(Void)
  fun graphene_sphere_init_from_vectors(this : Void*, n_vectors : UInt32, vectors : Pointer(LibGraphene::Vec3), center : Pointer(Void)) : Pointer(Void)
