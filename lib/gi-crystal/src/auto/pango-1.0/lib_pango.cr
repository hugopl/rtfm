...
lib LibPango
  ...
  # All C Functions
  fun pango_alignment_get_type : UInt64
  ...
  fun pango_attr_break(text : Pointer(LibC::Char), length : Int32, attr_list : Pointer(Void), offset : Int32, attrs : Pointer(Pointer(LibPango::LogAttr)), attrs_len : Int32) : Void
  ...
  fun pango_attr_type_get_type : UInt64
  ...
  fun pango_baseline_shift_get_type : UInt64
  fun pango_bidi_type_for_unichar(ch : UInt32) : UInt32
  fun pango_bidi_type_get_type : UInt64
  fun pango_break(text : Pointer(LibC::Char), length : Int32, analysis : Pointer(Void), attrs : Pointer(Pointer(LibPango::LogAttr)), attrs_len : Int32) : Void
  ...
  fun pango_context_list_families(this : Void*, families : Pointer(Pointer(Pointer(LibPango::FontFamily))), n_families : Pointer(Int32)) : Void
  ...
  fun pango_coverage_level_get_type : UInt64
  ...
  fun pango_default_break(text : Pointer(LibC::Char), length : Int32, analysis : Pointer(Void), attrs : Pointer(Pointer(LibPango::LogAttr)), attrs_len : Int32) : Void
  fun pango_direction_get_type : UInt64
  fun pango_ellipsize_mode_get_type : UInt64
  ...
  fun pango_font_description_set_features_static(this : Void*, features : Pointer(LibC::Char)) : Void
  ...
  fun pango_font_descriptions_free(descs : Pointer(Pointer(LibPango::FontDescription)), n_descs : Int32) : Void
  fun pango_font_deserialize(context : Pointer(Void), bytes : Pointer(Void), error : LibGLib::Error**) : Pointer(Void)
  ...
  fun pango_font_family_list_faces(this : Void*, faces : Pointer(Pointer(Pointer(LibPango::FontFace))), n_faces : Pointer(Int32)) : Void
  fun pango_font_get_coverage(this : Void*, language : Pointer(Void)) : Pointer(Void)
  fun pango_font_get_face(this : Void*) : Pointer(Void)
  fun pango_font_get_features(this : Void*, features : Pointer(Pointer(LibHarfBuzz::FeatureT)), len : UInt32, num_features : Pointer(UInt32)) : Void
  ...
  fun pango_font_get_languages(this : Void*) : Pointer(LibPango::Language)
  ...
  fun pango_font_map_add_font_file(this : Void*, filename : Pointer(LibC::Char), error : LibGLib::Error**) : LibC::Int
  ...
  fun pango_font_map_list_families(this : Void*, families : Pointer(Pointer(Pointer(LibPango::FontFamily))), n_families : Pointer(Int32)) : Void
  ...
  fun pango_font_map_reload_font(this : Void*, font : Pointer(Void), scale : Float64, context : Pointer(Void), variations : Pointer(LibC::Char)) : Pointer(Void)
  ...
  fun pango_get_log_attrs(text : Pointer(LibC::Char), length : Int32, level : Int32, language : Pointer(Void), attrs : Pointer(Pointer(LibPango::LogAttr)), attrs_len : Int32) : Void
  ...
  fun pango_glyph_item_get_logical_widths(this : Void*, text : Pointer(LibC::Char), logical_widths : Pointer(Pointer(Int32))) : Void
  ...
  fun pango_glyph_item_letter_space(this : Void*, text : Pointer(LibC::Char), log_attrs : Pointer(LibPango::LogAttr), letter_spacing : Int32) : Void
  ...
  fun pango_glyph_string_get_logical_widths(this : Void*, text : Pointer(LibC::Char), length : Int32, embedding_level : Int32, logical_widths : Pointer(Pointer(Int32))) : Void
  ...
  fun pango_gravity_get_type : UInt64
  fun pango_gravity_hint_get_type : UInt64
  ...
  fun pango_item_get_char_offset(this : Void*) : Int32
  ...
  fun pango_language_get_default : Pointer(Void)
  fun pango_language_get_preferred : Pointer(Pointer(LibPango::Language))
  fun pango_language_get_preferred : Pointer(Pointer(LibPango::Language))
  ...
  fun pango_layout_deserialize(context : Pointer(Void), bytes : Pointer(Void), flags : UInt32, error : LibGLib::Error**) : Pointer(Void)
  ...
  fun pango_layout_get_log_attrs(this : Void*, attrs : Pointer(Pointer(LibPango::LogAttr)), n_attrs : Pointer(Int32)) : Void
  fun pango_layout_get_log_attrs_readonly(this : Void*, n_attrs : Pointer(Int32)) : Pointer(LibPango::LogAttr)
  ...
  fun pango_layout_write_to_file(this : Void*, flags : UInt32, filename : Pointer(LibC::Char), error : LibGLib::Error**) : LibC::Int
  ...
  fun pango_markup_parser_finish(context : Pointer(Void), attr_list : Pointer(Pointer(Void)), text : Pointer(Pointer(LibC::Char)), accel_char : Pointer(UInt32), error : LibGLib::Error**) : LibC::Int
  ...
  fun pango_matrix_get_slant_ratio(this : Void*) : Float64
  ...
  fun pango_overline_get_type : UInt64
  ...
  fun pango_parse_markup(markup_text : Pointer(LibC::Char), length : Int32, accel_marker : UInt32, attr_list : Pointer(Pointer(Void)), text : Pointer(Pointer(LibC::Char)), accel_char : Pointer(UInt32), error : LibGLib::Error**) : LibC::Int
  ...
  fun pango_script_get_type : UInt64
  ...
  fun pango_shape_flags_get_type : UInt64
  ...
  fun pango_show_flags_get_type : UInt64
  ...
  fun pango_stretch_get_type : UInt64
  fun pango_style_get_type : UInt64
  fun pango_tab_align_get_type : UInt64
  ...
  fun pango_tailor_break(text : Pointer(LibC::Char), length : Int32, analysis : Pointer(Void), offset : Int32, attrs : Pointer(Pointer(LibPango::LogAttr)), attrs_len : Int32) : Void
  fun pango_text_transform_get_type : UInt64
  fun pango_trim_string(str : Pointer(LibC::Char)) : Pointer(LibC::Char)
  fun pango_underline_get_type : UInt64
  ...
  fun pango_variant_get_type : UInt64
